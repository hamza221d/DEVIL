local function marksq(msg)
if not marksDEVIL:get(DEVSTOR..'lock:reoly:bot'..msg.chat_id_) then
if text == "هلو" or text == "هلاو" or text == "هلوو" or text == "هاي" then 
local marks = {'هلاوات 😻 مشعشع 💫','اهلا وسهلا 💔','😩كل شويه يجي واحد واكلة هلو😖 والله مليت 🤕🙌','Hello😻, my friend😿, how are you👮','😎كل هلا بك في كروبنا 🤕 نورت😼'} 
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks[math.random(#marks)], 1, 'html')  
end 
if text == 'بوت' then
local marks = {'   نجب لك صارت قديمه صيحلي باسمي 😒💛','ها احجي شتريد 😏 صيحلي باسمي بعد لدكول بوت😢   ','  لۧاٲ   مو بوت اقرا اسمي✨ ',' نْجٍبْ لُگ عنْدِيَ آسم ۆصٍيَحٍـنْيَ بْيَة 😟😤ّ'} storm_sendMsg(msg.chat_id_, msg.id_, 1, ''..marks[math.random(#marks)]..'', 1, 'md') end 

if text == "شلونك" or text == "شلونكم"then 
local marks = {'😹اني بلنسبه الي دايح 👻 شوف بقية الاعضاء😴','😕الحمد •للّـ🙏ّـرب وانته/ي 🤔','😡كل شويه واحد يكلي شلونك😪 وشلونكم عمي كلنه بخير كمل🤐','زين واسيا واثير 😹 ادري قديمه انجب 😷'}
 storm_sendMsg(msg.chat_id_, msg.id_, 1,marks[math.random(#marks)], 1, 'html')  
end 
if text == "تحبني" then 
local marks1 = {'😱شلون ما احبك/ج💔 كفشة روحي 😠','احّ ـّـٌٍ❣ـٍّبّكَ و تحبني واثنينه مغلسين 😔',' 😕ما احبك 😹 طن بلكصة 😅','✋🏽عذرا مكبل💔 لتزحف/ين'} 
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks1[math.random(#marks1)], 1, 'html')  
end 
if text == "شيعي" or text == "سني" then 
local marks2 = {'😡لا تصير طائفي زمال🌚📿','🙄بدت رحمه •اللّـہ كلنه عراققين 🇮🇶 انجب✋🏽'} 
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks2[math.random(#marks2)], 1, 'html')  
end 
if text == "شكو ماكو" then 
local marks3 = {'غيرك بل كلب❤️ ماكو','😓صافية دافية','☹️كلشي ماكو ع حطت ايد👌🏾 ',' لعراق سوة صاروخ نووي🎃'} 
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks3[math.random(#marks3)], 1, 'html')  
end 
if text == "شنو اسمك" or text == "شسمك" then 
local marks4 = {'🆔اسمي مكتووب يا خرة💩','🐸لتزحف عزيزي✋🏽','🐸عوف اسمي وانطيني رقمك بلخاص ههه🙊'} 
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks4[math.random(#marks4)], 1, 'html')  
end 
if text == "روعة" or text == "روعه" then
local marks5 = {'😍مروك الاروع👌😌',' ✋🏽انَـَY̷̳̜̩̐̌̋O̷̳̜̩̐̌̋U̷̳̜̩̐̌̋ـَتَه الاروع حبي😚'}
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks5[math.random(#marks5)], 1, 'html') 
end
if text == "غني" or text == "غنيلي" then 
local marks6 = {'☺️حلو حلو شكد حلو هواي حلو رقمي😻 ******07727 تعال خاص اكملك 😹🙌','😿هذا حبيبي احبك كولش🤕 كولش احبة🤐 واتحدة واحد بلبشر مثلي يحبة😒','😜حغنيلكم ام الاحمر 💄 *وا يلا مع سلامة بيباي يا غرمة محافضها 😓🤒' }
end
if text == "باي" or text == "بيباي" or text == "جاو" then 
local marks7 = {'good bay 👮✋🏽','بيباي يعمري 😚','😡كل شوية واحد يروح 🚶كافيعاد 🙏','الله وياك بحي😿'}
end
if text == "اقرالي دعاء" then
local marks8 = {'اللهم عذب المدرسين 😢 منهم الاحياء والاموات 😭🔥 اللهم عذب ام الانكليزي 😭💔 وكهربها بلتيار الرئيسي 😇 اللهم عذب ام الرياضيات وحولها الى غساله بطانيات 🙊 اللهم عذب ام الاسلاميه واجعلها بائعة الشاميه 😭🍃 اللهم عذب ام العربي وحولها الى بائعه البلبي 😿 اللهم عذب ام الجغرافيه واجعلها كلدجاجه الحافية🙌 اللهم عذب ام التاريخ وزحلقها بقشره من البطيخ وارسلها الى المريخ🌚 اللهم عذب ام الاحياء واجعلها كل مومياء🕸🎃 اللهم عذب المعاون اقتله بلمدرسه بهاون 😂😂😂','🙏اللهم يعقلك ويكبرك شويونه ع الاقل👌🏾🐸'}
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks8[math.random(#marks8)], 1, 'html') 
end
if text == "هه" or text == "ههه" or text == "هههه" or text == "ههههه" or text == "😂" or text == "😹" or text == "ههههاي" or text == "😅" then
local marks9 = {'🙂{دِْۈۈۈۈ/يّارٌبْ_مـْو_يـّوّمٌ/ۈۈۈۈمْ}😇','دوم حبي ❤️🍃','ربي يدمها هلضحكة 🙊💫'}
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks9[math.random(#marks9)], 1, 'html') 
end
if text == "فدوة" or text == "فديتك" or text == "فديتج" then
local marks10 = {'😘فدِآكـ آلكؤن🙈ؤمَآي آَلَعيـونْ😚ؤقوآطيْ المَعجَون❤️🙊😋','😢واني محد يكلي فديتك 😭😭','😒لتضل تفدي هذا وذاك😕 انجب واسكت 👌😌'}
storm_sendMsg(msg.chat_id_, msg.id_, 1,marks10[math.random(#marks10)], 1, 'html') 
end
end
if text == 'تفعيل ردود البوت' and is_monsh(msg) then   
if marksDEVIL:get(DEVSTOR..'lock:reoly:bot'..msg.chat_id_) then
marks = '*📮¦ تم تفعيل ردود البوت *\n✓' 
storm_sendMsg( msg.chat_id_, msg.id_, 1, marks, 1, "md") 
marksDEVIL:del(DEVSTOR..'lock:reoly:bot'..msg.chat_id_) 
else
marks = '*📮¦ بالتاكيد تم تفعيل ردود البوت *\n✓' 
storm_sendMsg( msg.chat_id_, msg.id_, 1, marks, 1, "md") 
end
end
if text == 'تعطيل ردود البوت' and is_monsh(msg) then   
if not marksDEVIL:get(DEVSTOR..'lock:reoly:bot'..msg.chat_id_) then
marks = '*📮¦ تم تعطيل ردود البوت *\n✓' 
storm_sendMsg( msg.chat_id_, msg.id_, 1, marks, 1, "md") 
marksDEVIL:set(DEVSTOR..'lock:reoly:bot'..msg.chat_id_,true) 
else
marks = '*📮¦ بالتاكيد تم تعطيل ردود البوت *\n✓' 
storm_sendMsg( msg.chat_id_, msg.id_, 1, marks, 1, "md") 
end
end
