...
NAMEBOT = (tahadevdevil:get(DEVSTOR..'storm:name') or 'ستورم')
...
function is_banned(chat,user) local hash =  tahadevdevil:sismember(DEVSTOR..'storm:baned'..chat,user) if hash then return true else return false end end
function is_gban(chat,user) local hash =  tahadevdevil:sismember(DEVSTOR..'storm:gbaned',user) if hash then return true else return false end end
...
function storm_get_nae(user_id) if tahadevdevil:hget('name',user_id) then text = ''..(string.gsub(tahadevdevil:hget('name',user_id), 'false', '') or ' لا يوجد 🔥 ')  end  get_user(user_id) tahadevdevil:hdel('name',user_id) return text end
...
tahadevdevil:set(DEVSTOR.."test:group"..chat_id,'storm')    
...
function stormmonshn(chat_id, user_id, msg_id, text, offset, length) local tt = tahadevdevil:get(DEVSTOR..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
function storm1(chat,user) local sudoe = tahadevdevil:sismember(DEVSTOR..'sudo:bot',user)  local vipss = tahadevdevil:sismember(DEVSTOR..'vip:groups',user)  local monh = tahadevdevil:sismember(DEVSTOR..'modergroup'..chat,user)  local noow = tahadevdevil:sismember(DEVSTOR..'moder'..chat,user)  local nomo = tahadevdevil:sismember(DEVSTOR..'mods:'..chat,user)  local novip2 = tahadevdevil:sismember(DEVSTOR..'vip:group'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or monh  or noow or nomo  or novip2 then  return true  else  return false  end  end 
function storm2(chat,user) local sudoe = tahadevdevil:sismember(DEVSTOR..'sudo:bot',user)  local vipss = tahadevdevil:sismember(DEVSTOR..'vip:groups',user)  local noow = tahadevdevil:sismember(DEVSTOR..'moder'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or noow  then  return true else  return false end end 
function storm3(chat,user) local sudoe = tahadevdevil:sismember(DEVSTOR..'sudo:bot',user) local noow = tahadevdevil:sismember(DEVSTOR..'moder'..chat,user) if tonumber(SUDO) == tonumber(user) or sudoe or monh   then return true else return false end end 
function storm4(chat,user) local sudoe = tahadevdevil:sismember(DEVSTOR..'sudo:bot',user)     local noow = tahadevdevil:sismember(DEVSTOR..'moder'..chat,user)     local monh = tahadevdevil:sismember(DEVSTOR..'modergroup'..chat,user)     local memr = tahadevdevil:sismember(DEVSTOR..'mepar',user)    if tonumber(SUDO) == tonumber(user) or sudoe or monh or memr or noow then     return true     else     return false     end     end 
...
tahadevdevil:set(DEVSTOR.."test:group"..msg.chat_id_,'storm')   
end  
...
return false  end 
tahadevdevil:del(DEVSTOR..'namebot:witting'..msg.sender_user_id_) 
tahadevdevil:set(DEVSTOR..'storm:name',text) 
...
tahadevdevil:set(DEVSTOR..'setadd:bot'..bot_id,numadded)  storm_sendMsg(msg.chat_id_, msg.id_,  1, "📬*¦* تم وضع عدد الاضافه *{ "..numadded..' }*', 1, 'md')  
end
...
return false  end 
local rules = msg.content_.text_ tahadevdevil:set(DEVSTOR.."rules:group" .. msg.chat_id_, rules) storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦*تم حفظ القوانين ✔",  1, "md") end  tahadevdevil:del(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
...
if text == 'فتح الكل' and is_devtaha(msg) then   taha = '*🚸¦* تم فتح جميع الاوامر   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      tahadevdevil:del(DEVSTOR..'lock:photo'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:vico'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:ste'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:file'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:phon'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:links'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:ved'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:fwd'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:gif'..bot_id)    tahadevdevil:del(DEVSTOR..'lock:musec'..bot_id)    end      
if text == 'قفل الكل' and is_devtaha(msg) then   taha = '*📛¦* تم قفل جميع الاوامر  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      tahadevdevil:set(DEVSTOR..'lock:photo'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:vico'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:ste'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:file'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:phon'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:links'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:ved'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:fwd'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:gif'..bot_id,true)    tahadevdevil:set(DEVSTOR..'lock:musec'..bot_id,true)     end   
if text == 'فتح الصور' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصور   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:photo'..bot_id) end  
if text == 'قفل الصور' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصور  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:photo'..bot_id,true) end 
if text == 'فتح الصوت' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصوت   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:vico'..bot_id) end  
if text == 'قفل الصوت' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصوت  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:vico'..bot_id,true) end 
if text == 'فتح الاغاني' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الاغاني   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:musec'..bot_id) end  
if text == 'قفل الاغاني' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الاغاني  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:musec'..bot_id,true) end 
if text == 'فتح المتحركه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح المتحركه   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:gif'..bot_id) end  
if text == 'قفل المتحركه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل المتحركه  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:gif'..bot_id,true) end 
if text == 'فتح التوجيه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح التوجيه   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:fwd'..bot_id) end  
if text == 'قفل التوجيه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل التوحيه  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:fwd'..bot_id,true) end 
if text == 'فتح الفيديو' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الفيديو   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:ved'..bot_id) end  
if text == 'قفل الفيديو' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الفيديو  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:ved'..bot_id,true) end 
if text == 'فتح الروابط' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الروابط   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:links'..bot_id) end  
if text == 'قفل الروابط' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الروابط  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:links'..bot_id,true) end 
if text == 'فتح الجهات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الجهات   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:phon'..bot_id) end  
if text == 'قفل الجهات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الجهات  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:phon'..bot_id,true) end 
if text == 'فتح الملفات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملفات   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:file'..bot_id) end  
if text == 'قفل الملفات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملفات  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:file'..bot_id,true) end 
if text == 'فتح الملصقات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملصقات   ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:del(DEVSTOR..'lock:ste'..bot_id) end  
if text == 'قفل الملصقات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملصقات  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevdevil:set(DEVSTOR..'lock:ste'..bot_id,true) end 
...
if text == 'مسح المحظورين 📢' and is_devtaha(msg) then       local list = tahadevdevil:smembers(DEVSTOR..'pv:ban'..msg.chat_id_)   for k,v in pairs(list) do     tahadevdevil:del(DEVSTOR..'pv:ban'..msg.chat_id_)   tahadevdevil:del('numlocktextpv'..bot_id..v)  end   storm_sendMsg(msg.chat_id_, msg.id_, 1,'📛*¦* تم مسح المحظورين', 1, 'md')     end
if text == 'تفعيل البوت الخدمي 🎮' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل البوت خدمي  ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevdevil:del(DEVSTOR..'lock:bot:free'..bot_id) end 
if text == 'تعطيل البوت الخدمي 🚸' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل البوت الخدمي  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevdevil:set(DEVSTOR..'lock:bot:free'..bot_id,true) end
if text == 'تفعيل تواصل 📨' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل بوت التواصل  ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevdevil:del(DEVSTOR..'lock:botl'..bot_id) end 
if text == 'تعطيل تواصل 📩' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل التواصل  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevdevil:set(DEVSTOR..'lock:botl'..bot_id,true) end
...
if text == "وضع اسم البوت ⚡" and is_devtaha(msg) then tahadevdevil:setex(DEVSTOR..'namebot:witting'..msg.sender_user_id_,300,true) storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* ارسل لي الاسم 📯\n",1, 'md')  end
if text == 'مسح المميزين عام 🌟' and is_devtaha(msg) then      local list = tahadevdevil:smembers(DEVSTOR..'vip:groups')    if #list == 0 then  storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevdevil:srem(DEVSTOR.."vip:groups",v)    num = num + 1  end   storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين عام *\n', 1, 'md')   end
if text == 'مسح المطورين 👮' and is_devtaha(msg) then     local list = tahadevdevil:smembers(DEVSTOR..'sudo:bot')    if #list == 0 then  storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مطورين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevdevil:srem(DEVSTOR.."sudo:bot",v)    num = num + 1  end   storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المطورين *\n', 1, 'md')   end
if text == 'مسح قائمه العام 🚷' and is_devtaha(msg) then   local list = tahadevdevil:smembers(DEVSTOR..'storm:gbaned')    if #list == 0 then  storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevdevil:srem(DEVSTOR.."storm:gbaned",v)    num = num + 1  end   storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md')   end
if text and text:match("^ضع رد تواصل 💻$") and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  storm_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور 🎐$") and is_devtaha(msg) then tahadevdevil:setex(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  storm_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت 📠$") and is_devtaha(msg) then tahadevdevil:setex(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  storm_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text == 'تفعيل رساله الترحيب 🎌' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل رسالة ترحيب عند الاضافه  ✔' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevdevil:del(DEVSTOR..'lock:klsh:add'..bot_id) end 
if text == 'تعطيل رساله الترحيب 📱' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل رسالة ترحيب عند الاضافه  ❌' storm_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevdevil:set(DEVSTOR..'lock:klsh:add'..bot_id,true) end
if text == "حذف رد التواصل 🔧" and is_devtaha(msg) then  tahadevdevil:del(DEVSTOR.."pvstart") storm_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") end 
if text == "حذف كليشه ستارت 🃏" and is_devtaha(msg) then  tahadevdevil:del(DEVSTOR.."start:msgofstart1") storm_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") end 
if text == "حذف كليشه المطور 🀄" and is_devtaha(msg) then  tahadevdevil:del(DEVSTOR.."dev") storm_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") end 
if text and text:match("^ضع عدد الاعضاء 📜$") and is_devtaha(msg) then  tahadevdevil:setex(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📊¦ ارسل لي العدد الان*'  storm_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') end
if text == "جلب رد التواصل 📚" and is_devtaha(msg) then if tahadevdevil:get(DEVSTOR.."pvstart") then pvstart = tahadevdevil:get(DEVSTOR.."pvstart") storm_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(pvstart)..'', 1, 'md')  else  storm_sendMsg(msg.chat_id_, msg.id_, 1,'*✉¦ لا يوجد رد في التواصل \n📮¦* ارسل `ضع رد التواصل`\n🍃', 1, 'md')  end  end
if text == "جلب كليشه ستارت 📚" and is_devtaha(msg) then  local start = tahadevdevil:get(DEVSTOR.."start:msgofstart1")  if start then storm_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(start)..'', 1, 'md') else storm_sendMsg(msg.chat_id_, msg.id_, 1,'*🎭¦ لم يتم وضع كليشه ستارت *\n', 1, 'md') end end
if text == 'الاحصائيات 🔭' and is_devtaha(msg) then    local grall = tahadevdevil:scard(DEVSTOR.."botgps") or 0    local gradd = tahadevdevil:scard(DEVSTOR..'bot:gpsby:id') or 0    local uspv = tahadevdevil:scard(DEVSTOR.."usersbot") or 0    storm_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ عدد المجموعات الكلي ↫ ❪'..grall..'❫\n📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n📛¦ عدد المجموعات غير مفعله ↫ ❪'..(grall - gradd)..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md')   end
if text=="اذاعه بالتوجيه 📬" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للمجموعات\n✓", 1, "md")   end
if text=="اذاعه خاص بالتوجيه 🔮" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للخاص\n✓", 1, "md")   end
if text=="اذاعه عام بالتوجيه 💾" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للكل\n✓", 1, "md")   end
if text=="اذاعه 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى المجموعات\n✓", 1, "md")   end
if text=="اذاعه للكل 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الكل\n✓", 1, "md")   end
if text=="اذاعه خاص 📡" and msg.reply_to_message_id_ == 0 and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الخاص\n✓", 1, "md")   end 
if text ==('المجموعات 📇') and is_devtaha(msg) then    local list = tahadevdevil:smembers(DEVSTOR..'bot:gpsby:id')   if #list == 0 then  storm_sendMsg(msg.chat_id_, msg.id_, 1,'*💥¦ لا توجد مجموعات حاليا *\n', 1, 'md')  return false  end local t = '⚡¦* اهلا بك في ايدي المجموعات 🍁*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'    for k,v in pairs(list) do     local nummsg = tonumber(tahadevdevil:get(DEVSTOR..'groupmsg:'..v..':'))   numrgroup(v) local numg = (tahadevdevil:get(DEVSTOR.."numgrop"..v) or '3')  local namechat = tahadevdevil:get(DEVSTOR..'group:name'..v)   if namechat then  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n*« "..namechat..' » ❪'..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     else  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n* ❪"..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     end  file = io.open("storm_groups", "w") file:write([[ ]]..isnothtml(t)..[[ ]]) file:close()   end    t = t..'*📮¦*لعرض معلومات مجموعه معينه\n*💥¦ ارسل كشف من ثم ايدي المجموعه*\n*🚸¦ مثال ❪كشف -10012345667❫*\n꞉'    if #list >= 25 then    local groups = tahadevdevil:scard(DEVSTOR..'bot:gpsby:id')    sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './storm_groups','📛¦ عذرا لديك الكثير من المجموعات\n📬¦ تم ارسال المجموعات في الملف\n🚸¦ عدد المجموعات •⊱'..groups..'⊰•',dl_cb, nil)   else   storm_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')    end   end
...
if text == 'مسح المشتركين 💯' and is_devtaha(msg) then     local list = tahadevdevil:smembers(DEVSTOR..'usersbot')     local pv = 0  for k,v in pairs(list) do      tahadevdevil:srem(DEVSTOR..'usersbot',v)    pv = pv + 1  end     storm_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md')   end  
if text == 'مسح المجموعات 💯' and is_devtaha(msg) then   local lgp = tahadevdevil:smembers(DEVSTOR.."bot:gpsby:id")   local lsug = tahadevdevil:smembers(DEVSTOR.."botgps")   local lgpn = tahadevdevil:scard(DEVSTOR.."bot:gpsby:id")   local lsugn = tahadevdevil:scard(DEVSTOR.."botgps") + tahadevdevil:scard(DEVSTOR.."bot:gpsby:id")   for k,v in pairs(lgp) do   rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   for k,v in pairs(lsug) do    rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   storm_sendMsg(msg.chat_id_, msg.id_, 1,"*📮¦* تم مغادره البوت من » ❪"..lsugn.."❫ مجموعات \n✓", 1, 'md')   end
if text == 'المحظورين عام 📑' and is_devtaha(msg) then   local list = tahadevdevil:smembers(DEVSTOR..'storm:gbaned')  local t = '*📮¦ قائمه المحظورين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevdevil:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد محظورين عام في البوت'   end   storm_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
...
if tahadevdevil:sismember(DEVSTOR..'storm:gbaned',kk.id_) then
kkeed = 'محظور عام'
elseif tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,kk.id_) then
kkeed = 'محظور'
...
if tahadevdevil:sismember(DEVSTOR..'storm:gbaned',iduser) then
kkeed = 'محظور عام'
elseif tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,iduser) then
kkeed = 'محظور'
...
if tahadevdevil:sismember(DEVSTOR..'storm:gbaned',result.sender_user_id_) then
kkeed = 'محظور عام'
elseif tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'محظور'
...
if tahadevdevil:sismember(DEVSTOR..'storm:gbaned',tes.content_.entities_[0].user_id_) then
kkeed = 'محظور عام'
elseif tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'محظور'
...
if text and text:match('^ضع تكرار (%d+)$') and is_mod(msg) then tahadevdevil:hset("flooding:settings:"..msg.chat_id_ ,"floodmax" ,text:match('ضع تكرار (.*)')) storm_sendMsg(msg.chat_id_, msg.id_, 1,'💥*¦*  تم وضع عدد التكرار في المجموعه ( '..text:match('ضع تكرار (.*)')..' )', 1, 'md') end if text and text:match('^ضع زمن التكرار (%d+)$') and is_mod(msg) then tahadevdevil:hset("flooding:settings:"..msg.chat_id_ ,"floodtime" ,text:match('ضع زمن التكرار (.*)')) storm_sendMsg(msg.chat_id_, msg.id_, 1,'💥*¦*  تم وضع زمن التكرار في المجموعه ( '..text:match('ضع زمن التكرار (.*)')..' )', 1, 'md') end
...
tahadevdevil:sadd(DEVSTOR..'storm:kick'..msg.chat_id_,result.sender_user_id_)   
else
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم طرده من الكروب\n🍃'     
stormmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:sadd(DEVSTOR..'storm:kick'..msg.chat_id_,user)   
else
zo = '*??¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم طرده من الكروب\n🍃'     
tahadevdevil:sadd(DEVSTOR..'storm:kick'..msg.chat_id_,user)   
seavusername(user) 
...
local list = tahadevdevil:smembers(DEVSTOR..'storm:baned'..msg.chat_id_) 
if #list == 0 then
storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,v) 
num = num + 1
end 
...
local list = tahadevdevil:smembers(DEVSTOR..'storm:gbaned')  
if #list == 0 then
storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
tahadevdevil:srem(DEVSTOR.."storm:gbaned",v)  
num = num + 1
end 
...
if tahadevdevil:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) or tahadevdevil:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) or tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء رفع قيوده\n🍃'   
stormmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) or tahadevdevil:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) or tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء رفع قيوده\n🍃'   
stormmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,user)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) or tahadevdevil:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) or tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
...
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
stormmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevdevil:sadd(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevdevil:sadd(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevdevil:sadd(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_)   
tahadevdevil:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره من الكروب\n🍃'     
tahadevdevil:sadd(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
stormmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:sadd(DEVSTOR..'storm:baned'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevdevil:sadd(DEVSTOR..'storm:baned'..msg.chat_id_,user)   
seavusername(user) 
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
stormmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,result.sender_user_id_)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
stormmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,user)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره\n🍃'   
tahadevdevil:srem(DEVSTOR..'storm:baned'..msg.chat_id_,result.id_)   
storm_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevdevil:sismember(DEVSTOR..'storm:gbaned',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروب\n🍃'   
stormmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevdevil:sadd(DEVSTOR..'storm:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
tahadevdevil:sadd(DEVSTOR..'storm:gbaned',result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n🍃', 1, 'md') 
return false  end
if not tahadevdevil:sismember(DEVSTOR..'storm:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
tahadevdevil:sadd(DEVSTOR..'storm:gbaned',result.id_)   
tahadevdevil:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره عام من الكروب\n🍃'     
tahadevdevil:sadd(DEVSTOR..'storm:gbaned',result.id_)   
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not tahadevdevil:sismember(DEVSTOR..'storm:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروب\n🍃'   
stormmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:sadd(DEVSTOR..'storm:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
tahadevdevil:sadd(DEVSTOR..'storm:gbaned',user)   
seavusername(user) 
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
stormmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:srem(DEVSTOR..'storm:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevdevil:srem(DEVSTOR..'storm:gbaned',result.sender_user_id_)   
storm_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'storm:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
stormmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevdevil:srem(DEVSTOR..'storm:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevdevil:srem(DEVSTOR..'storm:gbaned',user)   
storm_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevdevil:sismember(DEVSTOR..'storm:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevdevil:srem(DEVSTOR..'storm:gbaned',result.id_)   
storm_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء حظره عام\n🍃'   
tahadevdevil:srem(DEVSTOR..'storm:gbaned',result.id_)   
...
if text ==('مسح قائمه المنع') and is_mod(msg) then tahadevdevil:del(DEVSTOR..'filters:'..msg.chat_id_) storm_sendMsg(msg.chat_id_, msg.id_, 1,'📇*¦* تم مسح قائمه المنع', 1, 'md') end 
...
if text and text:match("^مشاهده منشور$") then tahadevdevil:set(DEVSTOR..'viewchannel'..msg.sender_user_id_,true) storm_sendMsg(msg.chat_id_, msg.id_, 1, '♼*¦* حسننا ارسل التوجيه من القناة سارسل عدد المشاهدات', 1, 'md') end 
if text and text:match("^ضع رد تواصل$") and is_devtaha(msg) then   tahadevdevil:setex(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  storm_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور$") and is_devtaha(msg) then tahadevdevil:setex(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  storm_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت$") and is_devtaha(msg) then tahadevdevil:setex(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  storm_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
