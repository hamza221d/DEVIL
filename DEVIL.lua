...
DEVDEVIL = sudos.token:match("(%d+)")  
NAMEBOT = (tahadevDEVIL:get(DEVDEVIL..'DEVIL:name') or 'ستورم')
...
function is_sudo(msg) local hash = tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',msg.sender_user_id_)  if hash or is_devtaha(msg)  then  return true  else  return false  end  end
function is_bot(msg) if tonumber(BOTS) == BOTS then return true else return false end end 
function is_owner(msg) local hash = tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,msg.sender_user_id_)    if hash or is_devtaha(msg) or is_sudo(msg) then    return true    else    return false    end end
function is_monsh(msg) local hash = tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,msg.sender_user_id_)    if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) then    return true    else    return false    end end
function is_mod(msg) local hash = tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,msg.sender_user_id_)    if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) or is_monsh(msg) then    return true    else    return false    end end
function changetitle(chat_id, title) tdcli_function ({ ID = "ChangeChatTitle", chat_id_ = chat_id, title_ = title  }, dl_cb, nil) end
function is_vipgroups(msg)  local hash = tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',msg.sender_user_id_) if hash or  is_devtaha(msg) then return true else return false end end
function is_vipgroup(msg)  local hash = tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,msg.sender_user_id_) if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) or is_mod(msg) or is_vipgroups(msg)  then return true else return false end end
function is_memar(msg)  local hash = tahadevDEVIL:sismember(DEVDEVIL..'mepar',msg.sender_user_id_) if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) or is_mod(msg) or is_mod(msg) or is_vipgroup(msg) or is_vipgroups(msg) then return true else return false end end
function is_banned(chat,user) local hash =  tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..chat,user) if hash then return true else return false end end
function is_gban(chat,user) local hash =  tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',user) if hash then return true else return false end end
...
local var = true
if tahadevDEVIL:get(DEVDEVIL..'add:ch:id') then
tahaid = tahadevDEVIL:get(DEVDEVIL..'add:ch:id')
tahauser = tahadevDEVIL:get(DEVDEVIL..'add:ch:username')
...
var = false
if tahadevDEVIL:get(DEVDEVIL..'text:ch:user') then
local textchuser = tahadevDEVIL:get(DEVDEVIL..'text:ch:user')
...
tahadevDEVIL:set(DEVDEVIL.."user:Name"..id, "@"..username)
print('\27[30;35m»» USERNAME IS SAEVE ↓\n»» @'..data.username_..'\n\27[1;37m') else
tahadevDEVIL:del(DEVDEVIL.."user:Name"..id)
print('»» USERNAME IS NOT SAEVE') end
if data.type_.ID == "UserTypeBot" then
tahadevDEVIL:del(DEVDEVIL.."user:Name"..id) end
...
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user_id) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'moder'..chat_id,user_id) then
t = 'المنشئ'
elseif tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..chat_id,user_id) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..chat_id,user_id) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',user_id) then
t = 'المميز عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..chat_id,user_id) then
t = 'المميز'
else
t = ' '
end
...
if tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..chat_id,user_id) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..chat_id,user_id) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..chat_id,user_id) then
...
tahadevDEVIL:del(DEVDEVIL.."lock:user:name"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:hashtak"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Cmd"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Link"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:forward"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Keyboard"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:geam"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Photo"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Animation"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Video"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Audio"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:vico"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Sticker"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Document"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Unsupported"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Markdaun"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Contact"..chat_id)  tahadevDEVIL:del(DEVDEVIL.."lock:Spam"..chat_id)
end
local function add_lockal(chat_id)
tahadevDEVIL:set(DEVDEVIL.."lock:Bot:kick"..chat_id,'del')  tahadevDEVIL:set(DEVDEVIL..'lock:tagservrbot'..chat_id,true)   tahadevDEVIL:set(DEVDEVIL.."lock:user:name"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:hashtak"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Cmd"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Link"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:forward"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Keyboard"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:geam"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Photo"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Animation"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Video"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Audio"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:vico"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Sticker"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Document"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Unsupported"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Markdaun"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Contact"..chat_id,'del')    tahadevDEVIL:set(DEVDEVIL.."lock:Spam"..chat_id,'del')  
end
function rem_group(chat_id) 
tahadevDEVIL:srem(DEVDEVIL..'bot:gpsby:id',chat_id) 
tahadevDEVIL:del(DEVDEVIL.."test:group"..chat_id)   
tahadevDEVIL:del(DEVDEVIL.."add:bot:group"..chat_id,true) 
rem_lockal(chat_id) 
end
function add_group(chat_id) 
tahadevDEVIL:sadd(DEVDEVIL..'bot:gpsby:id',chat_id)
tahadevDEVIL:sadd(DEVDEVIL.."botgps",chat_id)  
tahadevDEVIL:set(DEVDEVIL.."test:group"..chat_id,'DEVIL')    
tahadevDEVIL:set(DEVDEVIL.."add:bot:group"..chat_id, true)   
end
...
function is_filter(msg, value)  local names = tahadevDEVIL:smembers(DEVDEVIL..'filters:'..msg.chat_id_)  local var = false for i=1, #names do  if names[i] == value and not is_vipgroup(msg) then  var = true      end end return var  end 
function is_muted(chat,user) local hash =  tahadevDEVIL:sismember(DEVDEVIL..'mutes'..chat,user) if hash then return true else return false end end
function DEVILmonshn(chat_id, user_id, msg_id, text, offset, length) local tt = tahadevDEVIL:get(DEVDEVIL..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
function DEVIL1(chat,user) local sudoe = tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user)  local vipss = tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',user)  local monh = tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..chat,user)  local noow = tahadevDEVIL:sismember(DEVDEVIL..'moder'..chat,user)  local nomo = tahadevDEVIL:sismember(DEVDEVIL..'mods:'..chat,user)  local novip2 = tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or monh  or noow or nomo  or novip2 then  return true  else  return false  end  end 
function DEVIL2(chat,user) local sudoe = tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user)  local vipss = tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',user)  local noow = tahadevDEVIL:sismember(DEVDEVIL..'moder'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or noow  then  return true else  return false end end 
function DEVIL3(chat,user) local sudoe = tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user) local noow = tahadevDEVIL:sismember(DEVDEVIL..'moder'..chat,user) if tonumber(SUDO) == tonumber(user) or sudoe or monh   then return true else return false end end 
function DEVIL4(chat,user) local sudoe = tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user)     local noow = tahadevDEVIL:sismember(DEVDEVIL..'moder'..chat,user)     local monh = tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..chat,user)     local memr = tahadevDEVIL:sismember(DEVDEVIL..'mepar',user)    if tonumber(SUDO) == tonumber(user) or sudoe or monh or memr or noow then     return true     else     return false     end     end 
...
local function getChatHiDEVILDEVDEVILy(chat_id, from_message_id, offset, limit,cb)tdcli_function ({ ID = "GetChatHiDEVILDEVDEVILy", chat_id_ = chat_id, from_message_id_ = from_message_id, offset_ = offset, limit_ = limit }, cb, nil) end 
...
function numrgroup(GroupID)  tdcli_function ({ ID = "GetChannelFull",channel_id_ = getChatId(GroupID).ID },function(arg,tah)   tahadevDEVIL:set(DEVDEVIL.."numgrop"..GroupID,tah.member_count_) end,nil)  return tahadevDEVIL:get(DEVDEVIL.."numgrop"..GroupID)   end
function title_name(GroupID) pcall(tdcli_function({ID ="GetChat",chat_id_=GroupID },function(arg,data)  tahadevDEVIL:set(DEVDEVIL..'group:name'..GroupID,data.title_)  end,nil)) return tahadevDEVIL:get(DEVDEVIL..'group:name'..GroupID)  end
...
function addmod(chat_id)   tdcli_function ({ID = "GetChannelMembers", channel_id_ = getChatId(chat_id).ID,filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100 },function(arg,data)  local admins = data.members_ for i=0 , #admins do  if data.members_[i].status_.ID == "ChatMemberStatusCreator" then owner_id = admins[i].user_id_  tahadevDEVIL:sadd(DEVDEVIL..'moder'..chat_id,owner_id)   tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_ },function(arg,b)   if b.username_ == true then  tahadevDEVIL:set(DEVDEVIL.."user:Name"..b.id_,"@"..b.username_) end end,nil)    end  if data.members_[i].bot_info_ == false and data.members_[i].status_.ID == "ChatMemberStatusEditor" then  tahadevDEVIL:sadd(DEVDEVIL..'mods:'..chat_id,admins[i].user_id_)   tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_ },function(arg,b)   if b.username_ == true then  tahadevDEVIL:set(DEVDEVIL.."user:Name"..b.id_,"@"..b.username_) end end,nil)    else  tahadevDEVIL:srem(DEVDEVIL..'mods:'..chat_id,admins[i].user_id_)   end end end,nil)     end
...
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,msg.sender_user_id_) 
else
DEVILmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضــو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم تقييده \n' , 14, utf8.len(data.first_name_)) 
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,msg.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "md")  
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_) 
else
DEVILmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضــو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم كتمه \n' , 14, utf8.len(data.first_name_))  
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_) 
end
...
end  function chackgp(msg)  local hash = tahadevDEVIL:sismember(DEVDEVIL..'bot:gps', msg.chat_id_) if hash then return true else return false end end
...
if msg.content_.ID == "MessageChatAddMembers" and not tahadevDEVIL:get(DEVDEVIL..'lock:klsh:add'..bot_id) then   
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:bot:free'..bot_id) then
...
if tahadevDEVIL:sismember(DEVDEVIL..'bot:gpsby:id',msg.chat_id_) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تفعيلها بالتاكيد \nꪜ*', 1, 'md')
tahadevDEVIL:set(DEVDEVIL.."add:bot:group"..msg.chat_id_, true) 
else
addmod(msg.chat_id_) 
if ( data.member_count_ > tonumber(tahadevDEVIL:get(DEVDEVIL..'setadd:bot'..bot_id) or 100) ) then
test = '*📮¦ تـم تفعيــل المجموعه بـنجـاح 🍃\n📬¦ تم ترقية المنشئ والادمنيه *\n\nꪜ'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,msg.sender_user_id_)  
tahadevDEVIL:sadd(DEVDEVIL..'add:num'..msg.sender_user_id_,msg.chat_id_) 
tahadevDEVIL:set(DEVDEVIL.."add:bot:group"..msg.chat_id_, true)  
tahadevDEVIL:sadd(DEVDEVIL..'bot:gpsby:id', msg.chat_id_)   
tahadevDEVIL:sadd(DEVDEVIL.."botgps", msg.chat_id_)  
else
local taha = tahadevDEVIL:get(DEVDEVIL..'setadd:bot'..bot_id)
...
tahadevDEVIL:del(DEVDEVIL.."test:group" .. msg.chat_id_)
end
if data.member_count_ > tonumber(tahadevDEVIL:get(DEVDEVIL..'setadd:bot'..bot_id) or 100) and not is_devtaha(msg) then    
local numadd = tahadevDEVIL:scard(DEVDEVIL..'add:num'..msg.sender_user_id_)
...
tahadevDEVIL:set(DEVDEVIL.."test:group"..msg.chat_id_,'DEVIL')   
end  
if text == 'تعطيل' and add_in_ch(msg) and is_sudo(msg) then      
if not tahadevDEVIL:sismember(DEVDEVIL..'bot:gpsby:id',msg.chat_id_) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تعطيــلها بالتاكيد \nꪜ*', 1, 'md')
tahadevDEVIL:del(DEVDEVIL.."add:bot:group"..msg.chat_id_, true)  
tahadevDEVIL:del(DEVDEVIL.."test:group" .. msg.chat_id_)
else
test = '*📮¦ تـم تعطيــل المجموعه بـنجـاح 🍃 *\n\nꪜ'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
tahadevDEVIL:del(DEVDEVIL.."add:bot:group"..msg.chat_id_, true)  
tahadevDEVIL:srem(DEVDEVIL..'bot:gpsby:id', msg.chat_id_)   
tahadevDEVIL:srem(DEVDEVIL.."botgps", msg.chat_id_)  
tahadevDEVIL:srem(DEVDEVIL..'add:num'..msg.sender_user_id_,msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL.."test:group" .. msg.chat_id_)
if not is_devtaha(msg) then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID}, function(arg,data)  
...
tahadevDEVIL:incr(DEVDEVIL..'groupmsg:'..msg.chat_id_..':') 
tahadevDEVIL:incr(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
tahadevDEVIL:incr(DEVDEVIL..'msg:chat:'..msg.chat_id_..':') 
tahadevDEVIL:incr(DEVDEVIL..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_)
if msg.send_state_.ID == "MessageIsSuccessfullySent" then return false  end end
if msg.can_be_deleted_ == true and not is_mod(msg) then   tdcli_function ({ ID = "GetUser", user_id_ = msg.sender_user_id_ },function(arg,data)  if data.username_ == true then tahadevDEVIL:set(DEVDEVIL.."user:Name"..msg.sender_user_id_,"@"..data.username_) end end,nil)
if tahadevDEVIL:get(DEVDEVIL..'add:mepr:'..msg.chat_id_) and tonumber(tahadevDEVIL:scard(DEVDEVIL..'addedtaha:'..msg.sender_user_id_)) == tonumber(tahadevDEVIL:get(DEVDEVIL..'setadd:'..msg.chat_id_)) then  
tahadevDEVIL:sadd(DEVDEVIL..'meaddwy:'..msg.chat_id_,msg.sender_user_id_)  
tahadevDEVIL:del(DEVDEVIL.."addedtaha:"..msg.sender_user_id_)  
tahadevDEVIL:srem(DEVDEVIL..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
if data.username_ then
DEVIL_sendMsg(msg.chat_id_,msg.id_,1,'*📬¦ العضو ↫ ❪*[@'..data.username_..']*❫*\n*💠¦ قمت باضافه ❪'..tonumber(tahadevDEVIL:get(DEVDEVIL..'setadd:'..msg.chat_id_))..'❫* اعضاء \n*📮¦ الان يمكنك الدردشه هنا* \n💥',1,'md')  
else
taha = '📬¦ العضو ↫ ❪'..data.id_..'❫\n💠¦ قمت باضافه ❪'..tonumber(tahadevDEVIL:get(DEVDEVIL..'setadd:'..msg.chat_id_))..'❫ اعضاء \n📮¦ الان يمكنك الدردشه هنا \n🍃'
DEVILmonshn(msg.chat_id_, data.id_, 0, taha, 13, utf8.len(data.id_))  
end
end,nil)
elseif msg.content_.text_ and tahadevDEVIL:get(DEVDEVIL..'add:mepr:'..msg.chat_id_) and not tahadevDEVIL:sismember(DEVDEVIL..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) and not tahadevDEVIL:sismember(DEVDEVIL..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_) then  
if tonumber(tahadevDEVIL:scard(DEVDEVIL..'addedtaha:'..msg.sender_user_id_)) ~= tonumber(tahadevDEVIL:get(DEVDEVIL..'setadd:'..msg.chat_id_)) then  
tahadevDEVIL:sadd(DEVDEVIL..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
local mustadd = (tahadevDEVIL:get(DEVDEVIL..'setadd:'..msg.chat_id_) or '0')  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
...
for i=0,#mem_id do  
if tahadevDEVIL:get(DEVDEVIL..'add:mepr:'..msg.chat_id_) then  
if not tahadevDEVIL:sismember(DEVDEVIL..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) then  
if mem_id[i].username_ and mem_id[i].username_:match("[Bb][Oo][Tt]$") then  
return false  
else  
tahadevDEVIL:sadd(DEVDEVIL..'addedtaha:'..msg.sender_user_id_,mem_id[i].id_)  
end  
end  
end  
end  
end  
if tahadevDEVIL:get(DEVDEVIL..'add:mepr:'..msg.chat_id_) and not tahadevDEVIL:sismember(DEVDEVIL..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) then  
...
if tahadevDEVIL:get(DEVDEVIL..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) then 
...
tahadevDEVIL:del(DEVDEVIL..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
chat_type = 'super'
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)   tahadevDEVIL:set(DEVDEVIL..'group:name'..msg.chat_id_,data.title_) end,nil) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  if data.username_ == true then tahadevDEVIL:set(DEVDEVIL.."user:Name"..msg.sender_user_id_,"@"..data.username) end end,nil) 
if msg.can_be_deleted_ == true then
tahadevDEVIL:sadd(DEVDEVIL.."botgps", msg.chat_id_)  
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,tah)   tahadevDEVIL:set(DEVDEVIL.."numgrop"..msg.chat_id_,tah.member_count_) end,nil) 
end
elseif id:match('^(%d+)') then 
chat_type = 'user' 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  if data.username_ == true then tahadevDEVIL:set(DEVDEVIL.."user:Name"..msg.sender_user_id_,"@"..data.username) else tahadevDEVIL:del(DEVDEVIL.."user:Name"..msg.sender_user_id_)  end end,nil) 
tahadevDEVIL:sadd(DEVDEVIL.."usersbot",msg.chat_id_)   
else 
chat_type = 'group' 
...
if msg.content_.ID == "MessageChatAddMembers" then 
tahadevDEVIL:incr(DEVDEVIL..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) 
end
if msg.content_.ID == "MessagePhoto" then msg_type = 'photo' end
if tahadevDEVIL:get(DEVDEVIL..'viewchannel'..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'viewchannel'..msg.sender_user_id_)
return false  end 
...
tahadevDEVIL:del(DEVDEVIL..'viewchannel'..msg.sender_user_id_) end end
if text then   
if is_filter(msg,text) then    
delete_msg(msg.chat_id_,{[0] = msg.id_})        
return false end   
end  
if text then if not tahadevDEVIL:get(DEVDEVIL..'bot_id') then
function cb(a,b,c) tahadevDEVIL:set(DEVDEVIL..'bot_id',b.id_) end getMe(cb) end end
if tahadevDEVIL:get(DEVDEVIL.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
changeChatMemberStatus(ch, bot_id, "Left")
return false  end
local nummsg = tonumber(tahadevDEVIL:get(DEVDEVIL..'groupmsg:'..ch..':')) 
local nummsgg = tahadevDEVIL:get(DEVDEVIL..'groupmsg:'..ch..':') 
...
if tahadevDEVIL:get(DEVDEVIL.."link:group"..ch) then
linkchl = tahadevDEVIL:get(DEVDEVIL.."link:group"..ch)
...
if tahadevDEVIL:get(DEVDEVIL.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
tahadevDEVIL:set(DEVDEVIL..'add:ch:id',data.id_)
tahadevDEVIL:set(DEVDEVIL..'add:ch:username','@'..data.type_.channel_.username_)
else
...
if tahadevDEVIL:get(DEVDEVIL.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
tahadevDEVIL:set(DEVDEVIL..'text:ch:user',texxt)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ تم تغيير رسالة الاشتراك بنجاح *\n✓', 1, 'md')
end
if tahadevDEVIL:get(DEVDEVIL.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local ch = string.match(text, "(-%d+)") 
...
if tahadevDEVIL:get(DEVDEVIL..'group:name'..ch) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📮*¦* رابط المجموعه \n📬*¦* '..tahadevDEVIL:get(DEVDEVIL..'group:name'..ch)..' \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🍃*¦* ['..data.invite_link_..']', 1, 'md')    
else
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'💠*¦* رابط المجموعه \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n['..(data.invite_link_)..']', 1, 'md')    
end
tahadevDEVIL:set(DEVDEVIL.."numgrop"..ch,data.member_count_) 
tdcli_function({ID ="GetChat",chat_id_=ch},function(arg,ata) tahadevDEVIL:set(DEVDEVIL..'group:name'..ch,ata.title_) end,nil)
end
end    
getChannelFull(ch, taha, {chat_id=ch,msg_id=msg.id})    
tahadevDEVIL:del(DEVDEVIL.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
end 
if tahadevDEVIL:get(DEVDEVIL..'namebot:witting'..msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'namebot:witting'..msg.sender_user_id_) 
return false  end 
tahadevDEVIL:del(DEVDEVIL..'namebot:witting'..msg.sender_user_id_) 
tahadevDEVIL:set(DEVDEVIL..'DEVIL:name',text) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*♻¦* تم تغير اسم البوت \n",1, 'md')  
end 
if tahadevDEVIL:get(DEVDEVIL.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local welcome = text:match("(.*)")  
tahadevDEVIL:set(DEVDEVIL..'welcome:'..msg.chat_id_,welcome) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n📬*¦* تم وضع الترحيب \n', 1, 'md')    
end
if tahadevDEVIL:get(DEVDEVIL.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
tahadevDEVIL:set(DEVDEVIL..'setadd:bot'..bot_id,numadded)  DEVIL_sendMsg(msg.chat_id_, msg.id_,  1, "📬*¦* تم وضع عدد الاضافه *{ "..numadded..' }*', 1, 'md')  
end
if tahadevDEVIL:get(DEVDEVIL.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  end 
tahadevDEVIL:del(DEVDEVIL.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if tahadevDEVIL:get(DEVDEVIL.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  end 
tahadevDEVIL:del(DEVDEVIL.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  local pro = tonumber(text:match("(%d+)")) local function myprofile(extra, result, success) if result.total_count_ == 0 then DEVIL_sendMsg(msg.chat_id_, msg.id_,  1, '*🔖¦* عذرا انت لا تمتلك صور في البروفايل\n', 1, 'md') else if result.total_count_ >= pro then if result.photos_[0] then sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_, '\n🌁¦ صورتك رقم  '..pro..' \n📋¦ عدد صورك  '..result.total_count_..' \n📊¦ حجم صورتك  '..result.photos_[0].sizes_[1].photo_.size_..' ') end else DEVIL_sendMsg(msg.chat_id_, msg.id_,  1, '\n*📛¦* انت لا تمتلك صوره رقم  *{'..pro..'}*\n*🌁¦* عدد صورك هي *{'..result.total_count_..'}*', 1, 'md')  end end end getUserProfilePhotos(msg.sender_user_id_, pro-1, 1000, myprofile)  end
if tahadevDEVIL:get(DEVDEVIL.."link:group"..msg.chat_id_) == 'setlinkwai' and is_mod(msg) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."link:group" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else  
...
tahadevDEVIL:set(DEVDEVIL..hash,glink)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* تم حفظ الرابط الخاص بالمجموعه', 1, 'md')  
end   
end 
end
if tahadevDEVIL:get(DEVDEVIL.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للمجموعات *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local gps = tahadevDEVIL:scard(DEVDEVIL..'bot:gpsby:id')   
local list = tahadevDEVIL:smembers(DEVDEVIL..'botgps')   
...
if tahadevDEVIL:get(DEVDEVIL.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للكل *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local list = tahadevDEVIL:smembers(DEVDEVIL..'botgps')   
for k,v in pairs(list) do  
...
local list = tahadevDEVIL:smembers(DEVDEVIL..'usersbot')   
for k,v in pairs(list) do  
forwardMessages(v, msg.chat_id_, {[0] = msg.id_}, 1)  
end   
end 
local gpspv = tahadevDEVIL:scard(DEVDEVIL..'usersbot')   
local gps = tahadevDEVIL:scard(DEVDEVIL..'bot:gpsby:id')   
...
if tahadevDEVIL:get(DEVDEVIL.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_,msg.id_ , 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للخاص *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local gps = tahadevDEVIL:scard(DEVDEVIL..'usersbot')   
local list = tahadevDEVIL:smembers(DEVDEVIL..'usersbot')   
for k,v in pairs(list) do  
forwardMessages(v, msg.chat_id_, {[0] = msg.id_}, 1)  
end   
...
if tahadevDEVIL:get(DEVDEVIL.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للمجموعات *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = tahadevDEVIL:smembers(DEVDEVIL..'bot:gpsby:id') 
for k,v in pairs(list) do 
...
if tahadevDEVIL:get(DEVDEVIL.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للكل *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)  
else  
local gps = tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id") or 0  
if msg.content_.text_ then
local list = tahadevDEVIL:smembers(DEVDEVIL..'bot:gpsby:id') 
...
local gpsv = tahadevDEVIL:scard(DEVDEVIL.."usersbot") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = tahadevDEVIL:smembers(DEVDEVIL..'usersbot') 
for k,v in pairs(list) do 
...
if tahadevDEVIL:get(DEVDEVIL.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للمشتركين *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = tahadevDEVIL:scard(DEVDEVIL.."usersbot") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = tahadevDEVIL:smembers(DEVDEVIL..'usersbot') 
for k,v in pairs(list) do 
...
if tahadevDEVIL:get(DEVDEVIL.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  end 
local rules = msg.content_.text_ tahadevDEVIL:set(DEVDEVIL.."rules:group" .. msg.chat_id_, rules) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦*تم حفظ القوانين ✔",  1, "md") end  tahadevDEVIL:del(DEVDEVIL.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
if tahadevDEVIL:get(DEVDEVIL.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local dev = text:match("(.*)") tahadevDEVIL:set(DEVDEVIL.."dev", dev)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📛¦* تم وضع كليشه المطور \n', 1, 'md')   
end
if tahadevDEVIL:get(DEVDEVIL.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
local msgofstart = text:match("(.*)")  
tahadevDEVIL:set(DEVDEVIL.."start:msgofstart1", msgofstart)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📛¦* تم وضع كليشه ستارت \n', 1, 'md')   
end

if tahadevDEVIL:get(DEVDEVIL.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) 
return false  end 
tahadevDEVIL:del(DEVDEVIL.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) 
local pvstart = text:match("(.*)") 
tahadevDEVIL:set(DEVDEVIL.."pvstart", pvstart)  
...
tahadevDEVIL:sadd(DEVDEVIL.."usersbot",msg.chat_id_)   
local start = tahadevDEVIL:get(DEVDEVIL.."start:msgofstart1")  
if start then 
...
if not is_devtaha(msg) then
if msg.forward_info_ and  tahadevDEVIL:get(DEVDEVIL..'lock:fwd'..bot_id) then     
return false  end    
if  msg.content_.ID == 'MessagePhoto' and tahadevDEVIL:get(DEVDEVIL..'lock:photo'..bot_id) then      
return false  end     
if msg.content_.ID == 'MessageDocument' and  tahadevDEVIL:get(DEVDEVIL..'lock:file'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageSticker' and  tahadevDEVIL:get(DEVDEVIL..'lock:ste'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageVoice' and  tahadevDEVIL:get(DEVDEVIL..'lock:musec'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageContact' and  tahadevDEVIL:get(DEVDEVIL..'lock:phon'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageVideo' and  tahadevDEVIL:get(DEVDEVIL..'lock:ved'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageAnimation' and  tahadevDEVIL:get(DEVDEVIL..'lock:gif'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageAudio' and  tahadevDEVIL:get(DEVDEVIL..'lock:vico'..bot_id) then     
return false  end    
...
if tahadevDEVIL:get(DEVDEVIL..'lock:links'..bot_id) then      
return false  end  
end
end  
if not tahadevDEVIL:get(DEVDEVIL..'lock:botl'..bot_id) then    
if not is_devtaha(msg) then     
local pvstart = tahadevDEVIL:get(DEVDEVIL.."pvstart")    
if pvstart then    
...
if not tahadevDEVIL:sismember(DEVDEVIL.."usersbot",msg.chat_id_) then    
tahadevDEVIL:sadd(DEVDEVIL.."usersbot",msg.chat_id_)    
local pvstart = tahadevDEVIL:get(DEVDEVIL.."pvstart")    
end    
...
if not tahadevDEVIL:sismember(DEVDEVIL..'pv:ban'..msg.chat_id_,id_user) then
if data.username_ == false then
local text = '📮¦ العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم حظره من التواصل\n✓'
tahadevDEVIL:incrby('numlocktextpv'..bot_id..id_user,10000000)    tahadevDEVIL:sadd(DEVDEVIL..'pv:ban'..msg.chat_id_,id_user) 
...
if tahadevDEVIL:sismember(DEVDEVIL..'pv:ban'..msg.chat_id_,id_user) then
if data.username_ == false then
local text = '📮¦ العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره من التواصل\n✓'
tahadevDEVIL:del('numlocktextpv'..bot_id..id_user)    tahadevDEVIL:srem(DEVDEVIL..'pv:ban'..msg.chat_id_,id_user)
DEVILmonshn(msg.chat_id_, id_user, msg.id_, text, 16, utf8.len(CatchName(data.first_name_,15)))  
else
zo = '*📮¦ العضــو ↫ ❪ *[@'..data.username_..'] ❫\n*📬¦ تم الغاء حظره من التواصل\n✓*'
tahadevDEVIL:del('numlocktextpv'..bot_id..id_user)    tahadevDEVIL:srem(DEVDEVIL..'pv:ban'..msg.chat_id_,id_user)
...
if text == 'فتح الكل' and is_devtaha(msg) then   taha = '*🚸¦* تم فتح جميع الاوامر   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      tahadevDEVIL:del(DEVDEVIL..'lock:photo'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:vico'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:ste'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:file'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:phon'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:links'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:ved'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:fwd'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:gif'..bot_id)    tahadevDEVIL:del(DEVDEVIL..'lock:musec'..bot_id)    end      
if text == 'قفل الكل' and is_devtaha(msg) then   taha = '*📛¦* تم قفل جميع الاوامر  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      tahadevDEVIL:set(DEVDEVIL..'lock:photo'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:vico'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:ste'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:file'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:phon'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:links'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:ved'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:fwd'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:gif'..bot_id,true)    tahadevDEVIL:set(DEVDEVIL..'lock:musec'..bot_id,true)     end   
if text == 'فتح الصور' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصور   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:photo'..bot_id) end  
if text == 'قفل الصور' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصور  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:photo'..bot_id,true) end 
if text == 'فتح الصوت' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصوت   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:vico'..bot_id) end  
if text == 'قفل الصوت' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصوت  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:vico'..bot_id,true) end 
if text == 'فتح الاغاني' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الاغاني   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:musec'..bot_id) end  
if text == 'قفل الاغاني' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الاغاني  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:musec'..bot_id,true) end 
if text == 'فتح المتحركه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح المتحركه   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:gif'..bot_id) end  
if text == 'قفل المتحركه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل المتحركه  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:gif'..bot_id,true) end 
if text == 'فتح التوجيه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح التوجيه   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:fwd'..bot_id) end  
if text == 'قفل التوجيه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل التوحيه  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:fwd'..bot_id,true) end 
if text == 'فتح الفيديو' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الفيديو   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:ved'..bot_id) end  
if text == 'قفل الفيديو' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الفيديو  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:ved'..bot_id,true) end 
if text == 'فتح الروابط' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الروابط   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:links'..bot_id) end  
if text == 'قفل الروابط' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الروابط  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:links'..bot_id,true) end 
if text == 'فتح الجهات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الجهات   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:phon'..bot_id) end  
if text == 'قفل الجهات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الجهات  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:phon'..bot_id,true) end 
if text == 'فتح الملفات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملفات   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:file'..bot_id) end  
if text == 'قفل الملفات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملفات  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:file'..bot_id,true) end 
if text == 'فتح الملصقات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملصقات   ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:del(DEVDEVIL..'lock:ste'..bot_id) end  
if text == 'قفل الملصقات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملصقات  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevDEVIL:set(DEVDEVIL..'lock:ste'..bot_id,true) end 
if text == 'الاعدادات 🔏' and is_devtaha(msg) then  if tahadevDEVIL:get(DEVDEVIL..'lock:photo'..bot_id) then    lock_photo = '* مقفل ✓ *'      else     lock_photo = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:vico'..bot_id) then    lockvic = '* مقفل ✓ *'      else     lockvic = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:ste'..bot_id) then    lockste = '* مقفل ✓ *'      else     lockste = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:file'..bot_id) then    lockfile = '* مقفل ✓ *'     else     lockfile = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:phon'..bot_id) then    lockphon = '* مقفل ✓ *'      else     lockphon = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:links'..bot_id) then    lock_link = '* مقفل ✓ *'      else     lock_link = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:ved'..bot_id) then    lock_vid = '* مقفل ✓ *'      else     lock_vid = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:fwd'..bot_id) then    lock_fwd = '* مقفل ✓ *'      else     lock_fwd = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:gif'..bot_id) then    lock_gif = '* مقفل ✓ *'      else     lock_gif = '*مفتوح ✘*'    end    if tahadevDEVIL:get(DEVDEVIL..'lock:musec'..bot_id) then    lock_muse = '* مقفل ✓ *'      else     lock_muse = '*مفتوح ✘*'    end    local text = '*📛¦* اهلا بك في اعدادات الخاص 🍃'..'\n*ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ*\n'..    '\n*📬¦* الروابط '..lock_link..    '\n'..'*📬¦* الصور '..lock_photo..    '\n'..'*📬¦* الاغاني '..lockvic..    '\n'..'*📬¦* الملصقات '..lockste..    '\n'..'*📬¦* الملفات '..lockfile..    '\n'..'*📬¦* الجهات '..lockphon..    '\n'..'*📬¦* الفيديو '..lock_vid..    '\n'..'*📬¦* التوجيه '..lock_fwd..    '\n'..'*📬¦* المتحركه '..lock_gif..    '\n'..'*📬¦* الصوت '..lock_muse..    '\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🚨*¦* اضافه الى ذالك تستطيع قفل وفتح الكل\n🚸*¦* قفل الكل \n🚸*¦* فتح الكل'    DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, text, 1, 'md')     end     
...
if text == 'مسح المحظورين 📢' and is_devtaha(msg) then       local list = tahadevDEVIL:smembers(DEVDEVIL..'pv:ban'..msg.chat_id_)   for k,v in pairs(list) do     tahadevDEVIL:del(DEVDEVIL..'pv:ban'..msg.chat_id_)   tahadevDEVIL:del('numlocktextpv'..bot_id..v)  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📛*¦* تم مسح المحظورين', 1, 'md')     end
if text == 'تفعيل البوت الخدمي 🎮' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل البوت خدمي  ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevDEVIL:del(DEVDEVIL..'lock:bot:free'..bot_id) end 
if text == 'تعطيل البوت الخدمي 🚸' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل البوت الخدمي  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevDEVIL:set(DEVDEVIL..'lock:bot:free'..bot_id,true) end
if text == 'تفعيل تواصل 📨' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل بوت التواصل  ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevDEVIL:del(DEVDEVIL..'lock:botl'..bot_id) end 
if text == 'تعطيل تواصل 📩' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل التواصل  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevDEVIL:set(DEVDEVIL..'lock:botl'..bot_id,true) end
...
if text == "وضع اسم البوت ⚡" and is_devtaha(msg) then tahadevDEVIL:setex(DEVDEVIL..'namebot:witting'..msg.sender_user_id_,300,true) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* ارسل لي الاسم 📯\n",1, 'md')  end
if text == 'مسح المميزين عام 🌟' and is_devtaha(msg) then      local list = tahadevDEVIL:smembers(DEVDEVIL..'vip:groups')    if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL.."vip:groups",v)    num = num + 1  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين عام *\n', 1, 'md')   end
if text == 'مسح المطورين 👮' and is_devtaha(msg) then     local list = tahadevDEVIL:smembers(DEVDEVIL..'sudo:bot')    if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مطورين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL.."sudo:bot",v)    num = num + 1  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المطورين *\n', 1, 'md')   end
if text == 'مسح قائمه العام 🚷' and is_devtaha(msg) then   local list = tahadevDEVIL:smembers(DEVDEVIL..'DEVIL:gbaned')    if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL.."DEVIL:gbaned",v)    num = num + 1  end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md')   end
if text and text:match("^ضع رد تواصل 💻$") and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور 🎐$") and is_devtaha(msg) then tahadevDEVIL:setex(DEVDEVIL.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت 📠$") and is_devtaha(msg) then tahadevDEVIL:setex(DEVDEVIL.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text == 'تفعيل رساله الترحيب 🎌' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل رسالة ترحيب عند الاضافه  ✔' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevDEVIL:del(DEVDEVIL..'lock:klsh:add'..bot_id) end 
if text == 'تعطيل رساله الترحيب 📱' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل رسالة ترحيب عند الاضافه  ❌' DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevDEVIL:set(DEVDEVIL..'lock:klsh:add'..bot_id,true) end
if text == "حذف رد التواصل 🔧" and is_devtaha(msg) then  tahadevDEVIL:del(DEVDEVIL.."pvstart") DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") end 
if text == "حذف كليشه ستارت 🃏" and is_devtaha(msg) then  tahadevDEVIL:del(DEVDEVIL.."start:msgofstart1") DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") end 
if text == "حذف كليشه المطور 🀄" and is_devtaha(msg) then  tahadevDEVIL:del(DEVDEVIL.."dev") DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") end 
if text and text:match("^ضع عدد الاعضاء 📜$") and is_devtaha(msg) then  tahadevDEVIL:setex(DEVDEVIL.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📊¦ ارسل لي العدد الان*'  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') end
if text == "جلب رد التواصل 📚" and is_devtaha(msg) then if tahadevDEVIL:get(DEVDEVIL.."pvstart") then pvstart = tahadevDEVIL:get(DEVDEVIL.."pvstart") DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(pvstart)..'', 1, 'md')  else  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*✉¦ لا يوجد رد في التواصل \n📮¦* ارسل `ضع رد التواصل`\n🍃', 1, 'md')  end  end
if text == "جلب كليشه ستارت 📚" and is_devtaha(msg) then  local start = tahadevDEVIL:get(DEVDEVIL.."start:msgofstart1")  if start then DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(start)..'', 1, 'md') else DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*🎭¦ لم يتم وضع كليشه ستارت *\n', 1, 'md') end end
if text == 'الاحصائيات 🔭' and is_devtaha(msg) then    local grall = tahadevDEVIL:scard(DEVDEVIL.."botgps") or 0    local gradd = tahadevDEVIL:scard(DEVDEVIL..'bot:gpsby:id') or 0    local uspv = tahadevDEVIL:scard(DEVDEVIL.."usersbot") or 0    DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ عدد المجموعات الكلي ↫ ❪'..grall..'❫\n📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n📛¦ عدد المجموعات غير مفعله ↫ ❪'..(grall - gradd)..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md')   end
if text=="اذاعه بالتوجيه 📬" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للمجموعات\n✓", 1, "md")   end
if text=="اذاعه خاص بالتوجيه 🔮" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للخاص\n✓", 1, "md")   end
if text=="اذاعه عام بالتوجيه 💾" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للكل\n✓", 1, "md")   end
if text=="اذاعه 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى المجموعات\n✓", 1, "md")   end
if text=="اذاعه للكل 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الكل\n✓", 1, "md")   end
if text=="اذاعه خاص 📡" and msg.reply_to_message_id_ == 0 and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الخاص\n✓", 1, "md")   end 
if text ==('المجموعات 📇') and is_devtaha(msg) then    local list = tahadevDEVIL:smembers(DEVDEVIL..'bot:gpsby:id')   if #list == 0 then  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*💥¦ لا توجد مجموعات حاليا *\n', 1, 'md')  return false  end local t = '⚡¦* اهلا بك في ايدي المجموعات 🍁*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'    for k,v in pairs(list) do     local nummsg = tonumber(tahadevDEVIL:get(DEVDEVIL..'groupmsg:'..v..':'))   numrgroup(v) local numg = (tahadevDEVIL:get(DEVDEVIL.."numgrop"..v) or '3')  local namechat = tahadevDEVIL:get(DEVDEVIL..'group:name'..v)   if namechat then  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n*« "..namechat..' » ❪'..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     else  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n* ❪"..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     end  file = io.open("DEVIL_groups", "w") file:write([[ ]]..isnothtml(t)..[[ ]]) file:close()   end    t = t..'*📮¦*لعرض معلومات مجموعه معينه\n*💥¦ ارسل كشف من ثم ايدي المجموعه*\n*🚸¦ مثال ❪كشف -10012345667❫*\n꞉'    if #list >= 25 then    local groups = tahadevDEVIL:scard(DEVDEVIL..'bot:gpsby:id')    sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DEVIL_groups','📛¦ عذرا لديك الكثير من المجموعات\n📬¦ تم ارسال المجموعات في الملف\n🚸¦ عدد المجموعات •⊱'..groups..'⊰•',dl_cb, nil)   else   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')    end   end
...
if text == 'مسح المشتركين 💯' and is_devtaha(msg) then     local list = tahadevDEVIL:smembers(DEVDEVIL..'usersbot')     local pv = 0  for k,v in pairs(list) do      tahadevDEVIL:srem(DEVDEVIL..'usersbot',v)    pv = pv + 1  end     DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md')   end  
if text == 'مسح المجموعات 💯' and is_devtaha(msg) then   local lgp = tahadevDEVIL:smembers(DEVDEVIL.."bot:gpsby:id")   local lsug = tahadevDEVIL:smembers(DEVDEVIL.."botgps")   local lgpn = tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id")   local lsugn = tahadevDEVIL:scard(DEVDEVIL.."botgps") + tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id")   for k,v in pairs(lgp) do   rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   for k,v in pairs(lsug) do    rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,"*📮¦* تم مغادره البوت من » ❪"..lsugn.."❫ مجموعات \n✓", 1, 'md')   end
if text == 'المحظورين عام 📑' and is_devtaha(msg) then   local list = tahadevDEVIL:smembers(DEVDEVIL..'DEVIL:gbaned')  local t = '*📮¦ قائمه المحظورين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevDEVIL:get(DEVDEVIL.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد محظورين عام في البوت'   end   DEVIL_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text == 'المطورين 📑' and is_devtaha(msg) then   local list = tahadevDEVIL:smembers(DEVDEVIL..'sudo:bot')  local t = '*📮¦ قائمه مطورين البوت *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevDEVIL:get(DEVDEVIL.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد مطورين في البوت'   end   DEVIL_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text == 'المميزين عام 📑' and is_devtaha(msg) then   local list = tahadevDEVIL:smembers(DEVDEVIL..'vip:groups')  local t = '*📮¦ قائمه المميزين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevDEVIL:get(DEVDEVIL.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد مميزين عام في البوت'   end   DEVIL_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text and text:match("^استخراج الرابط 🔦$") and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')  end
if text and text:match("^كشف 🔍$") and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'   DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')  end
end
if chat_type == 'super' then 
if not tahadevDEVIL:sismember(DEVDEVIL..'bot:gpsby:id',msg.chat_id_) then
...
if msg.content_.ID == "MessageChatAddMembers" then 
return else
local post_count = tonumber(tahadevDEVIL:get(DEVDEVIL..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
...
tahadevDEVIL:setex(DEVDEVIL..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(tahadevDEVIL:hget("flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
end 
end
...
tahadevDEVIL:del(DEVDEVIL.."lockpin"..msg.chat_id_) 
else
if msg.content_.ID == 'MessagePinMessage' then    
if is_owner(msg) and tahadevDEVIL:get(DEVDEVIL.."lockpin"..msg.chat_id_) then    
tahadevDEVIL:set(DEVDEVIL..'pinned'..msg.chat_id_, msg.content_.message_id_) 
elseif not tahadevDEVIL:get(DEVDEVIL.."lockpin"..msg.chat_id_) then    
tahadevDEVIL:set(DEVDEVIL..'pinned'..msg.chat_id_, msg.content_.message_id_)    
end    
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lockpin"..msg.chat_id_) then 
if msg.content_.ID == 'MessagePinMessage' then  
unpinChannelMessage(msg.chat_id_)  
local PinnedMessage = tahadevDEVIL:get(DEVDEVIL..'pinned'..msg.chat_id_)  
...
if tahadevDEVIL:get(DEVDEVIL..'lock:text'..msg.chat_id_) then       
delete_msg(msg.chat_id_,{[0] = msg.id_})   
return false end    
end     
---الاشعارات
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChangePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChangeTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if tahadevDEVIL:get(DEVDEVIL..'lock:tagservr'..msg.chat_id_) then  
delete_msg(msg.chat_id_,{[0] = msg.id_})       
end    
end   
---الاضافات والدخول
if msg.content_.ID == "MessageChatAddMembers" and not is_vipgroup(msg) then   
if tahadevDEVIL:get(DEVDEVIL.."lock:AddMempar"..msg.chat_id_) == 'kick' then
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Join"..msg.chat_id_) == 'kick' then
...
if tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" and not is_vipgroup(msg) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Photo"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Photo"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Photo"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Photo"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Video"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Video"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Video"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Video"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Animation"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Animation"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Animation"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Animation"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:geam"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:geam"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:geam"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:geam"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Audio"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Audio"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Audio"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Audio"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:vico"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:vico"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:vico"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:vico"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Keyboard"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Keyboard"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Keyboard"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Keyboard"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Sticker"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Sticker"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Sticker"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Sticker"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:forward"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif tahadevDEVIL:get(DEVDEVIL.."lock:forward"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif tahadevDEVIL:get(DEVDEVIL.."lock:forward"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif tahadevDEVIL:get(DEVDEVIL.."lock:forward"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Document"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Document"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Document"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Document"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Unsupported"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Unsupported"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Unsupported"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Unsupported"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not is_vipgroup(msg) then
if tahadevDEVIL:get(DEVDEVIL.."lock:Markdaun"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Markdaun"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Markdaun"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Markdaun"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Contact"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Contact"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Contact"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Contact"..msg.chat_id_) == "ktm" then
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "del" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "ked" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "kick" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "ktm" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
local status_welcome = (tahadevDEVIL:get(DEVDEVIL..'add:welc:'..msg.chat_id_) or 'rem')  
if status_welcome == 'add' and not tahadevDEVIL:get(DEVDEVIL..'lock:tagservr'..msg.chat_id_)  then
if msg.content_.ID == "MessageChatJoinByLink" then
if not is_banned(msg.chat_id_,msg.sender_user_id_) then 
function wlc(extra,result,success) 
if tahadevDEVIL:get(DEVDEVIL..'welcome:'..msg.chat_id_) then 
t = tahadevDEVIL:get(DEVDEVIL..'welcome:'..msg.chat_id_) 
else  
t = '\n• نورت حبي \n•  name \n• ngp' 
end 
t = t:gsub('name','<DEVIL>'..CatchName(result.first_name_,25)..'</DEVIL>') 
t = t:gsub('ngp',tahadevDEVIL:get(DEVDEVIL..'group:name'..msg.chat_id_)) 
...
tahadevDEVIL:set(DEVDEVIL.."lock:text"..msg.chat_id_,true) 
...
tahadevDEVIL:setex(DEVDEVIL.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📋¦* ارسل النص الذي تريده '  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^ضع ترحيب$") and is_mod(msg) then  
tahadevDEVIL:setex(DEVDEVIL.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📃¦* ارسل النص الذي تريده '  
local tt = '\n*📬¦* ايضا يمكنك وضع \n*📛¦* دالة طباعه الاسم `name` \n*📛¦* ودالة طباعه اسم المجموعه `ngp`'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t..tt, 1, 'md') 
end
if text and text:match("^جلب صوره$") and not tahadevDEVIL:get(DEVDEVIL.."lock:get:photo"..msg.chat_id_) then  
tahadevDEVIL:setex(DEVDEVIL.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
...
local list = tahadevDEVIL:smembers(DEVDEVIL.."rep:media"..msg.chat_id_)  
local taha = tahadevDEVIL:scard(DEVDEVIL.."rep:media"..msg.chat_id_)  
for k,v in pairs(list) do  
tahadevDEVIL:del(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:gif"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:vico"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:stekr"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."taha:"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:photo"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:video"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:document"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:audio"..v..msg.chat_id_)  
tahadevDEVIL:srem(DEVDEVIL.."rep:media"..msg.chat_id_,v)  
end  
...
for k,v in pairs(list) do  
if tahadevDEVIL:get(DEVDEVIL.."addreply1:gif"..v..msg.chat_id_) then
taha = 'متحركه 🎆'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:vico"..v..msg.chat_id_)  then
taha = 'بصمه 🎵'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:stekr"..v..msg.chat_id_)  then
taha = 'ملصق 🃏'
elseif tahadevDEVIL:get(DEVDEVIL.."taha:"..v..msg.chat_id_) then
taha = 'رساله 💭'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:photo"..v..msg.chat_id_)  then
taha = 'صوره 🌇'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:video"..v..msg.chat_id_)  then
taha = 'فيديو 📹'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:document"..v..msg.chat_id_)  then
taha = 'ملف 📁'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:audio"..v..msg.chat_id_)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end  
...
tahadevDEVIL:set(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  end    
if text then   
local tsssst = tahadevDEVIL:get(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if tahadevDEVIL:sismember(DEVDEVIL..'rep:media'..msg.chat_id_,text) then
...
tahadevDEVIL:set(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"repp")  
tahadevDEVIL:set(DEVDEVIL.."addreply2:"..msg.sender_user_id_..msg.chat_id_, text)  
tahadevDEVIL:sadd(DEVDEVIL.."rep:media"..msg.chat_id_,text)  
end
return false  end  
end  
if text and text == 'حذف رد بالرد' and  is_monsh(msg) then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = tahadevDEVIL:get(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if not tahadevDEVIL:sismember(DEVDEVIL..'rep:media'..msg.chat_id_,text) then
tahadevDEVIL:del(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
...
tahadevDEVIL:del(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:gif"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:vico"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:stekr"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."taha:"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:photo"..text..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:video"..text..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:document"..text..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:audio"..text..msg.chat_id_)
tahadevDEVIL:srem(DEVDEVIL.."rep:media"..msg.chat_id_,text)  
end
return false  end  
end
...
tahadevDEVIL:del(DEVDEVIL.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
local test = tahadevDEVIL:get(DEVDEVIL.."addreply2:"..msg.sender_user_id_..msg.chat_id_)  
if msg.content_.sticker_ then   
tahadevDEVIL:set(DEVDEVIL.."addreply1:stekr"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
tahadevDEVIL:set(DEVDEVIL.."addreply1:vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
tahadevDEVIL:set(DEVDEVIL.."addreply1:gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
tahadevDEVIL:set(DEVDEVIL.."taha:"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
tahadevDEVIL:set(DEVDEVIL.."addreply1:audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevDEVIL:set(DEVDEVIL.."addreply1:document"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevDEVIL:set(DEVDEVIL.."addreply1:video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
tahadevDEVIL:set(DEVDEVIL.."addreply1:video:caption"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
tahadevDEVIL:set(DEVDEVIL.."addreply1:photo"..test..msg.chat_id_, photo_in_group)  
tahadevDEVIL:set(DEVDEVIL.."addreply1:photo:caption"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
tahadevDEVIL:del(DEVDEVIL.."addreply2:"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text and msg.reply_to_message_id_ ~= 0 and not tahadevDEVIL:get(DEVDEVIL..'lock:rep:rd'..msg.chat_id_) then  
local anemi = tahadevDEVIL:get(DEVDEVIL.."addreply1:gif"..text..msg.chat_id_)   
local veico = tahadevDEVIL:get(DEVDEVIL.."addreply1:vico"..text..msg.chat_id_)   
local stekr = tahadevDEVIL:get(DEVDEVIL.."addreply1:stekr"..text..msg.chat_id_)     
local taha = tahadevDEVIL:get(DEVDEVIL.."taha:"..text..msg.chat_id_)   
local photo = tahadevDEVIL:get(DEVDEVIL.."addreply1:photo"..text..msg.chat_id_)
local photo_caption = (tahadevDEVIL:get(DEVDEVIL.."addreply1:photo:caption"..text..msg.chat_id_) or '' )
local video = tahadevDEVIL:get(DEVDEVIL.."addreply1:video"..text..msg.chat_id_)
local video_caption = tahadevDEVIL:get(DEVDEVIL.."addreply1:video:caption"..text..msg.chat_id_)
local document = tahadevDEVIL:get(DEVDEVIL.."addreply1:document"..text..msg.chat_id_)
local audio = tahadevDEVIL:get(DEVDEVIL.."addreply1:audio"..text..msg.chat_id_)
if taha then    
...
local list = tahadevDEVIL:smembers(DEVDEVIL.."repmedia"..msg.chat_id_)  
local taha = tahadevDEVIL:scard(DEVDEVIL.."repmedia"..msg.chat_id_)  
for k,v in pairs(list) do  
tahadevDEVIL:del(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply1:gif"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply1:vico"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply1:stekr"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply:rd"..v..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:photo:gp"..v..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:video:gp"..v..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:document:gp"..v..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:audio:gp"..v..msg.chat_id_)
tahadevDEVIL:srem(DEVDEVIL.."repmedia"..msg.chat_id_,v)  
end  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')  
end
...
for k,v in pairs(list) do  
if tahadevDEVIL:get(DEVDEVIL.."add:reply1:gif"..v..msg.chat_id_) then
taha = 'متحركه 🎆'
elseif tahadevDEVIL:get(DEVDEVIL.."add:reply1:vico"..v..msg.chat_id_) then
taha = 'بصمه 🎙'
elseif tahadevDEVIL:get(DEVDEVIL.."add:reply1:stekr"..v..msg.chat_id_) then
taha = 'ملصق 🃏'
elseif tahadevDEVIL:get(DEVDEVIL.."add:reply:rd"..v..msg.chat_id_) then
taha = 'رساله 💭'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:photo:gp"..v..msg.chat_id_) then
taha = 'صوره 🌇'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:video:gp"..v..msg.chat_id_) then
taha = 'فيديو 📹'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:document:gp"..v..msg.chat_id_) then
taha = 'ملف 📁'
elseif tahadevDEVIL:get(DEVDEVIL.."addreply1:audio:gp"..v..msg.chat_id_) then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = tahadevDEVIL:get(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if tahadevDEVIL:sismember(DEVDEVIL..'repmedia'..msg.chat_id_,text) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"repp")  
tahadevDEVIL:set(DEVDEVIL.."add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
tahadevDEVIL:sadd(DEVDEVIL.."repmedia"..msg.chat_id_,text)  
end
return false  end  
end
if text == 'حذف رد' and is_monsh(msg) then   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = tahadevDEVIL:get(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
if not tahadevDEVIL:sismember(DEVDEVIL..'repmedia'..msg.chat_id_,text) then
tahadevDEVIL:del(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦ الكلمه » {* ["..text.."] *} 🍃\n⚡¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ الكلمه » {* ["..text.."] *} 🍃\n📬¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
tahadevDEVIL:del(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply1:gif"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply1:vico"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply1:stekr"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."add:reply:rd"..text..msg.chat_id_)  
tahadevDEVIL:del(DEVDEVIL.."addreply1:photo:gp"..text..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:video:gp"..text..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:document:gp"..text..msg.chat_id_)
tahadevDEVIL:del(DEVDEVIL.."addreply1:audio:gp"..text..msg.chat_id_)
tahadevDEVIL:srem(DEVDEVIL.."repmedia"..msg.chat_id_,text)  
end
return false  end  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📌¦ تم حفظ الردَ الخاص پك\n📨¦ نو؏ الرد — { '..what..' }*', 1, 'md')  
tahadevDEVIL:del(DEVDEVIL.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
local test = tahadevDEVIL:get(DEVDEVIL.."add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if msg.content_.sticker_ then   
tahadevDEVIL:set(DEVDEVIL.."add:reply1:stekr"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
tahadevDEVIL:set(DEVDEVIL.."add:reply1:vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
tahadevDEVIL:set(DEVDEVIL.."add:reply1:gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
tahadevDEVIL:set(DEVDEVIL.."add:reply:rd"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
tahadevDEVIL:set(DEVDEVIL.."addreply1:audio:gp"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevDEVIL:set(DEVDEVIL.."addreply1:document:gp"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevDEVIL:set(DEVDEVIL.."addreply1:video:gp"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
tahadevDEVIL:set(DEVDEVIL.."addreply1:video:caption:gp"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
tahadevDEVIL:set(DEVDEVIL.."addreply1:photo:gp"..test..msg.chat_id_, photo_in_group)  
tahadevDEVIL:set(DEVDEVIL.."addreply1:photo:caption:gp"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
tahadevDEVIL:del(DEVDEVIL.."add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
if text and not tahadevDEVIL:get(DEVDEVIL..'lock:rep'..msg.chat_id_) then  
local anemi = tahadevDEVIL:get(DEVDEVIL.."add:reply1:gif"..text..msg.chat_id_)   
local veico = tahadevDEVIL:get(DEVDEVIL.."add:reply1:vico"..text..msg.chat_id_)   
local stekr = tahadevDEVIL:get(DEVDEVIL.."add:reply1:stekr"..text..msg.chat_id_)     
local taha = tahadevDEVIL:get(DEVDEVIL.."add:reply:rd"..text..msg.chat_id_)   
local video_caption = tahadevDEVIL:get(DEVDEVIL.."addreply1:video:caption:gp"..text..msg.chat_id_)
local photo_caption = (tahadevDEVIL:get(DEVDEVIL.."addreply1:photo:caption:gp"..text..msg.chat_id_) or '' )
local photo = tahadevDEVIL:get(DEVDEVIL.."addreply1:photo:gp"..text..msg.chat_id_)
local video = tahadevDEVIL:get(DEVDEVIL.."addreply1:video:gp"..text..msg.chat_id_)
local document = tahadevDEVIL:get(DEVDEVIL.."addreply1:document:gp"..text..msg.chat_id_)
local audio = tahadevDEVIL:get(DEVDEVIL.."addreply1:audio:gp"..text..msg.chat_id_)
if taha then    
...
if tahadevDEVIL:get(DEVDEVIL..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تفعيل ردود المطور بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:rep:all:rd'..bot_id)   
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تعطيل ردود المطور بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:rep:all:rd'..bot_id,true)   
else
...
local list = tahadevDEVIL:smembers(DEVDEVIL.."rep:media:all:rd"..bot_id)    
local taha = tahadevDEVIL:scard(DEVDEVIL.."rep:media:all:rd"..bot_id)    
for k,v in pairs(list) do    
tahadevDEVIL:del(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:repallt:gif:all:rd"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tvico:all:rd"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tstekr:all:rd"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:text:all:rd"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:photo:gp"..v..bot_id)
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:video:gp"..v..bot_id)
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:document:gp"..v..bot_id)
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:audio:gp"..v..bot_id)
tahadevDEVIL:srem(DEVDEVIL.."rep:media:all:rd"..bot_id,v)    
end    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')    
end
...
for k,v in pairs(list) do    
if tahadevDEVIL:get(DEVDEVIL.."add:repallt:gif:all:rd"..v..bot_id) then
taha = 'متحركه 🎆'
elseif tahadevDEVIL:get(DEVDEVIL.."add:rep:tvico:all:rd"..v..bot_id) then
taha = 'بصمه 🎙'
elseif tahadevDEVIL:get(DEVDEVIL.."add:rep:tstekr:all:rd"..v..bot_id)  then
taha = 'ملصق 🃏'
elseif tahadevDEVIL:get(DEVDEVIL.."add:rep:text:all:rd"..v..bot_id) then
taha = 'رساله 💭'
elseif tahadevDEVIL:get(DEVDEVIL.."all:addreply1:photo:gp"..v..bot_id)  then
taha = 'صوره 🌇'
elseif tahadevDEVIL:get(DEVDEVIL.."all:addreply1:video:gp"..v..bot_id)  then
taha = 'فيديو 📹'
elseif tahadevDEVIL:get(DEVDEVIL.."all:addreply1:document:gp"..v..bot_id)  then
taha = 'ملف 📁'
elseif tahadevDEVIL:get(DEVDEVIL.."all:addreply1:audio:gp"..v..bot_id)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end    
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes')    
return false    end      
if text then     
local tt = tahadevDEVIL:get(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
if tt == 'yes' then     
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
return false  end 
if tahadevDEVIL:sismember(DEVDEVIL.."rep:media:all:rd"..bot_id,text) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes1')    
tahadevDEVIL:set(DEVDEVIL.."addreply2:"..msg.sender_user_id_..bot_id, text)    
tahadevDEVIL:sadd(DEVDEVIL.."rep:media:all:rd"..bot_id,text)    
end
return false    end    
end
if text and text == 'حذف رد بالرد عام' and  is_devtaha(msg) then     
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes11')    
return false    end    
--للكل بالرد
if text then 
local test = tahadevDEVIL:get(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
if test and test == 'yes11' then     
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
return false  end 
if not tahadevDEVIL:sismember(DEVDEVIL..'rep:media:all:rd'..bot_id,text) then
tahadevDEVIL:del(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*🎫¦ الكلمه » {* ["..text.."] *} 🍂\n📮¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📌¦ الكلمه » {* ["..text.."] *} 🍂\n💢¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
tahadevDEVIL:del(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:repallt:gif:all:rd"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tvico:all:rd"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tstekr:all:rd"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:text:all:rd"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:photo:gp"..text..bot_id)
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:video:gp"..text..bot_id)
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:document:gp"..text..bot_id)
tahadevDEVIL:del(DEVDEVIL.."all:addreply1:audio:gp"..text..bot_id)
tahadevDEVIL:srem(DEVDEVIL.."rep:media:all:rd"..bot_id,text)    
end
return false    end    
end
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📌¦ تم حفظ الردَ الخاص پك\n📨¦ نو؏ الرد — { '..what..' }*', 1, 'md')  
tahadevDEVIL:del(DEVDEVIL.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
local test = tahadevDEVIL:get(DEVDEVIL.."addreply2:"..msg.sender_user_id_..bot_id)    
if msg.content_.sticker_ then     
tahadevDEVIL:set(DEVDEVIL.."add:rep:tstekr:all:rd"..test..bot_id, msg.content_.sticker_.sticker_.persistent_id_)    
end     
if msg.content_.voice_ then    
tahadevDEVIL:set(DEVDEVIL.."add:rep:tvico:all:rd"..test..bot_id, msg.content_.voice_.voice_.persistent_id_)    
end     
if msg.content_.animation_ then     
tahadevDEVIL:set(DEVDEVIL.."add:repallt:gif:all:rd"..test..bot_id, msg.content_.animation_.animation_.persistent_id_)    
end    
if text then     
tahadevDEVIL:set(DEVDEVIL.."add:rep:text:all:rd"..test..bot_id, text)    
end    
if msg.content_.audio_ then
tahadevDEVIL:set(DEVDEVIL.."all:addreply1:audio:gp"..test..bot_id, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevDEVIL:set(DEVDEVIL.."all:addreply1:document:gp"..test..bot_id, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevDEVIL:set(DEVDEVIL.."all:addreply1:video:gp"..test..bot_id, msg.content_.video_.video_.persistent_id_)  
tahadevDEVIL:set(DEVDEVIL.."all:addreply1:video:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
tahadevDEVIL:set(DEVDEVIL.."all:addreply1:photo:gp"..test..bot_id, photo_in_group)  
tahadevDEVIL:set(DEVDEVIL.."all:addreply1:photo:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
tahadevDEVIL:del(DEVDEVIL.."addreply2:"..msg.sender_user_id_..bot_id)    
return false    
end    
end
if text and msg.reply_to_message_id_ ~= 0 and not tahadevDEVIL:get(DEVDEVIL..'lock:rep:all:rd'..bot_id) then   
local anemi = tahadevDEVIL:get(DEVDEVIL.."add:repallt:gif:all:rd"..text..bot_id)    
local veico = tahadevDEVIL:get(DEVDEVIL.."add:rep:tvico:all:rd"..text..bot_id)    
local stekr = tahadevDEVIL:get(DEVDEVIL.."add:rep:tstekr:all:rd"..text..bot_id)      
local taha = tahadevDEVIL:get(DEVDEVIL.."add:rep:text:all:rd"..text..bot_id)    
local video_caption = tahadevDEVIL:get(DEVDEVIL.."all:addreply1:video:caption:gp"..text..bot_id)
local photo_caption = (tahadevDEVIL:get(DEVDEVIL.."all:addreply1:photo:caption:gp"..text..bot_id) or '' )
local photo = tahadevDEVIL:get(DEVDEVIL.."all:addreply1:photo:gp"..text..bot_id)
local video = tahadevDEVIL:get(DEVDEVIL.."all:addreply1:video:gp"..text..bot_id)
local document = tahadevDEVIL:get(DEVDEVIL.."all:addreply1:document:gp"..text..bot_id)
local audio = tahadevDEVIL:get(DEVDEVIL.."all:addreply1:audio:gp"..text..bot_id)
if taha then     
DEVIL_sendMsg(msg.chat_id_, msg.reply_to_message_id_, 1, ''..check_markdown(taha)..'', 1, 'md')      
return false    
end     
...
if tahadevDEVIL:get(DEVDEVIL..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تفعيل ردود المطور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:rep:all'..bot_id)   
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تعطيل ردود المطور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:rep:all'..bot_id,true)   
else
...
local list = tahadevDEVIL:smembers(DEVDEVIL.."rep:media:all"..bot_id)    
local taha = tahadevDEVIL:scard(DEVDEVIL.."rep:media:all"..bot_id)    
for k,v in pairs(list) do    
tahadevDEVIL:del(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:repallt:gif:all"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tvico:all"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tstekr:all"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:text:all"..v..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:photo:gp"..v..bot_id)
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:video:gp"..v..bot_id)
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:document:gp"..v..bot_id)
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:audio:gp"..v..bot_id)
tahadevDEVIL:srem(DEVDEVIL.."rep:media:all"..bot_id,v)    
...
t = "*📮¦ قائمة ردود المطور 🍃\nٴ━━━━━━━━━━━*\n"    
for k,v in pairs(list) do    
if tahadevDEVIL:get(DEVDEVIL.."add:repallt:gif:all"..v..bot_id) then
taha = 'متحركه 🎆'
elseif tahadevDEVIL:get(DEVDEVIL.."add:rep:tvico:all"..v..bot_id) then
taha = 'بصمه 🎙'
elseif tahadevDEVIL:get(DEVDEVIL.."add:rep:tstekr:all"..v..bot_id) then
taha = 'ملصق 🃏'
elseif tahadevDEVIL:get(DEVDEVIL.."add:rep:text:all"..v..bot_id) then
taha = 'رساله 💭'
elseif tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:photo:gp"..v..bot_id)  then
taha = 'صوره 🌇'
elseif tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:video:gp"..v..bot_id)  then
taha = 'فيديو 📹'
elseif tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:document:gp"..v..bot_id)  then
taha = 'ملف 📁'
elseif tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:audio:gp"..v..bot_id)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end    
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id,'yes')    
return false    end      
if text then    
local tt = tahadevDEVIL:get(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
if tt == 'yes' then     
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
return false  end 
if tahadevDEVIL:sismember(DEVDEVIL.."rep:media:all"..bot_id,text) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id,'yes1')    
tahadevDEVIL:set(DEVDEVIL.."addreply2:"..msg.sender_user_id_..bot_id, text)    
tahadevDEVIL:sadd(DEVDEVIL.."rep:media:all"..bot_id,text)    
end
return false    end    
end
if text and text == 'حذف رد عام' and  is_devtaha(msg) then     
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevDEVIL:set(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id,'yes11')    
return false    end    
if text then 
local test = tahadevDEVIL:get(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
if test and test == 'yes11' then   
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
return false  end   
if not tahadevDEVIL:sismember(DEVDEVIL..'rep:media:all'..bot_id,text) then
tahadevDEVIL:del(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*🎫¦ الكلمه » {* ["..text.."] *} 🍂\n📮¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📌¦ الكلمه » {* ["..text.."] *} 🍂\n💢¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
tahadevDEVIL:del(DEVDEVIL.."add:repallt"..msg.sender_user_id_..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:repallt:gif:all"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tvico:all"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:tstekr:all"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."add:rep:text:all"..text..bot_id)    
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:photo:gp"..text..bot_id)
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:video:gp"..text..bot_id)
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:document:gp"..text..bot_id)
tahadevDEVIL:del(DEVDEVIL.."mall:addreply1:audio:gp"..text..bot_id)
tahadevDEVIL:srem(DEVDEVIL.."rep:media:all"..bot_id,text)    
end
return false    end    
end    
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
...
local test = tahadevDEVIL:get(DEVDEVIL.."addreply2:"..msg.sender_user_id_..bot_id)    
if msg.content_.sticker_ then     
tahadevDEVIL:set(DEVDEVIL.."add:rep:tstekr:all"..test..bot_id, msg.content_.sticker_.sticker_.persistent_id_)    
end     
if msg.content_.voice_ then    
tahadevDEVIL:set(DEVDEVIL.."add:rep:tvico:all"..test..bot_id, msg.content_.voice_.voice_.persistent_id_)    
end     
if msg.content_.animation_ then     
tahadevDEVIL:set(DEVDEVIL.."add:repallt:gif:all"..test..bot_id, msg.content_.animation_.animation_.persistent_id_)    
end    
if text then     
tahadevDEVIL:set(DEVDEVIL.."add:rep:text:all"..test..bot_id, text)    
end    
if msg.content_.audio_ then
tahadevDEVIL:set(DEVDEVIL.."mall:addreply1:audio:gp"..test..bot_id, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevDEVIL:set(DEVDEVIL.."mall:addreply1:document:gp"..test..bot_id, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevDEVIL:set(DEVDEVIL.."mall:addreply1:video:gp"..test..bot_id, msg.content_.video_.video_.persistent_id_)  
tahadevDEVIL:set(DEVDEVIL.."mall:addreply1:video:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
tahadevDEVIL:set(DEVDEVIL.."mall:addreply1:photo:gp"..test..bot_id, photo_in_group)  
tahadevDEVIL:set(DEVDEVIL.."mall:addreply1:photo:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
tahadevDEVIL:del(DEVDEVIL.."addreply2:"..msg.sender_user_id_..bot_id)    
return false    end    
end
if text and not tahadevDEVIL:get(DEVDEVIL..'lock:rep:all'..bot_id) then    
local anemi = tahadevDEVIL:get(DEVDEVIL.."add:repallt:gif:all"..text..bot_id)    
local veico = tahadevDEVIL:get(DEVDEVIL.."add:rep:tvico:all"..text..bot_id)    
local stekr = tahadevDEVIL:get(DEVDEVIL.."add:rep:tstekr:all"..text..bot_id)      
local taha = tahadevDEVIL:get(DEVDEVIL.."add:rep:text:all"..text..bot_id)    
local video_caption = tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:video:caption:gp"..text..bot_id)
local photo_caption = (tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:photo:caption:gp"..text..bot_id) or '' )
local photo = tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:photo:gp"..text..bot_id)
local video = tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:video:gp"..text..bot_id)
local document = tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:document:gp"..text..bot_id)
local audio = tahadevDEVIL:get(DEVDEVIL.."mall:addreply1:audio:gp"..text..bot_id)
if taha then     
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, ''..check_markdown(taha)..'', 1, 'md')      
return false    end     
if veico then     
...
local group = tahadevDEVIL:smembers(DEVDEVIL..'bot:gpsby:id')   
local w = 0
local q = 0
for i = 1, #group do
...
tahadevDEVIL:srem(DEVDEVIL.."bot:gpsby:id",group[i])  
rem_group(group[i])   
...
local pv = tahadevDEVIL:smembers(DEVDEVIL..'usersbot')   
local sendok = 0
for i = 1, #pv do
...
tahadevDEVIL:srem(DEVDEVIL.."usersbot",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if tahadevDEVIL:get(DEVDEVIL.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
tahadevDEVIL:del(DEVDEVIL..'id:gp'..msg.chat_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevDEVIL:del(DEVDEVIL.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(.*)") 
local iduserr = tahadevDEVIL:get(DEVDEVIL..'id:gp'..msg.chat_id_)  
...
tahadevDEVIL:set(DEVDEVIL..'id:gp'..msg.chat_id_,taha)  
tahadevDEVIL:setex(DEVDEVIL.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
...
if text then 
if is_mod(msg) then
if text == 'ارسال نسخه' and is_devtaha(msg) then  sendDocument(SUDO, 0, 0, 1, nil, './DEVIL.lua', '🚸¦اسم الملف ( DEVIL.lua )\n♻¦عدد المشتركين ( '..(tahadevDEVIL:scard(DEVDEVIL.."usersbot") or 0)..' )\n📮¦عدد المجموعات ( '..(tahadevDEVIL:scard(DEVDEVIL.."botgps") or 0)..' )',dl_cb, nil)  end
...
local pv = tahadevDEVIL:scard(DEVDEVIL.."usersbot")      
...
local grp = tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id")       
...
local grall = tahadevDEVIL:scard(DEVDEVIL.."botgps") or 0  
local gradd = tahadevDEVIL:scard(DEVDEVIL..'bot:gpsby:id') or 0  
local uspv = tahadevDEVIL:scard(DEVDEVIL.."usersbot") or 0  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ عدد المجموعات الكلي ↫ ❪'..grall..'❫\n📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n📛¦ عدد المجموعات غير مفعله ↫ ❪'..(grall - gradd)..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md') 
end
...
local pv = 0
for k,v in pairs(list) do    
tahadevDEVIL:srem(DEVDEVIL..'usersbot',v)  
pv = pv + 1
end   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md') 
end  
if text == 'غادر' and is_owner(msg) then 
tahadevDEVIL:srem(DEVDEVIL.."addgrop", msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL.."add:bot:group"..msg.chat_id_, true) 
rem_group(msg.chat_id_)  
rem_lockal(msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL.."test:group"..msg.chat_id_)   
tahadevDEVIL:del(DEVDEVIL..'moder'..msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL..'modergroup'..msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL..'mods:'..msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL.."add:bot:group"..msg.chat_id_, true) 
tahadevDEVIL:srem(DEVDEVIL..'bot:gpsby:id', msg.chat_id_)  
tahadevDEVIL:srem(DEVDEVIL.."botgps", msg.chat_id_)   
changeChatMemberStatus(msg.chat_id_, bot_id, "Left") 
...
local list = tahadevDEVIL:smembers(DEVDEVIL..'tedmembars'..msg.chat_id_) 
local pv = 0
for k,v in pairs(list) do   
tahadevDEVIL:del(DEVDEVIL..'tedmembars'..msg.chat_id_) 
tahadevDEVIL:srem(DEVDEVIL.."keed", msg.chat_id_)  
...
return false  end
if kk.id_ then  
local msgss = tonumber(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..kk.id_) or 0)  
...
t = 'مطور اساسي'
elseif tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',kk.id_) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,kk.id_) then
t = 'المنشئ'
elseif tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,kk.id_) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,kk.id_) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',kk.id_) then
t = 'مميز عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,kk.id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',kk.id_) then
kkeed = 'محظور عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,kk.id_) then
kkeed = 'محظور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,kk.id_) then
kkeed = 'مكتوم'
elseif tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,kk.id_) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
'` ❫\n⭐*¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..kk.id_) or 0)..
...
local msgss = tonumber(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..iduser) or 0)  
...
t = 'مطور اساسي'
elseif tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',iduser) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,iduser) then
t = 'المنشئ'
elseif tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,iduser) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,iduser) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',iduser) then
t = 'مميز عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,iduser) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',iduser) then
kkeed = 'محظور عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,iduser) then
kkeed = 'محظور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,iduser) then
kkeed = 'مكتوم'
elseif tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,iduser) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..iduser) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
local msgss = tonumber(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..result.sender_user_id_) or 0)  
...
t = 'مطور اساسي'
elseif tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',result.sender_user_id_) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,result.sender_user_id_) then
t = 'المنشئ'
elseif tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',result.sender_user_id_) then
t = 'مميز عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,result.sender_user_id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',result.sender_user_id_) then
kkeed = 'محظور عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'محظور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'مكتوم'
elseif tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'مقيد'
else
kkeed = 'لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..result.sender_user_id_) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
local msgss = tonumber(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..tes.content_.entities_[0].user_id_) or 0)  
...
t = 'مطور اساسي'
elseif tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',tes.content_.entities_[0].user_id_) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'المنشئ'
elseif tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',tes.content_.entities_[0].user_id_) then
t = 'مميز عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',tes.content_.entities_[0].user_id_) then
kkeed = 'محظور عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'محظور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'مكتوم'
elseif tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..tes.content_.entities_[0].user_id_) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
tahadevDEVIL:setex(DEVDEVIL.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^معلومات$") and is_devtaha(msg) then  
tahadevDEVIL:setex(DEVDEVIL.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == 'الكروبات' and is_sudo(msg) then 
local t = tahadevDEVIL:scard(DEVDEVIL.."botgps")
local y = tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id") 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ العدد الكلي للكروبات هو » ❪'..(y)..'❫* \n', 1, 'md') 
end
if text == 'المشتركين' and is_sudo(msg) then     
local addgrop = tahadevDEVIL:scard(DEVDEVIL.."usersbot") or 0    
...
tahadevDEVIL:setex(DEVDEVIL.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📊¦ ارسل لي العدد الان*'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == 'مسح المجموعات' and is_devtaha(msg) then 
local lgp = tahadevDEVIL:smembers(DEVDEVIL.."bot:gpsby:id") 
local lsug = tahadevDEVIL:smembers(DEVDEVIL.."botgps") 
local lgpn = tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id") 
local lsugn = tahadevDEVIL:scard(DEVDEVIL.."botgps") + tahadevDEVIL:scard(DEVDEVIL.."bot:gpsby:id") 
...
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,admins[i].user_id_) 
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_
},function(arg,b) 
if b.username_ == true then
tahadevDEVIL:set(DEVDEVIL.."user:Name"..b.id_,"@"..b.username_)
end
if b.first_name_ == false then
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,admins[i].user_id_) 
end
end,nil)   
else
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,admins[i].user_id_) 
...
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,owner_id) 
end
end
...
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,owner_id) 
return false  end
...
tahadevDEVIL:set(DEVDEVIL..'group:name'..msg.chat_id_,name)
end
end,nil) 
end
...
tahadevDEVIL:set(DEVDEVIL.."link:group"..msg.chat_id_, 'setlinkwai') 
end
if text == "الرابط" then 
local link = tahadevDEVIL:get(DEVDEVIL.."link:group"..msg.chat_id_)            
if link then                              
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*ٴ📮¦ »* رابط مجموعة ↓\n*ٴ📬¦ » '..tahadevDEVIL:get(DEVDEVIL..'group:name'..msg.chat_id_)..' *\n*ٴ📛¦* » ['..link..']\n💥', 1, 'md')                          
else                
...
tahadevDEVIL:del(DEVDEVIL.."link:group" .. msg.chat_id_)       
end
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then 
tahadevDEVIL:setex(DEVDEVIL.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:setex(DEVDEVIL.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:setex(DEVDEVIL.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:setex(DEVDEVIL.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:setex(DEVDEVIL.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:setex(DEVDEVIL.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:setex(DEVDEVIL.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevDEVIL:del(DEVDEVIL.."rules:group" .. msg.chat_id_) 
end
if text and text:match("^القوانين$") then 
local rules = tahadevDEVIL:get(DEVDEVIL.."rules:group" .. msg.chat_id_)   
if rules then     
...
tahadevDEVIL:srem(DEVDEVIL..'bot:gps',gp) 
tahadevDEVIL:srem(DEVDEVIL..'bot:gpsby:id',gp) 
tahadevDEVIL:srem(DEVDEVIL.."botgps",gp) 
tahadevDEVIL:del(DEVDEVIL..'mod:'..gp) 
tahadevDEVIL:del(DEVDEVIL..'moder'..gp) 
tahadevDEVIL:del(DEVDEVIL..'banned:'..gp) 
tahadevDEVIL:del(DEVDEVIL.."add:bot:group"..gp) 
tahadevDEVIL:del(DEVDEVIL.."setmoder:"..gp) 
tahadevDEVIL:del(DEVDEVIL.."gps:settings:"..gp) 
tahadevDEVIL:del(DEVDEVIL.."gps:settings:"..gp) 
...
tahadevDEVIL:set(DEVDEVIL..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
for k,v in pairs(list) do   
local nummsg = tonumber(tahadevDEVIL:get(DEVDEVIL..'groupmsg:'..v..':')) 
numrgroup(v) local numg = (tahadevDEVIL:get(DEVDEVIL.."numgrop"..v) or '3')
local namechat = tahadevDEVIL:get(DEVDEVIL..'group:name'..v) 
if namechat then
...
if #list >= 25 then  
local groups = tahadevDEVIL:scard(DEVDEVIL..'bot:gpsby:id')  
...
local hash = tahadevDEVIL:get(DEVDEVIL..'add:welc:'..msg.chat_id_)     
if hash == 'add' then     
return '✓'     
else     
return '✘'     
...
if tahadevDEVIL:get(DEVDEVIL..'lock:tagservrbot'..msg.chat_id_) then
lock_tagservr_bot = '✓'
else 
lock_tagservr_bot = '✘'    
end
...
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..msg.chat_id_) then    
lock_edit = '✓'
else 
lock_edit = '✘'    
end
if tahadevDEVIL:get(DEVDEVIL..'lock:edit:media'..msg.chat_id_) then    
lock_edit_med = '✓'
else 
lock_edit_med = '✘'    
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then
lock_links = '✓'
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "ked" then
lock_links = 'بالتقيد 🔏'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "ktm" then
lock_links = 'بالكتم 🔇'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "kick" then
lock_links = 'بالطرد 🚷'    
else
lock_links = '✘'    
end
if tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = '✓'
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = 'بالتقيد 🔏'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = 'بالكتم 🔇'   
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = 'بالطرد 🚷'    
else
lock_cmds = '✘'    
end
if tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "del" then
lock_user = '✓'
elseif tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "ked" then
lock_user = 'بالتقيد 🔏'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "ktm" then
lock_user = 'بالكتم 🔇'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "kick" then
lock_user = 'بالطرد 🚷'    
else
lock_user = '✘'    
end
if tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = '✓'
elseif tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = 'بالتقيد 🔏'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = 'بالكتم 🔇'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = 'بالطرد 🚷'    
else
lock_hash = '✘'    
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Bot:kick"..msg.chat_id_) == 'del' then
lock_bots = '✓'
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Bot:kick"..msg.chat_id_) == 'ked' then
lock_bots = 'بالتقيد 🔏'   
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Bot:kick"..msg.chat_id_) == 'kick' then
lock_bots = 'بالطرد 🚷'    
else
lock_bots = '✘'    
end
...
if tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = '✓'
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = 'بالتقيد 🔏'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = 'بالكتم 🔇'    
elseif tahadevDEVIL:get(DEVDEVIL.."lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = 'بالطرد 🚷'    
else
lock_spam = '✘'    
end        
...
tahadevDEVIL:del(DEVDEVIL..'add:ch:id')
tahadevDEVIL:del(DEVDEVIL..'add:ch:username')
taha = "*📮¦ تم تعطيل الاشتراك الاجباري *\n✓"
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devtaha(msg) then  
if tahadevDEVIL:get(DEVDEVIL..'add:ch:username') then
local addchusername = tahadevDEVIL:get(DEVDEVIL..'add:ch:username')
...
local getwelcom = tahadevDEVIL:get(DEVDEVIL..'welcome:'..msg.chat_id_)  
if getwelcom then 
...
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:kick'..msg.chat_id_,result.sender_user_id_)   
else
...
if da.status_.ID == "ChatMemberStatusLeft" then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم طرده من الكروب\n🍃'     
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
return false  end
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم طرده من الكروب\n🍃'     
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:kick'..msg.chat_id_,user)   
else
zo = '*??¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم طرده من الكروب\n🍃'     
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:kick'..msg.chat_id_,user)   
seavusername(user) 
...
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevDEVIL:sadd(DEVDEVIL..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'vip:group'..msg.chat_id_,result.id_)  
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد هو مميز'   
tahadevDEVIL:sadd(DEVDEVIL..'vip:group'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'vip:group'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,result.id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز'   
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
...
tahadevDEVIL:sadd(DEVDEVIL..'vip:groups',result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
tahadevDEVIL:sadd(DEVDEVIL..'vip:groups',result.id_)  
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مميز عام'   
tahadevDEVIL:sadd(DEVDEVIL..'vip:groups',result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز عام البوت\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
tahadevDEVIL:sadd(DEVDEVIL..'vip:groups',user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'vip:groups',result.sender_user_id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
tahadevDEVIL:srem(DEVDEVIL..'vip:groups',result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
tahadevDEVIL:srem(DEVDEVIL..'vip:groups',result.id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز عام'   
tahadevDEVIL:srem(DEVDEVIL..'vip:groups',result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
tahadevDEVIL:srem(DEVDEVIL..'vip:groups',user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'modergroup'..msg.chat_id_,result.id_)  
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مدير'   
tahadevDEVIL:sadd(DEVDEVIL..'modergroup'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'modergroup'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مدير'   
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,result.id_)  
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ادمن'   
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'mods:'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس ادمن'   
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,result.id_)  
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو منشئ'   
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه منشئ للـكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
tahadevDEVIL:sadd(DEVDEVIL..'moder'..msg.chat_id_,user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,result.sender_user_id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,result.id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس منشئ'   
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n'   
DEVILmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
tahadevDEVIL:srem(DEVDEVIL..'moder'..msg.chat_id_,user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
tahadevDEVIL:sadd(DEVDEVIL..'sudo:bot',result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
tahadevDEVIL:sadd(DEVDEVIL..'sudo:bot',result.id_)  
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مطور'   
tahadevDEVIL:sadd(DEVDEVIL..'sudo:bot',result.id_)  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
tahadevDEVIL:sadd(DEVDEVIL..'sudo:bot',user)  
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
tahadevDEVIL:srem(DEVDEVIL..'sudo:bot',result.sender_user_id_)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
tahadevDEVIL:srem(DEVDEVIL..'sudo:bot',result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مطور'   
tahadevDEVIL:srem(DEVDEVIL..'sudo:bot',result.id_)  
end
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
tahadevDEVIL:srem(DEVDEVIL..'sudo:bot',user)  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) or tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_) or tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء رفع قيوده\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
tahadevDEVIL:srem(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
tahadevDEVIL:srem(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
tahadevDEVIL:srem(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,user) or tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,user) or tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء رفع قيوده\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
tahadevDEVIL:srem(DEVDEVIL..'tedmembars'..msg.chat_id_,user) 
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user)   
tahadevDEVIL:srem(DEVDEVIL..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
tahadevDEVIL:srem(DEVDEVIL..'tedmembars'..msg.chat_id_,user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.id_) or tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.id_) or tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء رفع قيوده\n🍃'   
...
tahadevDEVIL:srem(DEVDEVIL..'tedmembars'..msg.chat_id_,result.id_) 
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_)   
tahadevDEVIL:srem(DEVDEVIL..'mutes'..msg.chat_id_,result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_)   
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره من الكروب\n🍃'     
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user)   
seavusername(user) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.sender_user_id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,user)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره\n🍃'   
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:baned'..msg.chat_id_,result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
for k, v in pairs(list) do 
local taha = tahadevDEVIL:get(DEVDEVIL.."user:Name" .. v)
if taha then
local username = taha
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:gbaned',result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n🍃', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:gbaned',result.id_)   
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره عام من الكروب\n🍃'     
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:gbaned',result.id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره عام من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'DEVIL:gbaned',user)   
seavusername(user) 
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:gbaned',result.sender_user_id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:gbaned',user)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'DEVIL:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:gbaned',result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء حظره عام\n🍃'   
tahadevDEVIL:srem(DEVDEVIL..'DEVIL:gbaned',result.id_)   
...
if not tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*📬¦* تـم كتمه من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if not tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,result.id_)   
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم كتمه من الكروب\n🍃'     
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,result.id_)   
...
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,user)   
seavusername(user) 
...
if tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevDEVIL:srem(DEVDEVIL..'mutes'..msg.chat_id_,user)   
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء كتمه\n🍃'   
tahadevDEVIL:srem(DEVDEVIL..'mutes'..msg.chat_id_,result.id_)   
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
if not tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
tahadevDEVIL:sadd(DEVDEVIL..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if not tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,result.id_) 
tahadevDEVIL:set(DEVDEVIL.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم تقييده من الكروب\n🍃'     
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
...
return false  end
if not tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تقييده من الكروب\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,user) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,user) 
...
if tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
DEVILmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
DEVILmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء تقييده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
tahadevDEVIL:srem(DEVDEVIL..'tedmembars'..msg.chat_id_,result.id_) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
getChatHiDEVILDEVDEVILy(msg.chat_id_, 0, 0, taha + 3,cb) 
end 
end  
if tonumber(msg.reply_to_message_id_) > 0 then
...
if tahadevDEVIL:sismember(DEVDEVIL..'filters:'..msg.chat_id_,taha) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ الكلمه » ❪ '..taha..' ❫*\n*📪¦* بالتأكيد تم منع هاذه الكلمه \n💥', 1, 'md') 
else
tahadevDEVIL:sadd(DEVDEVIL..'filters:'..msg.chat_id_,taha) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ الكلمه » ❪ '..taha..' ❫*\n*💠¦* تم منع ارسال هاذه الكلمه \n✓', 1, 'md') 
end
end 
if text and text:match('^الغاء المنع (.*)')  and is_mod(msg) then  
local taha = text:match('^الغاء المنع (.*)') 
if not tahadevDEVIL:sismember(DEVDEVIL..'filters:'..msg.chat_id_,taha) then
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'*⚜¦ الكلمه » ❪ '..taha..' ❫*\n*🗳¦* بالتأكيد تم الغاء منع الكلمه\n💥', 1, 'md') 
else
tahadevDEVIL:srem(DEVDEVIL..'filters:'..msg.chat_id_,taha) 
...
if text ==('مسح قائمه المنع') and is_mod(msg) then tahadevDEVIL:del(DEVDEVIL..'filters:'..msg.chat_id_) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📇*¦* تم مسح قائمه المنع', 1, 'md') end 
if text == ('قائمه المنع') and is_mod(msg) then  
local list = tahadevDEVIL:smembers(DEVDEVIL..'filters:'..msg.chat_id_) 
...
if tahadevDEVIL:sismember(DEVDEVIL..'lock:pin',msg.chat_id_) and not is_monsh(msg) then
DEVIL_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* التثبيت مقفل في المجموعه \n🍃", 1, 'md')  
return false  end
if tahadevDEVIL:sismember(DEVDEVIL..'lockpinmsg:ban'..msg.chat_id_,msg.sender_user_id_) then
...
if text == 'اطردني' and not tahadevDEVIL:get(DEVDEVIL.."lock:kickme"..msg.chat_id_)   then 
tdcli_function ({
ID = "GetChatMember",
chat_id_ = msg.chat_id_,
user_id_ = msg.sender_user_id_},
...
tahadevDEVIL:del(DEVDEVIL..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
return false  end 
if DEVIL1(msg.chat_id_,msg.sender_user_id_) then 
if tonumber(msg.sender_user_id_) == tonumber(SUDO) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'sudo:bot',msg.sender_user_id_) then
t = 'المطور'
elseif tahadevDEVIL:sismember(DEVDEVIL..'moder'..msg.chat_id_,msg.sender_user_id_) then
t = 'المنشئ'
elseif tahadevDEVIL:sismember(DEVDEVIL..'modergroup'..msg.chat_id_,msg.sender_user_id_) then
t = 'المدير'
elseif tahadevDEVIL:sismember(DEVDEVIL..'mods:'..msg.chat_id_,msg.sender_user_id_) then
t = 'الادمن'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:groups',msg.sender_user_id_) then
t = 'مميز عام'
elseif tahadevDEVIL:sismember(DEVDEVIL..'vip:group'..msg.chat_id_,msg.sender_user_id_) then
t = 'مميز'
else
t = ' '
end
...
tahadevDEVIL:set(DEVDEVIL..hash, "waite") 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '📮*¦* رائع الان يمكنك تطبيق الشروط\n⚀*¦* ارسل ❪ نعم ❫ ليتم طردك\n*⚁¦* ارسل ❪ لا ❫ لالغاء طردك\n💥', 1, 'md') 
end,nil)
end 
if text then 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if text:match("^نعم$") and tahadevDEVIL:get(DEVDEVIL..hash) == "waite" then 
tahadevDEVIL:set(DEVDEVIL..hash, "نعم") 
elseif text:match("^لا$") and tahadevDEVIL:get(DEVDEVIL..hash) == "waite" then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* حسنآ لن يتم طردك من هنا\n💭', 1, 'md') 
tahadevDEVIL:del(DEVDEVIL..hash, true) 
end 
end 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if tahadevDEVIL:get(DEVDEVIL..hash) then 
if tahadevDEVIL:get(DEVDEVIL..hash) == "نعم" then 
if DEVIL1(msg.chat_id_,msg.sender_user_id_) then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* عذرا انت ❪ '..get_mok(msg.chat_id_,msg.sender_user_id_)..' ❫ لا استطيع طردك \n🍃', 1, 'md') 
else  
kick(msg,msg.chat_id_,msg.sender_user_id_)  
...
if text == 'نزلني' and not tahadevDEVIL:get(DEVDEVIL.."lock:demrtpa"..msg.chat_id_)   then 
local hash = 'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_ tahadevDEVIL:set(DEVDEVIL..hash, "waite") 
...
tahadevDEVIL:del(DEVDEVIL..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else  
...
if tahadevDEVIL:get(DEVDEVIL..hash) then 
if tahadevDEVIL:get(DEVDEVIL..hash) == "نعم" then 
tahadevDEVIL:srem(DEVDEVIL..'modergroup'..msg.chat_id_,msg.sender_user_id_)  
tahadevDEVIL:srem(DEVDEVIL..'mods:'..msg.chat_id_,msg.sender_user_id_) 
tahadevDEVIL:srem(DEVDEVIL..'vip:group'..msg.chat_id_,msg.sender_user_id_) 
...
tahadevDEVIL:set(DEVDEVIL..'add:mepr:'..msg.chat_id_,true) 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,"📮❯ تم تفعيل الاضافه اجباري", 1, 'md') 
end 
end
if text == "تعطيل الاضافه" and is_owner(msg) then 
tahadevDEVIL:del(DEVDEVIL..'add:mepr:'..msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL..'meaddwy:'..msg.chat_id_) 
tahadevDEVIL:del(DEVDEVIL..'meaddtaha:'..msg.chat_id_) 
local taha = tahadevDEVIL:keys("addedtaha:*") 
for i=1,#taha do tahadevDEVIL:del(DEVDEVIL..taha[i]) 
end 
...
tahadevDEVIL:set(DEVDEVIL..'setadd:'..msg.chat_id_,numadded) 
...
local nummsg = tonumber(tahadevDEVIL:get(DEVDEVIL..'groupmsg:'..msg.chat_id_..':')) 
local nummsgg = tahadevDEVIL:get(DEVDEVIL..'groupmsg:'..msg.chat_id_..':') 
...
if text and text:match("^مشاهده منشور$") then tahadevDEVIL:set(DEVDEVIL..'viewchannel'..msg.sender_user_id_,true) DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, '♼*¦* حسننا ارسل التوجيه من القناة سارسل عدد المشاهدات', 1, 'md') end 
if text and text:match("^ضع رد تواصل$") and is_devtaha(msg) then   tahadevDEVIL:setex(DEVDEVIL.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور$") and is_devtaha(msg) then tahadevDEVIL:setex(DEVDEVIL.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت$") and is_devtaha(msg) then tahadevDEVIL:setex(DEVDEVIL.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if msg.content_.ID == 'MessageChatChangeTitle' then tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)  tahadevDEVIL:set(DEVDEVIL..'group:name'..msg.chat_id_,data.title_) end,nil)  end
...
DEVIL_sendMsg(msg.chat_id_,msg.id_, 1, "*📬¦* تم وضع اسم للمجموعه \n", 1, 'md')  
tahadevDEVIL:set(DEVDEVIL..'group:name'..result.chat_id_,result.content_.text_)
end
end,nil) 
end 
...
if tahadevDEVIL:get(DEVDEVIL..'lock:rep:rd'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الردود بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:rep:rd'..msg.chat_id_)  
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:rep:rd'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الردود بالرد *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:rep:rd'..msg.chat_id_,true)   
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:rep'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الردود *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:rep'..msg.chat_id_)  
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:rep'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الردود *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:rep'..msg.chat_id_,true)   
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:id'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الايدي *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:id'..msg.chat_id_) 
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:id'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الايدي *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:id'..msg.chat_id_,true) 
else
taha = '*📮¦ بالتاكيد تم تفعيل الايدي  *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
end
...
if tahadevDEVIL:get(DEVDEVIL..'lock:get:photo'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل امر جلب الصور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:get:photo'..msg.chat_id_) 
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:get:photo'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل امر جلب الصور *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:get:photo'..msg.chat_id_,true) 
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:kickme'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل امر اطردني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:kickme'..msg.chat_id_) 
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:kickme'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل امر اطردني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:kickme'..msg.chat_id_,true) 
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:demrtpa'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل امر نزلني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:demrtpa'..msg.chat_id_) 
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:demrtpa'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل امر نزلني *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:demrtpa'..msg.chat_id_,true) 
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:bot:free'..bot_id) then
taha = '*📮¦ تم تفعيل البوت الخدمي *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:bot:free'..bot_id) 
else
...
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:bot:free'..bot_id,true) 
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:klsh:add'..bot_id) then
taha = '*📮¦ تم تفعيل كليشه الترحيب عند الاضافه*\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:klsh:add'..bot_id) 
else
...
if not tahadevDEVIL:get(DEVDEVIL..'lock:klsh:add'..bot_id) then
taha = '*📮¦ تم تعطيل كليشه الترحيب عند الاضافه*\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:klsh:add'..bot_id,true) 
else
...
if tahadevDEVIL:get(DEVDEVIL..'lock:botl'..bot_id) then
taha = '*📮¦ تم تفعيل البوت التواصل *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:del(DEVDEVIL..'lock:botl'..bot_id) 
else
...
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevDEVIL:set(DEVDEVIL..'lock:botl'..bot_id,true) 
else
taha = '*📮¦ بالتاكيد تم تعطيل البوت التواصل  *\n✓' 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
end
end
if text and text:match("^صورتي (%d+)") and not tahadevDEVIL:get(DEVDEVIL.."lock:get:photo"..msg.chat_id_)  then 
...
local dev = tahadevDEVIL:get(DEVDEVIL.."dev") 
if dev then 
...
tahadevDEVIL:del(DEVDEVIL.."dev") 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") 
end 
if text == "جلب رد التواصل" and is_devtaha(msg) then 
if tahadevDEVIL:get(DEVDEVIL.."pvstart") then
pvstart = tahadevDEVIL:get(DEVDEVIL.."pvstart")
...
tahadevDEVIL:del(DEVDEVIL.."pvstart") 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") 
end 
if text == "حذف كليشه ستارت" and is_devtaha(msg) then  
tahadevDEVIL:del(DEVDEVIL.."start:msgofstart1") 
DEVIL_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") 
end 
if text == 'معلوماتي' or text=='موقعي' or text == 'اكشفني' then 
local msgtaha = 500 
local msggstaha = tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0  
local nupmsgg =  tonumber((msggstaha / msgtaha) * 100)   
local msguser = tonumber(tahadevDEVIL:get(DEVDEVIL..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
local tahamsg = (tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if is_devtaha(msg) then 
t = 'مطور اساسي 🌟'  
...
local whatnumadded = (tahadevDEVIL:get(DEVDEVIL..'setadd:'..msg.chat_id_) or 0) 
...
local getmsgs = tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local taha = '\n*📨¦ عدد رسائلك » ❪ '..getmsgs..' ❫ رساله\n📮¦ تم مسح جميع رسائلك *\n🍃'  
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md')  
tahadevDEVIL:del(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
end
...
if text == "تفاعلي" then
local msguser = tonumber(tahadevDEVIL:get(DEVDEVIL..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
taha = '*📮¦ تفاعلك هنا » ❪ '..formsgg(msguser)..' ❫\n🍃*'
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "جهاتي" then
local addmempar = tonumber(tahadevDEVIL:get(DEVDEVIL..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
if addmempar == 0 then
...
tahadevDEVIL:setex(DEVDEVIL.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
local tahaid= [[
*📮¦ اهلا عزيزي المطور 
...
tahadevDEVIL:del(DEVDEVIL.."KLISH:ID")
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,  '*📮¦ تم مسح كليشه الايدي *\n', 1, 'md')
return false  
end 
if tahadevDEVIL:get(DEVDEVIL.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevDEVIL:del(DEVDEVIL.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  end 
tahadevDEVIL:del(DEVDEVIL.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
...
tahadevDEVIL:set(DEVDEVIL.."KLISH:ID",CHENGER_ID)
DEVIL_sendMsg(msg.chat_id_, msg.id_, 1,'\n📬*¦* تم تغير كليشه الايدي \n', 1, 'md')    
end
if text == ("ايدي") and msg.reply_to_message_id_ == 0 and not tahadevDEVIL:get(DEVDEVIL..'lock:id'..msg.chat_id_) then      
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
...
NUMPGAME = (tahadevDEVIL:get(DEVDEVIL..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
if tonumber(NUMPGAME) == 0 then
nko = '0'
else
nko = NUMPGAME
end
local get_id_text = tahadevDEVIL:get(DEVDEVIL.."KLISH:ID")
if get_id_text then
...
if data.channel_.status_.ID == "ChatMemberStatusKicked" then    local list = tahadevDEVIL:smembers(DEVDEVIL..'moder'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'moder'..'-100'..data.channel_.id_,v)      end   local list = tahadevDEVIL:smembers(DEVDEVIL..'modergroup'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'modergroup'..'-100'..data.channel_.id_,v)      end   local list = tahadevDEVIL:smembers(DEVDEVIL..'mods:'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'mods:'..'-100'..data.channel_.id_,v)      end   local list = tahadevDEVIL:smembers(DEVDEVIL..'vip:group'..'-100'..data.channel_.id_)    for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'vip:group'..'-100'..data.channel_.id_,v)      end
...
tahadevDEVIL:srem(DEVDEVIL..'bot:gpsby:id',idch) 
tdcli_function({ID="GetChat",chat_id_ = '-100'..data.channel_.id_},function(arg,data)  linkgp = tahadevDEVIL:get(DEVDEVIL.."link:group"..idch)  
...
local list = tahadevDEVIL:smembers(DEVDEVIL..'moder'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'moder'..'-100'..data.channel_.id_,v)      end   local list = tahadevDEVIL:smembers(DEVDEVIL..'modergroup'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'modergroup'..'-100'..data.channel_.id_,v)      end   local list = tahadevDEVIL:smembers(DEVDEVIL..'mods:'..'-100'..data.channel_.id_)   for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'mods:'..'-100'..data.channel_.id_,v)      end   local list = tahadevDEVIL:smembers(DEVDEVIL..'vip:group'..'-100'..data.channel_.id_)    for k, v in pairs(list) do    tahadevDEVIL:srem(DEVDEVIL..'vip:group'..'-100'..data.channel_.id_,v)      end
rem_group('-100'..data.channel_.id_)   
tahadevDEVIL:sadd(DEVDEVIL..'botgps','-100'..data.channel_.id_) 
end  
end
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and tahadevDEVIL:get(DEVDEVIL.."lock:Bot:kick"..msg.chat_id_) == 'del'  and not is_vipgroup(msg) then  
...
if msg.content_.ID == "MessageChatDeleteMember" and tahadevDEVIL:get(DEVDEVIL..'lock:tagservrbot'..msg.chat_id_) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and tahadevDEVIL:get(DEVDEVIL.."lock:Bot:kick"..msg.chat_id_) == 'ked' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
tahadevDEVIL:sadd(DEVDEVIL..'tedmembars'..msg.chat_id_,msg.sender_user_id_)
end  
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and tahadevDEVIL:get(DEVDEVIL.."lock:Bot:kick"..msg.chat_id_) == 'kick' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
...
if tahadevDEVIL:get(DEVDEVIL..'lock:edit:media'..data.chat_id_) then 
...
if txxt:find("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") and tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Pp][Ee]") and tahadevDEVIL:get(DEVDEVIL..'lock:links'..msg.chat_id_) then 
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") and tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") and tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt].[Mm][Ee]/") and tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Ww][Ww][Ww].") and tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Cc][Oo][Mm]") then
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) and tahadevDEVIL:get(DEVDEVIL.."lock:Link"..msg.chat_id_) == "del" then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find('@[%a%d_]+') and tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "del" then
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('@(.+)') and tahadevDEVIL:get(DEVDEVIL.."lock:user:name"..msg.chat_id_) == "del" then
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#[%a%d_]+') and tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "del" then
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#(.+)') and tahadevDEVIL:get(DEVDEVIL.."lock:hashtak"..msg.chat_id_) == "del" then
if tahadevDEVIL:get(DEVDEVIL..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
...
tahadevDEVIL:srem(DEVDEVIL..'botgps',v) 
changeChatMemberStatus(v, bot_id, "Left")
rem_group(v)   
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
...
tahadevDEVIL:set(DEVDEVIL..'group:name'..v,data.title_)
